# EdFi.OdsApi.Sdk.v54.Apis.All.BudgetsApi
...
#### Using the DeleteBudgetByIdWithHttpInfo variant
...
{
    // Deletes an existing resource using the resource identifier.
    apiInstance.DeleteBudgetByIdWithHttpInfo(id, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling BudgetsApi.DeleteBudgetByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
#### Using the DeletesBudgetsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesBudgetsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
{
    Debug.Print("Exception when calling BudgetsApi.DeletesBudgetsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="getbudgets"></a>
# **GetBudgets**
> List&lt;EdFiBudget&gt; GetBudgets (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, DateOnly? asOfDate = null, string? accountIdentifier = null, int? educationOrganizationId = null, int? fiscalYear = null, double? amount = null, string? id = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class GetBudgetsExample
    {
        public static void Main()
        {
            ...
            var asOfDate = DateOnly.Parse("2013-10-20");  // DateOnly? | The date of the reported budget element. (optional) 
            ...
            var amount = 1.2D;  // double? | Amount budgeted for the account for this fiscal year. (optional) 
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiBudget>> response = apiInstance.GetBudgetsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, asOfDate, accountIdentifier, educationOrganizationId, fiscalYear, amount, id, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling BudgetsApi.GetBudgetsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
| **asOfDate** | **DateOnly?** | The date of the reported budget element. | [optional]  |
...
#### Using the GetBudgetsByIdWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiBudget> response = apiInstance.GetBudgetsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling BudgetsApi.GetBudgetsByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
#### Using the PostBudgetWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostBudgetWithHttpInfo(budget);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling BudgetsApi.PostBudgetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
#### Using the PutBudgetWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutBudgetWithHttpInfo(id, budget, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling BudgetsApi.PutBudgetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
