# EdFi.OdsApi.Sdk.v54.Apis.All.PayrollsApi
...
namespace Example
{
    public class DeletePayrollByIdExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new PayrollsApi(config);
...
#### Using the DeletePayrollByIdWithHttpInfo variant
...
{
    // Deletes an existing resource using the resource identifier.
    apiInstance.DeletePayrollByIdWithHttpInfo(id, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling PayrollsApi.DeletePayrollByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
#### Using the DeletesPayrollsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesPayrollsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
{
    Debug.Print("Exception when calling PayrollsApi.DeletesPayrollsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class GetPayrollsExample
    {
        public static void Main()
        {
            ...
            var asOfDate = DateOnly.Parse("2013-10-20");  // DateOnly? | The date of the reported payroll element. (optional) 
            ...
            var amountToDate = 1.2D;  // double? | Current balance (amount paid to employee) for account for the fiscal year. (optional) 
...
#### Using the GetPayrollsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiPayroll>> response = apiInstance.GetPayrollsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, asOfDate, accountIdentifier, educationOrganizationId, fiscalYear, staffUniqueId, amountToDate, id, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling PayrollsApi.GetPayrollsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
| **asOfDate** | **DateOnly?** | The date of the reported payroll element. | [optional]  |
...
#### Using the GetPayrollsByIdWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiPayroll> response = apiInstance.GetPayrollsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling PayrollsApi.GetPayrollsByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
#### Using the PostPayrollWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostPayrollWithHttpInfo(payroll);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling PayrollsApi.PostPayrollWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
#### Using the PutPayrollWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutPayrollWithHttpInfo(id, payroll, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling PayrollsApi.PutPayrollWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
