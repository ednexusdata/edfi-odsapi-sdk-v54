# EdFi.OdsApi.Sdk.v54.Apis.All.ContractedStaffsApi
...
<a id="deletecontractedstaffbyid"></a>
...
namespace Example
{
    public class DeleteContractedStaffByIdExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new ContractedStaffsApi(config);
...
#### Using the DeleteContractedStaffByIdWithHttpInfo variant
...
{
    // Deletes an existing resource using the resource identifier.
    apiInstance.DeleteContractedStaffByIdWithHttpInfo(id, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling ContractedStaffsApi.DeleteContractedStaffByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="deletescontractedstaffs"></a>
...
#### Using the DeletesContractedStaffsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesContractedStaffsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
{
    Debug.Print("Exception when calling ContractedStaffsApi.DeletesContractedStaffsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="getcontractedstaffs"></a>
# **GetContractedStaffs**
> List&lt;EdFiContractedStaff&gt; GetContractedStaffs (int? offset = null, int? limit = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, DateOnly? asOfDate = null, string? accountIdentifier = null, int? educationOrganizationId = null, int? fiscalYear = null, string? staffUniqueId = null, double? amountToDate = null, string? id = null, string? snapshotIdentifier = null)
...
namespace Example
{
    public class GetContractedStaffsExample
    {
        public static void Main()
        {
            ...
            var asOfDate = DateOnly.Parse("2013-10-20");  // DateOnly? | The date of the reported contracted staff element. (optional) 
            ...
            var amountToDate = 1.2D;  // double? | Current balance (amount paid to contractor) for account for the fiscal year. (optional) 
...
#### Using the GetContractedStaffsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiContractedStaff>> response = apiInstance.GetContractedStaffsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, asOfDate, accountIdentifier, educationOrganizationId, fiscalYear, staffUniqueId, amountToDate, id, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling ContractedStaffsApi.GetContractedStaffsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
| **asOfDate** | **DateOnly?** | The date of the reported contracted staff element. | [optional]  |
...
<a id="getcontractedstaffsbyid"></a>
...
#### Using the GetContractedStaffsByIdWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiContractedStaff> response = apiInstance.GetContractedStaffsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling ContractedStaffsApi.GetContractedStaffsByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
#### Using the PostContractedStaffWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostContractedStaffWithHttpInfo(contractedStaff);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling ContractedStaffsApi.PostContractedStaffWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
#### Using the PutContractedStaffWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutContractedStaffWithHttpInfo(id, contractedStaff, ifMatch);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling ContractedStaffsApi.PutContractedStaffWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
