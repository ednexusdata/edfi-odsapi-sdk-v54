# EdFi.OdsApi.Sdk.v54.Apis.All.StaffIdentificationSystemDescriptorsApi
...
namespace Example
{
    public class DeletesStaffIdentificationSystemDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<DeletedResource> result = apiInstance.DeletesStaffIdentificationSystemDescriptors(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesStaffIdentificationSystemDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
