# EdFi.OdsApi.Sdk.v54.Apis.All.SchoolChoiceImplementStatusDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesSchoolChoiceImplementStatusDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
