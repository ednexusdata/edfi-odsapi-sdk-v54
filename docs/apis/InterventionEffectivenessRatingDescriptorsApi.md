# EdFi.OdsApi.Sdk.v54.Apis.All.InterventionEffectivenessRatingDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesInterventionEffectivenessRatingDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
