# EdFi.OdsApi.Sdk.v54.Apis.All.IdentificationDocumentUseDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesIdentificationDocumentUseDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
