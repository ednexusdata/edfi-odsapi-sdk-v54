# EdFi.OdsApi.Sdk.v54.Apis.All.AssessmentIdentificationSystemDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesAssessmentIdentificationSystemDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
