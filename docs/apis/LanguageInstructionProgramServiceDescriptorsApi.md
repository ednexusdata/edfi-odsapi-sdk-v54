# EdFi.OdsApi.Sdk.v54.Apis.All.LanguageInstructionProgramServiceDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesLanguageInstructionProgramServiceDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
