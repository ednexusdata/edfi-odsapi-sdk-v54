# EdFi.OdsApi.Sdk.v54.Apis.All.MigrantEducationProgramServiceDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesMigrantEducationProgramServiceDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
