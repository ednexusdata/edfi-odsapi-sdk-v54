# EdFi.OdsApi.Sdk.v54.Apis.All.CourseGPAApplicabilityDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesCourseGPAApplicabilityDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
