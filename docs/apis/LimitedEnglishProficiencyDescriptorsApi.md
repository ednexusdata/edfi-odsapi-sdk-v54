# EdFi.OdsApi.Sdk.v54.Apis.All.LimitedEnglishProficiencyDescriptorsApi
...
namespace Example
{
    public class DeletesLimitedEnglishProficiencyDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<DeletedResource> result = apiInstance.DeletesLimitedEnglishProficiencyDescriptors(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesLimitedEnglishProficiencyDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
