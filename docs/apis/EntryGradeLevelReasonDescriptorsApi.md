# EdFi.OdsApi.Sdk.v54.Apis.All.EntryGradeLevelReasonDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesEntryGradeLevelReasonDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
