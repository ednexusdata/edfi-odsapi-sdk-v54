# EdFi.OdsApi.Sdk.v54.Apis.All.PerformanceBaseConversionDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesPerformanceBaseConversionDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
