# EdFi.OdsApi.Sdk.v54.Apis.All.EducationOrganizationPeerAssociationsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesEducationOrganizationPeerAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
