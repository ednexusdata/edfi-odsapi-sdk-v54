# EdFi.OdsApi.Sdk.v54.Apis.All.GradingPeriodsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesGradingPeriodsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
namespace Example
{
    public class GetGradingPeriodsExample
    {
        public static void Main()
        {
            ...
            var beginDate = DateOnly.Parse("2013-10-20");  // DateOnly | Month, day, and year of the first day of the GradingPeriod. (optional) 
            var endDate = DateOnly.Parse("2013-10-20");  // DateOnly | Month, day, and year of the last day of the GradingPeriod. (optional) 
...
| **beginDate** | **DateOnly** | Month, day, and year of the first day of the GradingPeriod. | [optional]  |
| **endDate** | **DateOnly** | Month, day, and year of the last day of the GradingPeriod. | [optional]  |
| **id** | **string** |  | [optional]  |
