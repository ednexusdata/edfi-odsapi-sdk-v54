# EdFi.OdsApi.Sdk.v54.Apis.All.AdministrationEnvironmentDescriptorsApi
...
namespace Example
{
    public class DeletesAdministrationEnvironmentDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<DeletedResource> result = apiInstance.DeletesAdministrationEnvironmentDescriptors(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesAdministrationEnvironmentDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
