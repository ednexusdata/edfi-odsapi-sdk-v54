# EdFi.OdsApi.Sdk.v54.Apis.All.HomelessPrimaryNighttimeResidenceDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesHomelessPrimaryNighttimeResidenceDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
