# EdFi.OdsApi.Sdk.v54.Apis.All.NeglectedOrDelinquentProgramServiceDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesNeglectedOrDelinquentProgramServiceDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
