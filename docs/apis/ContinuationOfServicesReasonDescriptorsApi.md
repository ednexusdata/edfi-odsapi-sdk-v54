# EdFi.OdsApi.Sdk.v54.Apis.All.ContinuationOfServicesReasonDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesContinuationOfServicesReasonDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
