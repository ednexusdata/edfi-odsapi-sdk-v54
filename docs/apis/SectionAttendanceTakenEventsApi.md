# EdFi.OdsApi.Sdk.v54.Apis.All.SectionAttendanceTakenEventsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesSectionAttendanceTakenEventsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
namespace Example
{
    public class GetSectionAttendanceTakenEventsExample
    {
        public static void Main()
        {
            ...
            var date = DateOnly.Parse("2013-10-20");  // DateOnly | The month, day, and year of the CalendarEvent. (optional) 
            ...
            var eventDate = DateOnly.Parse("2013-10-20");  // DateOnly | The date the SectionAttendanceTakenEvent was submitted, which could be a different date than the instructional day. (optional) 
...
| **date** | **DateOnly** | The month, day, and year of the CalendarEvent. | [optional]  |
...
| **eventDate** | **DateOnly** | The date the SectionAttendanceTakenEvent was submitted, which could be a different date than the instructional day. | [optional]  |
| **id** | **string** |  | [optional]  |
| **snapshotIdentifier** | **string** | Indicates the Snapshot-Identifier that should be used. | [optional]  |
