# EdFi.OdsApi.Sdk.v54.Apis.All.AdministrativeFundingControlDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesAdministrativeFundingControlDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
