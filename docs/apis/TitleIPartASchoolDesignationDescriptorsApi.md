# EdFi.OdsApi.Sdk.v54.Apis.All.TitleIPartASchoolDesignationDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesTitleIPartASchoolDesignationDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
