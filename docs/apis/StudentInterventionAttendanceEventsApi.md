# EdFi.OdsApi.Sdk.v54.Apis.All.StudentInterventionAttendanceEventsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesStudentInterventionAttendanceEventsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
