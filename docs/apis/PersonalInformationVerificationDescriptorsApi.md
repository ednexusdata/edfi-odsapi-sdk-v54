# EdFi.OdsApi.Sdk.v54.Apis.All.PersonalInformationVerificationDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesPersonalInformationVerificationDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
