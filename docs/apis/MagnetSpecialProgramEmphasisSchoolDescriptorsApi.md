# EdFi.OdsApi.Sdk.v54.Apis.All.MagnetSpecialProgramEmphasisSchoolDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesMagnetSpecialProgramEmphasisSchoolDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
