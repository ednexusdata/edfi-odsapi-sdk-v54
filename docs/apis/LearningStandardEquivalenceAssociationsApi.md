# EdFi.OdsApi.Sdk.v54.Apis.All.LearningStandardEquivalenceAssociationsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesLearningStandardEquivalenceAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
