# EdFi.OdsApi.Sdk.v54.Apis.All.EducationOrganizationNetworkAssociationsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesEducationOrganizationNetworkAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
namespace Example
{
    public class GetEducationOrganizationNetworkAssociationsExample
    {
        public static void Main()
        {
            ...
            var beginDate = DateOnly.Parse("2013-10-20");  // DateOnly | The date on which the EducationOrganization joined this network. (optional) 
            var endDate = DateOnly.Parse("2013-10-20");  // DateOnly | The date on which the EducationOrganization left this network. (optional) 
