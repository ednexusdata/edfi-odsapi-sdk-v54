# EdFi.OdsApi.Sdk.v54.Apis.All.RestraintEventsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesRestraintEventsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
namespace Example
{
    public class GetRestraintEventsExample
    {
        public static void Main()
        {
            ...
            var eventDate = DateOnly.Parse("2013-10-20");  // DateOnly | Month, day, and year of the RestraintEvent. (optional) 
...
| **eventDate** | **DateOnly** | Month, day, and year of the RestraintEvent. | [optional]  |
| **id** | **string** |  | [optional]  |
| **snapshotIdentifier** | **string** | Indicates the Snapshot-Identifier that should be used. | [optional]  |
