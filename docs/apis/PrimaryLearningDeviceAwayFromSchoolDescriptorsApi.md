# EdFi.OdsApi.Sdk.v54.Apis.All.PrimaryLearningDeviceAwayFromSchoolDescriptorsApi
...
namespace Example
{
    public class DeletesPrimaryLearningDeviceAwayFromSchoolDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<DeletedResource> result = apiInstance.DeletesPrimaryLearningDeviceAwayFromSchoolDescriptors(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesPrimaryLearningDeviceAwayFromSchoolDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
