# EdFi.OdsApi.Sdk.v54.Apis.All.BarrierToInternetAccessInResidenceDescriptorsApi
...
namespace Example
{
    public class DeletesBarrierToInternetAccessInResidenceDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<DeletedResource> result = apiInstance.DeletesBarrierToInternetAccessInResidenceDescriptors(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesBarrierToInternetAccessInResidenceDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
