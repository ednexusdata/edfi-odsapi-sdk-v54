# EdFi.OdsApi.Sdk.v54.Apis.All.DisabilityDeterminationSourceTypeDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesDisabilityDeterminationSourceTypeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
