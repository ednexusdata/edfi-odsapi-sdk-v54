# EdFi.OdsApi.Sdk.v54.Apis.All.SchoolFoodServiceProgramServiceDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesSchoolFoodServiceProgramServiceDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
