# EdFi.OdsApi.Sdk.v54.Apis.All.PostSecondaryInstitutionLevelDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesPostSecondaryInstitutionLevelDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
