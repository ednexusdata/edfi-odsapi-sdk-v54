# EdFi.OdsApi.Sdk.v54.Apis.All.DisciplineActionsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesDisciplineActionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
namespace Example
{
    public class GetDisciplineActionsExample
    {
        public static void Main()
        {
            ...
            var disciplineDate = DateOnly.Parse("2013-10-20");  // DateOnly | The date of the DisciplineAction. (optional) 
            ...
            var disciplineActionLength = 1.2D;  // double | The length of time in school days for the DisciplineAction (e.g. removal, detention), if applicable. (optional) 
...
| **disciplineDate** | **DateOnly** | The date of the DisciplineAction. | [optional]  |
