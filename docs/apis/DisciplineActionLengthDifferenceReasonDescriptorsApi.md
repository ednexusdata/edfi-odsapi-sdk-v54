# EdFi.OdsApi.Sdk.v54.Apis.All.DisciplineActionLengthDifferenceReasonDescriptorsApi
...
namespace Example
{
    public class DeletesDisciplineActionLengthDifferenceReasonDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<DeletedResource> result = apiInstance.DeletesDisciplineActionLengthDifferenceReasonDescriptors(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesDisciplineActionLengthDifferenceReasonDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
