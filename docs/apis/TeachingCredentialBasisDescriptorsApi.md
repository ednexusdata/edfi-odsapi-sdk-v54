# EdFi.OdsApi.Sdk.v54.Apis.All.TeachingCredentialBasisDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesTeachingCredentialBasisDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
