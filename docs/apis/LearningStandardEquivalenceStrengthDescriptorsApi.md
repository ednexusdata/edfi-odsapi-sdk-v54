# EdFi.OdsApi.Sdk.v54.Apis.All.LearningStandardEquivalenceStrengthDescriptorsApi
...
namespace Example
{
    public class DeletesLearningStandardEquivalenceStrengthDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<DeletedResource> result = apiInstance.DeletesLearningStandardEquivalenceStrengthDescriptors(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesLearningStandardEquivalenceStrengthDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
