# EdFi.OdsApi.Sdk.v54.Apis.All.DisciplineIncidentParticipationCodeDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesDisciplineIncidentParticipationCodeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
