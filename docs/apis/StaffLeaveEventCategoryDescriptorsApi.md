# EdFi.OdsApi.Sdk.v54.Apis.All.StaffLeaveEventCategoryDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesStaffLeaveEventCategoryDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
