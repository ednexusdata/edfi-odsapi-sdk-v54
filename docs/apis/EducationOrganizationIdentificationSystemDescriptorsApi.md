# EdFi.OdsApi.Sdk.v54.Apis.All.EducationOrganizationIdentificationSystemDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesEducationOrganizationIdentificationSystemDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
