# EdFi.OdsApi.Sdk.v54.Apis.All.SchoolsApi
...
namespace Example
{
    public class DeletesSchoolsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<DeletedResource> result = apiInstance.DeletesSchools(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesSchoolsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
