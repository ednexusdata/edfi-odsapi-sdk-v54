# EdFi.OdsApi.Sdk.v54.Apis.All.LocalEducationAgencyCategoryDescriptorsApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesLocalEducationAgencyCategoryDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
