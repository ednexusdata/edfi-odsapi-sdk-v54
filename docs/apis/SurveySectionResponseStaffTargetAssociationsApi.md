# EdFi.OdsApi.Sdk.v54.Apis.All.SurveySectionResponseStaffTargetAssociationsApi
...
namespace Example
{
    public class DeletesSurveySectionResponseStaffTargetAssociationsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<DeletedResource> result = apiInstance.DeletesSurveySectionResponseStaffTargetAssociations(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesSurveySectionResponseStaffTargetAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
