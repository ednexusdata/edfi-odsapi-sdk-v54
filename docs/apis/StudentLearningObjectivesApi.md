# EdFi.OdsApi.Sdk.v54.Apis.All.StudentLearningObjectivesApi
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesStudentLearningObjectivesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
namespace Example
{
    public class GetStudentLearningObjectivesExample
    {
        public static void Main()
        {
            ...
            var varNamespace = "varNamespace_example";  // string | Namespace for the LearningObjective. (optional) 
...
| **varNamespace** | **string** | Namespace for the LearningObjective. | [optional]  |
