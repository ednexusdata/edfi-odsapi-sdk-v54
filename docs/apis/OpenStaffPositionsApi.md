# EdFi.OdsApi.Sdk.v54.Apis.All.OpenStaffPositionsApi
...
namespace Example
{
    public class DeletesOpenStaffPositionsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<DeletedResource> result = apiInstance.DeletesOpenStaffPositions(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<DeletedResource>> response = apiInstance.DeletesOpenStaffPositionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
...
namespace Example
{
    public class GetOpenStaffPositionsExample
    {
        public static void Main()
        {
            ...
            var datePosted = DateOnly.Parse("2013-10-20");  // DateOnly | Date the OpenStaffPosition was posted. (optional) 
...
| **datePosted** | **DateOnly** | Date the OpenStaffPosition was posted. | [optional]  |
