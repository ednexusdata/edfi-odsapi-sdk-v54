...
namespace EdFi.OdsApi.Sdk.v54.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.ed-fi.org:443/v5.4/api/data/v3";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.ed-fi.org:443/v5.4/api/data/v3"},
        ...
        public Configuration(
            ...
            string basePath = "https://api.ed-fi.org:443/v5.4/api/data/v3") : this()
        {
        ...
        {
            string report = "C# SDK (EdFi.OdsApi.Sdk.v54) Debug Report:\n";
