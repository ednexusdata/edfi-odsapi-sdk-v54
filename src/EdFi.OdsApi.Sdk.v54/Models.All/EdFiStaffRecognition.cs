    ...
    public class EdFiStaffRecognitionJsonConverter : JsonConverter<EdFiStaffRecognition>
    {
        ...
        public override EdFiStaffRecognition Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (achievementCategoryDescriptor.IsSet && achievementCategoryDescriptor.Value == null)
                throw new ArgumentNullException(nameof(achievementCategoryDescriptor), "Property is not nullable for class EdFiStaffRecognition.");

            if (achievementCategorySystem.IsSet && achievementCategorySystem.Value == null)
                throw new ArgumentNullException(nameof(achievementCategorySystem), "Property is not nullable for class EdFiStaffRecognition.");

            if (achievementTitle.IsSet && achievementTitle.Value == null)
                throw new ArgumentNullException(nameof(achievementTitle), "Property is not nullable for class EdFiStaffRecognition.");

            if (criteria.IsSet && criteria.Value == null)
                throw new ArgumentNullException(nameof(criteria), "Property is not nullable for class EdFiStaffRecognition.");

            if (criteriaURL.IsSet && criteriaURL.Value == null)
                throw new ArgumentNullException(nameof(criteriaURL), "Property is not nullable for class EdFiStaffRecognition.");

            if (evidenceStatement.IsSet && evidenceStatement.Value == null)
                throw new ArgumentNullException(nameof(evidenceStatement), "Property is not nullable for class EdFiStaffRecognition.");

            if (imageURL.IsSet && imageURL.Value == null)
                throw new ArgumentNullException(nameof(imageURL), "Property is not nullable for class EdFiStaffRecognition.");

            if (issuerName.IsSet && issuerName.Value == null)
                throw new ArgumentNullException(nameof(issuerName), "Property is not nullable for class EdFiStaffRecognition.");

            if (issuerOriginURL.IsSet && issuerOriginURL.Value == null)
                throw new ArgumentNullException(nameof(issuerOriginURL), "Property is not nullable for class EdFiStaffRecognition.");

            if (recognitionAwardDate.IsSet && recognitionAwardDate.Value == null)
                throw new ArgumentNullException(nameof(recognitionAwardDate), "Property is not nullable for class EdFiStaffRecognition.");

            if (recognitionAwardExpiresDate.IsSet && recognitionAwardExpiresDate.Value == null)
                throw new ArgumentNullException(nameof(recognitionAwardExpiresDate), "Property is not nullable for class EdFiStaffRecognition.");

            if (recognitionDescription.IsSet && recognitionDescription.Value == null)
                throw new ArgumentNullException(nameof(recognitionDescription), "Property is not nullable for class EdFiStaffRecognition.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStaffRecognition edFiStaffRecognition, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStaffRecognition.AchievementCategoryDescriptorOption.IsSet && edFiStaffRecognition.AchievementCategoryDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaffRecognition.AchievementCategoryDescriptor), "Property is required for class EdFiStaffRecognition.");

            if (edFiStaffRecognition.AchievementCategorySystemOption.IsSet && edFiStaffRecognition.AchievementCategorySystem == null)
                throw new ArgumentNullException(nameof(edFiStaffRecognition.AchievementCategorySystem), "Property is required for class EdFiStaffRecognition.");

            if (edFiStaffRecognition.AchievementTitleOption.IsSet && edFiStaffRecognition.AchievementTitle == null)
                throw new ArgumentNullException(nameof(edFiStaffRecognition.AchievementTitle), "Property is required for class EdFiStaffRecognition.");

            if (edFiStaffRecognition.CriteriaOption.IsSet && edFiStaffRecognition.Criteria == null)
                throw new ArgumentNullException(nameof(edFiStaffRecognition.Criteria), "Property is required for class EdFiStaffRecognition.");

            if (edFiStaffRecognition.CriteriaURLOption.IsSet && edFiStaffRecognition.CriteriaURL == null)
                throw new ArgumentNullException(nameof(edFiStaffRecognition.CriteriaURL), "Property is required for class EdFiStaffRecognition.");

            if (edFiStaffRecognition.EvidenceStatementOption.IsSet && edFiStaffRecognition.EvidenceStatement == null)
                throw new ArgumentNullException(nameof(edFiStaffRecognition.EvidenceStatement), "Property is required for class EdFiStaffRecognition.");

            if (edFiStaffRecognition.ImageURLOption.IsSet && edFiStaffRecognition.ImageURL == null)
                throw new ArgumentNullException(nameof(edFiStaffRecognition.ImageURL), "Property is required for class EdFiStaffRecognition.");

            if (edFiStaffRecognition.IssuerNameOption.IsSet && edFiStaffRecognition.IssuerName == null)
                throw new ArgumentNullException(nameof(edFiStaffRecognition.IssuerName), "Property is required for class EdFiStaffRecognition.");

            if (edFiStaffRecognition.IssuerOriginURLOption.IsSet && edFiStaffRecognition.IssuerOriginURL == null)
                throw new ArgumentNullException(nameof(edFiStaffRecognition.IssuerOriginURL), "Property is required for class EdFiStaffRecognition.");

            if (edFiStaffRecognition.RecognitionDescriptionOption.IsSet && edFiStaffRecognition.RecognitionDescription == null)
                throw new ArgumentNullException(nameof(edFiStaffRecognition.RecognitionDescription), "Property is required for class EdFiStaffRecognition.");
