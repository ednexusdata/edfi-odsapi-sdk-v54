...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiCourseTranscript : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="courseAttemptResultDescriptor">The result from the student&#39;s attempt to take the course, for example:        Pass        Fail        Incomplete        Withdrawn.</param>
    ...
    public class EdFiCourseTranscriptJsonConverter : JsonConverter<EdFiCourseTranscript>
    {
        ...
        public override EdFiCourseTranscript Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (alternativeCourseCode.IsSet && alternativeCourseCode.Value == null)
                throw new ArgumentNullException(nameof(alternativeCourseCode), "Property is not nullable for class EdFiCourseTranscript.");
            ...
            if (alternativeCourseTitle.IsSet && alternativeCourseTitle.Value == null)
                throw new ArgumentNullException(nameof(alternativeCourseTitle), "Property is not nullable for class EdFiCourseTranscript.");

            if (assigningOrganizationIdentificationCode.IsSet && assigningOrganizationIdentificationCode.Value == null)
                throw new ArgumentNullException(nameof(assigningOrganizationIdentificationCode), "Property is not nullable for class EdFiCourseTranscript.");

            if (attemptedCreditConversion.IsSet && attemptedCreditConversion.Value == null)
                throw new ArgumentNullException(nameof(attemptedCreditConversion), "Property is not nullable for class EdFiCourseTranscript.");

            if (attemptedCredits.IsSet && attemptedCredits.Value == null)
                throw new ArgumentNullException(nameof(attemptedCredits), "Property is not nullable for class EdFiCourseTranscript.");

            if (attemptedCreditTypeDescriptor.IsSet && attemptedCreditTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(attemptedCreditTypeDescriptor), "Property is not nullable for class EdFiCourseTranscript.");

            if (courseCatalogURL.IsSet && courseCatalogURL.Value == null)
                throw new ArgumentNullException(nameof(courseCatalogURL), "Property is not nullable for class EdFiCourseTranscript.");

            if (courseRepeatCodeDescriptor.IsSet && courseRepeatCodeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(courseRepeatCodeDescriptor), "Property is not nullable for class EdFiCourseTranscript.");

            if (courseTitle.IsSet && courseTitle.Value == null)
                throw new ArgumentNullException(nameof(courseTitle), "Property is not nullable for class EdFiCourseTranscript.");
            ...
            if (earnedCreditConversion.IsSet && earnedCreditConversion.Value == null)
                throw new ArgumentNullException(nameof(earnedCreditConversion), "Property is not nullable for class EdFiCourseTranscript.");

            if (earnedCreditTypeDescriptor.IsSet && earnedCreditTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(earnedCreditTypeDescriptor), "Property is not nullable for class EdFiCourseTranscript.");

            if (externalEducationOrganizationNameOfInstitution.IsSet && externalEducationOrganizationNameOfInstitution.Value == null)
                throw new ArgumentNullException(nameof(externalEducationOrganizationNameOfInstitution), "Property is not nullable for class EdFiCourseTranscript.");

            if (finalLetterGradeEarned.IsSet && finalLetterGradeEarned.Value == null)
                throw new ArgumentNullException(nameof(finalLetterGradeEarned), "Property is not nullable for class EdFiCourseTranscript.");

            if (finalNumericGradeEarned.IsSet && finalNumericGradeEarned.Value == null)
                throw new ArgumentNullException(nameof(finalNumericGradeEarned), "Property is not nullable for class EdFiCourseTranscript.");

            if (methodCreditEarnedDescriptor.IsSet && methodCreditEarnedDescriptor.Value == null)
                throw new ArgumentNullException(nameof(methodCreditEarnedDescriptor), "Property is not nullable for class EdFiCourseTranscript.");
            ...
            if (whenTakenGradeLevelDescriptor.IsSet && whenTakenGradeLevelDescriptor.Value == null)
                throw new ArgumentNullException(nameof(whenTakenGradeLevelDescriptor), "Property is not nullable for class EdFiCourseTranscript.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiCourseTranscript edFiCourseTranscript, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiCourseTranscript.AlternativeCourseCodeOption.IsSet && edFiCourseTranscript.AlternativeCourseCode == null)
                throw new ArgumentNullException(nameof(edFiCourseTranscript.AlternativeCourseCode), "Property is required for class EdFiCourseTranscript.");
            ...
            if (edFiCourseTranscript.AlternativeCourseTitleOption.IsSet && edFiCourseTranscript.AlternativeCourseTitle == null)
                throw new ArgumentNullException(nameof(edFiCourseTranscript.AlternativeCourseTitle), "Property is required for class EdFiCourseTranscript.");

            if (edFiCourseTranscript.AssigningOrganizationIdentificationCodeOption.IsSet && edFiCourseTranscript.AssigningOrganizationIdentificationCode == null)
                throw new ArgumentNullException(nameof(edFiCourseTranscript.AssigningOrganizationIdentificationCode), "Property is required for class EdFiCourseTranscript.");

            if (edFiCourseTranscript.AttemptedCreditTypeDescriptorOption.IsSet && edFiCourseTranscript.AttemptedCreditTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCourseTranscript.AttemptedCreditTypeDescriptor), "Property is required for class EdFiCourseTranscript.");

            if (edFiCourseTranscript.CourseCatalogURLOption.IsSet && edFiCourseTranscript.CourseCatalogURL == null)
                throw new ArgumentNullException(nameof(edFiCourseTranscript.CourseCatalogURL), "Property is required for class EdFiCourseTranscript.");

            if (edFiCourseTranscript.CourseRepeatCodeDescriptorOption.IsSet && edFiCourseTranscript.CourseRepeatCodeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCourseTranscript.CourseRepeatCodeDescriptor), "Property is required for class EdFiCourseTranscript.");

            if (edFiCourseTranscript.CourseTitleOption.IsSet && edFiCourseTranscript.CourseTitle == null)
                throw new ArgumentNullException(nameof(edFiCourseTranscript.CourseTitle), "Property is required for class EdFiCourseTranscript.");
            ...
            if (edFiCourseTranscript.EarnedCreditTypeDescriptorOption.IsSet && edFiCourseTranscript.EarnedCreditTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCourseTranscript.EarnedCreditTypeDescriptor), "Property is required for class EdFiCourseTranscript.");

            if (edFiCourseTranscript.ExternalEducationOrganizationNameOfInstitutionOption.IsSet && edFiCourseTranscript.ExternalEducationOrganizationNameOfInstitution == null)
                throw new ArgumentNullException(nameof(edFiCourseTranscript.ExternalEducationOrganizationNameOfInstitution), "Property is required for class EdFiCourseTranscript.");

            if (edFiCourseTranscript.FinalLetterGradeEarnedOption.IsSet && edFiCourseTranscript.FinalLetterGradeEarned == null)
                throw new ArgumentNullException(nameof(edFiCourseTranscript.FinalLetterGradeEarned), "Property is required for class EdFiCourseTranscript.");

            if (edFiCourseTranscript.MethodCreditEarnedDescriptorOption.IsSet && edFiCourseTranscript.MethodCreditEarnedDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCourseTranscript.MethodCreditEarnedDescriptor), "Property is required for class EdFiCourseTranscript.");
            ...
            if (edFiCourseTranscript.WhenTakenGradeLevelDescriptorOption.IsSet && edFiCourseTranscript.WhenTakenGradeLevelDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCourseTranscript.WhenTakenGradeLevelDescriptor), "Property is required for class EdFiCourseTranscript.");
