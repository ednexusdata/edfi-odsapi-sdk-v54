    ...
    public class EdFiStudentCTEProgramAssociationCTEProgramJsonConverter : JsonConverter<EdFiStudentCTEProgramAssociationCTEProgram>
    {
        ...
        public override EdFiStudentCTEProgramAssociationCTEProgram Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (cipCode.IsSet && cipCode.Value == null)
                throw new ArgumentNullException(nameof(cipCode), "Property is not nullable for class EdFiStudentCTEProgramAssociationCTEProgram.");

            if (cteProgramCompletionIndicator.IsSet && cteProgramCompletionIndicator.Value == null)
                throw new ArgumentNullException(nameof(cteProgramCompletionIndicator), "Property is not nullable for class EdFiStudentCTEProgramAssociationCTEProgram.");

            if (primaryCTEProgramIndicator.IsSet && primaryCTEProgramIndicator.Value == null)
                throw new ArgumentNullException(nameof(primaryCTEProgramIndicator), "Property is not nullable for class EdFiStudentCTEProgramAssociationCTEProgram.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentCTEProgramAssociationCTEProgram edFiStudentCTEProgramAssociationCTEProgram, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentCTEProgramAssociationCTEProgram.CipCodeOption.IsSet && edFiStudentCTEProgramAssociationCTEProgram.CipCode == null)
                throw new ArgumentNullException(nameof(edFiStudentCTEProgramAssociationCTEProgram.CipCode), "Property is required for class EdFiStudentCTEProgramAssociationCTEProgram.");
