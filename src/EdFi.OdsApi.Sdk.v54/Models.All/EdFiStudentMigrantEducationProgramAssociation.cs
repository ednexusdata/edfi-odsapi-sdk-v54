    ...
    public class EdFiStudentMigrantEducationProgramAssociationJsonConverter : JsonConverter<EdFiStudentMigrantEducationProgramAssociation>
    {
        ...
        public override EdFiStudentMigrantEducationProgramAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (continuationOfServicesReasonDescriptor.IsSet && continuationOfServicesReasonDescriptor.Value == null)
                throw new ArgumentNullException(nameof(continuationOfServicesReasonDescriptor), "Property is not nullable for class EdFiStudentMigrantEducationProgramAssociation.");

            if (eligibilityExpirationDate.IsSet && eligibilityExpirationDate.Value == null)
                throw new ArgumentNullException(nameof(eligibilityExpirationDate), "Property is not nullable for class EdFiStudentMigrantEducationProgramAssociation.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class EdFiStudentMigrantEducationProgramAssociation.");
            ...
            if (qualifyingArrivalDate.IsSet && qualifyingArrivalDate.Value == null)
                throw new ArgumentNullException(nameof(qualifyingArrivalDate), "Property is not nullable for class EdFiStudentMigrantEducationProgramAssociation.");

            if (reasonExitedDescriptor.IsSet && reasonExitedDescriptor.Value == null)
                throw new ArgumentNullException(nameof(reasonExitedDescriptor), "Property is not nullable for class EdFiStudentMigrantEducationProgramAssociation.");

            if (servedOutsideOfRegularSession.IsSet && servedOutsideOfRegularSession.Value == null)
                throw new ArgumentNullException(nameof(servedOutsideOfRegularSession), "Property is not nullable for class EdFiStudentMigrantEducationProgramAssociation.");

            if (stateResidencyDate.IsSet && stateResidencyDate.Value == null)
                throw new ArgumentNullException(nameof(stateResidencyDate), "Property is not nullable for class EdFiStudentMigrantEducationProgramAssociation.");

            if (usInitialEntry.IsSet && usInitialEntry.Value == null)
                throw new ArgumentNullException(nameof(usInitialEntry), "Property is not nullable for class EdFiStudentMigrantEducationProgramAssociation.");

            if (usInitialSchoolEntry.IsSet && usInitialSchoolEntry.Value == null)
                throw new ArgumentNullException(nameof(usInitialSchoolEntry), "Property is not nullable for class EdFiStudentMigrantEducationProgramAssociation.");

            if (usMostRecentEntry.IsSet && usMostRecentEntry.Value == null)
                throw new ArgumentNullException(nameof(usMostRecentEntry), "Property is not nullable for class EdFiStudentMigrantEducationProgramAssociation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentMigrantEducationProgramAssociation edFiStudentMigrantEducationProgramAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentMigrantEducationProgramAssociation.ContinuationOfServicesReasonDescriptorOption.IsSet && edFiStudentMigrantEducationProgramAssociation.ContinuationOfServicesReasonDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentMigrantEducationProgramAssociation.ContinuationOfServicesReasonDescriptor), "Property is required for class EdFiStudentMigrantEducationProgramAssociation.");
            ...
            if (edFiStudentMigrantEducationProgramAssociation.ReasonExitedDescriptorOption.IsSet && edFiStudentMigrantEducationProgramAssociation.ReasonExitedDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentMigrantEducationProgramAssociation.ReasonExitedDescriptor), "Property is required for class EdFiStudentMigrantEducationProgramAssociation.");
