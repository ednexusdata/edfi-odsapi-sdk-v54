...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_accountClassificationDescriptor")]
    public partial class EdFiAccountClassificationDescriptor : IValidatableObject
    {
        ...
        protected EdFiAccountClassificationDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAccountClassificationDescriptor" /> class.
        /// </summary>
        ...
        public EdFiAccountClassificationDescriptor(string id = default, int accountClassificationDescriptorId = default, string codeValue = default, string description = default, DateOnly effectiveBeginDate = default, DateOnly effectiveEndDate = default, string varNamespace = default, int priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAccountClassificationDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "varNamespace" is required (not null)
            if (varNamespace == null)
            {
                throw new ArgumentNullException("varNamespace is a required property for EdFiAccountClassificationDescriptor and cannot be null");
            }
            this.Namespace = varNamespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAccountClassificationDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "accountClassificationDescriptorId", EmitDefaultValue = false)]
        public int AccountClassificationDescriptorId { get; set; }
