    ...
    public class EdFiGraduationPlanCreditsByCreditCategoryJsonConverter : JsonConverter<EdFiGraduationPlanCreditsByCreditCategory>
    {
        ...
        public override EdFiGraduationPlanCreditsByCreditCategory Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (creditTypeDescriptor.IsSet && creditTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(creditTypeDescriptor), "Property is not nullable for class EdFiGraduationPlanCreditsByCreditCategory.");

            if (creditConversion.IsSet && creditConversion.Value == null)
                throw new ArgumentNullException(nameof(creditConversion), "Property is not nullable for class EdFiGraduationPlanCreditsByCreditCategory.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiGraduationPlanCreditsByCreditCategory edFiGraduationPlanCreditsByCreditCategory, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiGraduationPlanCreditsByCreditCategory.CreditTypeDescriptorOption.IsSet && edFiGraduationPlanCreditsByCreditCategory.CreditTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiGraduationPlanCreditsByCreditCategory.CreditTypeDescriptor), "Property is required for class EdFiGraduationPlanCreditsByCreditCategory.");
