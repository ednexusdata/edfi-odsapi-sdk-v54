    ...
    public class EdFiAssessmentScoreJsonConverter : JsonConverter<EdFiAssessmentScore>
    {
        ...
        public override EdFiAssessmentScore Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (resultDatatypeTypeDescriptor.IsSet && resultDatatypeTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(resultDatatypeTypeDescriptor), "Property is not nullable for class EdFiAssessmentScore.");

            if (maximumScore.IsSet && maximumScore.Value == null)
                throw new ArgumentNullException(nameof(maximumScore), "Property is not nullable for class EdFiAssessmentScore.");

            if (minimumScore.IsSet && minimumScore.Value == null)
                throw new ArgumentNullException(nameof(minimumScore), "Property is not nullable for class EdFiAssessmentScore.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiAssessmentScore edFiAssessmentScore, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiAssessmentScore.ResultDatatypeTypeDescriptorOption.IsSet && edFiAssessmentScore.ResultDatatypeTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiAssessmentScore.ResultDatatypeTypeDescriptor), "Property is required for class EdFiAssessmentScore.");

            if (edFiAssessmentScore.MaximumScoreOption.IsSet && edFiAssessmentScore.MaximumScore == null)
                throw new ArgumentNullException(nameof(edFiAssessmentScore.MaximumScore), "Property is required for class EdFiAssessmentScore.");

            if (edFiAssessmentScore.MinimumScoreOption.IsSet && edFiAssessmentScore.MinimumScore == null)
                throw new ArgumentNullException(nameof(edFiAssessmentScore.MinimumScore), "Property is required for class EdFiAssessmentScore.");
