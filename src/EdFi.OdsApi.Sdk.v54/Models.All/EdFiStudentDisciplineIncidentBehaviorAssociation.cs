    ...
    public class EdFiStudentDisciplineIncidentBehaviorAssociationJsonConverter : JsonConverter<EdFiStudentDisciplineIncidentBehaviorAssociation>
    {
        ...
        public override EdFiStudentDisciplineIncidentBehaviorAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (behaviorDetailedDescription.IsSet && behaviorDetailedDescription.Value == null)
                throw new ArgumentNullException(nameof(behaviorDetailedDescription), "Property is not nullable for class EdFiStudentDisciplineIncidentBehaviorAssociation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentDisciplineIncidentBehaviorAssociation edFiStudentDisciplineIncidentBehaviorAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentDisciplineIncidentBehaviorAssociation.BehaviorDetailedDescriptionOption.IsSet && edFiStudentDisciplineIncidentBehaviorAssociation.BehaviorDetailedDescription == null)
                throw new ArgumentNullException(nameof(edFiStudentDisciplineIncidentBehaviorAssociation.BehaviorDetailedDescription), "Property is required for class EdFiStudentDisciplineIncidentBehaviorAssociation.");
