    ...
    public class EdFiRestraintEventJsonConverter : JsonConverter<EdFiRestraintEvent>
    {
        ...
        public override EdFiRestraintEvent Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (educationalEnvironmentDescriptor.IsSet && educationalEnvironmentDescriptor.Value == null)
                throw new ArgumentNullException(nameof(educationalEnvironmentDescriptor), "Property is not nullable for class EdFiRestraintEvent.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiRestraintEvent edFiRestraintEvent, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiRestraintEvent.EducationalEnvironmentDescriptorOption.IsSet && edFiRestraintEvent.EducationalEnvironmentDescriptor == null)
                throw new ArgumentNullException(nameof(edFiRestraintEvent.EducationalEnvironmentDescriptor), "Property is required for class EdFiRestraintEvent.");
