...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiAssessmentItem : IValidatableObject
    {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> CorrectResponseOption { get; private set; }
        ...
        public string? CorrectResponse { get { return this.CorrectResponseOption; } set { this.CorrectResponseOption = new(value); } }
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for CorrectResponse, length must be less than 20.", new [] { "CorrectResponse" });
            }
    ...
    public class EdFiAssessmentItemJsonConverter : JsonConverter<EdFiAssessmentItem>
    {
        ...
        public override EdFiAssessmentItem Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<string?> correctResponse = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "correctResponse":
                            correctResponse = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
            ...
            if (assessmentItemCategoryDescriptor.IsSet && assessmentItemCategoryDescriptor.Value == null)
                throw new ArgumentNullException(nameof(assessmentItemCategoryDescriptor), "Property is not nullable for class EdFiAssessmentItem.");

            if (assessmentItemURI.IsSet && assessmentItemURI.Value == null)
                throw new ArgumentNullException(nameof(assessmentItemURI), "Property is not nullable for class EdFiAssessmentItem.");

            if (correctResponse.IsSet && correctResponse.Value == null)
                throw new ArgumentNullException(nameof(correctResponse), "Property is not nullable for class EdFiAssessmentItem.");

            if (expectedTimeAssessed.IsSet && expectedTimeAssessed.Value == null)
                throw new ArgumentNullException(nameof(expectedTimeAssessed), "Property is not nullable for class EdFiAssessmentItem.");

            if (itemText.IsSet && itemText.Value == null)
                throw new ArgumentNullException(nameof(itemText), "Property is not nullable for class EdFiAssessmentItem.");
            ...
            if (maxRawScore.IsSet && maxRawScore.Value == null)
                throw new ArgumentNullException(nameof(maxRawScore), "Property is not nullable for class EdFiAssessmentItem.");

            if (nomenclature.IsSet && nomenclature.Value == null)
                throw new ArgumentNullException(nameof(nomenclature), "Property is not nullable for class EdFiAssessmentItem.");
            ...
            return new EdFiAssessmentItem(identificationCode.Value!, assessmentReference.Value!, id, assessmentItemCategoryDescriptor, assessmentItemURI, correctResponse, expectedTimeAssessed, itemText, learningStandards, maxRawScore, nomenclature, possibleResponses, etag, ext);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiAssessmentItem edFiAssessmentItem, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiAssessmentItem.AssessmentItemCategoryDescriptorOption.IsSet && edFiAssessmentItem.AssessmentItemCategoryDescriptor == null)
                throw new ArgumentNullException(nameof(edFiAssessmentItem.AssessmentItemCategoryDescriptor), "Property is required for class EdFiAssessmentItem.");

            if (edFiAssessmentItem.AssessmentItemURIOption.IsSet && edFiAssessmentItem.AssessmentItemURI == null)
                throw new ArgumentNullException(nameof(edFiAssessmentItem.AssessmentItemURI), "Property is required for class EdFiAssessmentItem.");

            if (edFiAssessmentItem.CorrectResponseOption.IsSet && edFiAssessmentItem.CorrectResponse == null)
                throw new ArgumentNullException(nameof(edFiAssessmentItem.CorrectResponse), "Property is required for class EdFiAssessmentItem.");

            if (edFiAssessmentItem.ExpectedTimeAssessedOption.IsSet && edFiAssessmentItem.ExpectedTimeAssessed == null)
                throw new ArgumentNullException(nameof(edFiAssessmentItem.ExpectedTimeAssessed), "Property is required for class EdFiAssessmentItem.");

            if (edFiAssessmentItem.ItemTextOption.IsSet && edFiAssessmentItem.ItemText == null)
                throw new ArgumentNullException(nameof(edFiAssessmentItem.ItemText), "Property is required for class EdFiAssessmentItem.");
            ...
            if (edFiAssessmentItem.NomenclatureOption.IsSet && edFiAssessmentItem.Nomenclature == null)
                throw new ArgumentNullException(nameof(edFiAssessmentItem.Nomenclature), "Property is required for class EdFiAssessmentItem.");
            ...
            if (edFiAssessmentItem.CorrectResponseOption.IsSet)
                writer.WriteString("correctResponse", edFiAssessmentItem.CorrectResponse);
