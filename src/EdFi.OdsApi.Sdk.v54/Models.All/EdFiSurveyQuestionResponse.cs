    ...
    public class EdFiSurveyQuestionResponseJsonConverter : JsonConverter<EdFiSurveyQuestionResponse>
    {
        ...
        public override EdFiSurveyQuestionResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (comment.IsSet && comment.Value == null)
                throw new ArgumentNullException(nameof(comment), "Property is not nullable for class EdFiSurveyQuestionResponse.");

            if (noResponse.IsSet && noResponse.Value == null)
                throw new ArgumentNullException(nameof(noResponse), "Property is not nullable for class EdFiSurveyQuestionResponse.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiSurveyQuestionResponse edFiSurveyQuestionResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiSurveyQuestionResponse.CommentOption.IsSet && edFiSurveyQuestionResponse.Comment == null)
                throw new ArgumentNullException(nameof(edFiSurveyQuestionResponse.Comment), "Property is required for class EdFiSurveyQuestionResponse.");
