    ...
    public class EdFiInterventionJsonConverter : JsonConverter<EdFiIntervention>
    {
        ...
        public override EdFiIntervention Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class EdFiIntervention.");
            ...
            if (maxDosage.IsSet && maxDosage.Value == null)
                throw new ArgumentNullException(nameof(maxDosage), "Property is not nullable for class EdFiIntervention.");
            ...
            if (minDosage.IsSet && minDosage.Value == null)
                throw new ArgumentNullException(nameof(minDosage), "Property is not nullable for class EdFiIntervention.");
