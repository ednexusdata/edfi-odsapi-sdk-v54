    ...
    public class EdFiInterventionPrescriptionJsonConverter : JsonConverter<EdFiInterventionPrescription>
    {
        ...
        public override EdFiInterventionPrescription Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (maxDosage.IsSet && maxDosage.Value == null)
                throw new ArgumentNullException(nameof(maxDosage), "Property is not nullable for class EdFiInterventionPrescription.");

            if (minDosage.IsSet && minDosage.Value == null)
                throw new ArgumentNullException(nameof(minDosage), "Property is not nullable for class EdFiInterventionPrescription.");
