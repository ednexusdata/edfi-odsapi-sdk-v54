    ...
    public class EdFiGeneralStudentProgramAssociationProgramParticipationStatusJsonConverter : JsonConverter<EdFiGeneralStudentProgramAssociationProgramParticipationStatus>
    {
        ...
        public override EdFiGeneralStudentProgramAssociationProgramParticipationStatus Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (designatedBy.IsSet && designatedBy.Value == null)
                throw new ArgumentNullException(nameof(designatedBy), "Property is not nullable for class EdFiGeneralStudentProgramAssociationProgramParticipationStatus.");

            if (statusEndDate.IsSet && statusEndDate.Value == null)
                throw new ArgumentNullException(nameof(statusEndDate), "Property is not nullable for class EdFiGeneralStudentProgramAssociationProgramParticipationStatus.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiGeneralStudentProgramAssociationProgramParticipationStatus edFiGeneralStudentProgramAssociationProgramParticipationStatus, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiGeneralStudentProgramAssociationProgramParticipationStatus.DesignatedByOption.IsSet && edFiGeneralStudentProgramAssociationProgramParticipationStatus.DesignatedBy == null)
                throw new ArgumentNullException(nameof(edFiGeneralStudentProgramAssociationProgramParticipationStatus.DesignatedBy), "Property is required for class EdFiGeneralStudentProgramAssociationProgramParticipationStatus.");
