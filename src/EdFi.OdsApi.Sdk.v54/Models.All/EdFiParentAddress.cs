    ...
    public class EdFiParentAddressJsonConverter : JsonConverter<EdFiParentAddress>
    {
        ...
        public override EdFiParentAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (localeDescriptor.IsSet && localeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(localeDescriptor), "Property is not nullable for class EdFiParentAddress.");

            if (apartmentRoomSuiteNumber.IsSet && apartmentRoomSuiteNumber.Value == null)
                throw new ArgumentNullException(nameof(apartmentRoomSuiteNumber), "Property is not nullable for class EdFiParentAddress.");

            if (buildingSiteNumber.IsSet && buildingSiteNumber.Value == null)
                throw new ArgumentNullException(nameof(buildingSiteNumber), "Property is not nullable for class EdFiParentAddress.");

            if (congressionalDistrict.IsSet && congressionalDistrict.Value == null)
                throw new ArgumentNullException(nameof(congressionalDistrict), "Property is not nullable for class EdFiParentAddress.");

            if (countyFIPSCode.IsSet && countyFIPSCode.Value == null)
                throw new ArgumentNullException(nameof(countyFIPSCode), "Property is not nullable for class EdFiParentAddress.");

            if (doNotPublishIndicator.IsSet && doNotPublishIndicator.Value == null)
                throw new ArgumentNullException(nameof(doNotPublishIndicator), "Property is not nullable for class EdFiParentAddress.");

            if (latitude.IsSet && latitude.Value == null)
                throw new ArgumentNullException(nameof(latitude), "Property is not nullable for class EdFiParentAddress.");

            if (longitude.IsSet && longitude.Value == null)
                throw new ArgumentNullException(nameof(longitude), "Property is not nullable for class EdFiParentAddress.");

            if (nameOfCounty.IsSet && nameOfCounty.Value == null)
                throw new ArgumentNullException(nameof(nameOfCounty), "Property is not nullable for class EdFiParentAddress.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiParentAddress edFiParentAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiParentAddress.LocaleDescriptorOption.IsSet && edFiParentAddress.LocaleDescriptor == null)
                throw new ArgumentNullException(nameof(edFiParentAddress.LocaleDescriptor), "Property is required for class EdFiParentAddress.");

            if (edFiParentAddress.ApartmentRoomSuiteNumberOption.IsSet && edFiParentAddress.ApartmentRoomSuiteNumber == null)
                throw new ArgumentNullException(nameof(edFiParentAddress.ApartmentRoomSuiteNumber), "Property is required for class EdFiParentAddress.");

            if (edFiParentAddress.BuildingSiteNumberOption.IsSet && edFiParentAddress.BuildingSiteNumber == null)
                throw new ArgumentNullException(nameof(edFiParentAddress.BuildingSiteNumber), "Property is required for class EdFiParentAddress.");

            if (edFiParentAddress.CongressionalDistrictOption.IsSet && edFiParentAddress.CongressionalDistrict == null)
                throw new ArgumentNullException(nameof(edFiParentAddress.CongressionalDistrict), "Property is required for class EdFiParentAddress.");

            if (edFiParentAddress.CountyFIPSCodeOption.IsSet && edFiParentAddress.CountyFIPSCode == null)
                throw new ArgumentNullException(nameof(edFiParentAddress.CountyFIPSCode), "Property is required for class EdFiParentAddress.");

            if (edFiParentAddress.LatitudeOption.IsSet && edFiParentAddress.Latitude == null)
                throw new ArgumentNullException(nameof(edFiParentAddress.Latitude), "Property is required for class EdFiParentAddress.");

            if (edFiParentAddress.LongitudeOption.IsSet && edFiParentAddress.Longitude == null)
                throw new ArgumentNullException(nameof(edFiParentAddress.Longitude), "Property is required for class EdFiParentAddress.");

            if (edFiParentAddress.NameOfCountyOption.IsSet && edFiParentAddress.NameOfCounty == null)
                throw new ArgumentNullException(nameof(edFiParentAddress.NameOfCounty), "Property is required for class EdFiParentAddress.");
