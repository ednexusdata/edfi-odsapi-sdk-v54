    ...
    public class EdFiEducationServiceCenterJsonConverter : JsonConverter<EdFiEducationServiceCenter>
    {
        ...
        public override EdFiEducationServiceCenter Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (operationalStatusDescriptor.IsSet && operationalStatusDescriptor.Value == null)
                throw new ArgumentNullException(nameof(operationalStatusDescriptor), "Property is not nullable for class EdFiEducationServiceCenter.");

            if (shortNameOfInstitution.IsSet && shortNameOfInstitution.Value == null)
                throw new ArgumentNullException(nameof(shortNameOfInstitution), "Property is not nullable for class EdFiEducationServiceCenter.");

            if (webSite.IsSet && webSite.Value == null)
                throw new ArgumentNullException(nameof(webSite), "Property is not nullable for class EdFiEducationServiceCenter.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiEducationServiceCenter edFiEducationServiceCenter, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiEducationServiceCenter.OperationalStatusDescriptorOption.IsSet && edFiEducationServiceCenter.OperationalStatusDescriptor == null)
                throw new ArgumentNullException(nameof(edFiEducationServiceCenter.OperationalStatusDescriptor), "Property is required for class EdFiEducationServiceCenter.");

            if (edFiEducationServiceCenter.ShortNameOfInstitutionOption.IsSet && edFiEducationServiceCenter.ShortNameOfInstitution == null)
                throw new ArgumentNullException(nameof(edFiEducationServiceCenter.ShortNameOfInstitution), "Property is required for class EdFiEducationServiceCenter.");

            if (edFiEducationServiceCenter.WebSiteOption.IsSet && edFiEducationServiceCenter.WebSite == null)
                throw new ArgumentNullException(nameof(edFiEducationServiceCenter.WebSite), "Property is required for class EdFiEducationServiceCenter.");
