    ...
    public class EdFiStudentCTEProgramAssociationJsonConverter : JsonConverter<EdFiStudentCTEProgramAssociation>
    {
        ...
        public override EdFiStudentCTEProgramAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class EdFiStudentCTEProgramAssociation.");

            if (nonTraditionalGenderStatus.IsSet && nonTraditionalGenderStatus.Value == null)
                throw new ArgumentNullException(nameof(nonTraditionalGenderStatus), "Property is not nullable for class EdFiStudentCTEProgramAssociation.");
            ...
            if (privateCTEProgram.IsSet && privateCTEProgram.Value == null)
                throw new ArgumentNullException(nameof(privateCTEProgram), "Property is not nullable for class EdFiStudentCTEProgramAssociation.");
            ...
            if (reasonExitedDescriptor.IsSet && reasonExitedDescriptor.Value == null)
                throw new ArgumentNullException(nameof(reasonExitedDescriptor), "Property is not nullable for class EdFiStudentCTEProgramAssociation.");

            if (servedOutsideOfRegularSession.IsSet && servedOutsideOfRegularSession.Value == null)
                throw new ArgumentNullException(nameof(servedOutsideOfRegularSession), "Property is not nullable for class EdFiStudentCTEProgramAssociation.");
            ...
            if (technicalSkillsAssessmentDescriptor.IsSet && technicalSkillsAssessmentDescriptor.Value == null)
                throw new ArgumentNullException(nameof(technicalSkillsAssessmentDescriptor), "Property is not nullable for class EdFiStudentCTEProgramAssociation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentCTEProgramAssociation edFiStudentCTEProgramAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentCTEProgramAssociation.ReasonExitedDescriptorOption.IsSet && edFiStudentCTEProgramAssociation.ReasonExitedDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentCTEProgramAssociation.ReasonExitedDescriptor), "Property is required for class EdFiStudentCTEProgramAssociation.");
            ...
            if (edFiStudentCTEProgramAssociation.TechnicalSkillsAssessmentDescriptorOption.IsSet && edFiStudentCTEProgramAssociation.TechnicalSkillsAssessmentDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentCTEProgramAssociation.TechnicalSkillsAssessmentDescriptor), "Property is required for class EdFiStudentCTEProgramAssociation.");
