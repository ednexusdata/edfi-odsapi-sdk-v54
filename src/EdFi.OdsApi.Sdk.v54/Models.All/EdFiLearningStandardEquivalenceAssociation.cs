    ...
    public class EdFiLearningStandardEquivalenceAssociationJsonConverter : JsonConverter<EdFiLearningStandardEquivalenceAssociation>
    {
        ...
        public override EdFiLearningStandardEquivalenceAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (effectiveDate.IsSet && effectiveDate.Value == null)
                throw new ArgumentNullException(nameof(effectiveDate), "Property is not nullable for class EdFiLearningStandardEquivalenceAssociation.");

            if (learningStandardEquivalenceStrengthDescription.IsSet && learningStandardEquivalenceStrengthDescription.Value == null)
                throw new ArgumentNullException(nameof(learningStandardEquivalenceStrengthDescription), "Property is not nullable for class EdFiLearningStandardEquivalenceAssociation.");

            if (learningStandardEquivalenceStrengthDescriptor.IsSet && learningStandardEquivalenceStrengthDescriptor.Value == null)
                throw new ArgumentNullException(nameof(learningStandardEquivalenceStrengthDescriptor), "Property is not nullable for class EdFiLearningStandardEquivalenceAssociation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiLearningStandardEquivalenceAssociation edFiLearningStandardEquivalenceAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiLearningStandardEquivalenceAssociation.LearningStandardEquivalenceStrengthDescriptionOption.IsSet && edFiLearningStandardEquivalenceAssociation.LearningStandardEquivalenceStrengthDescription == null)
                throw new ArgumentNullException(nameof(edFiLearningStandardEquivalenceAssociation.LearningStandardEquivalenceStrengthDescription), "Property is required for class EdFiLearningStandardEquivalenceAssociation.");

            if (edFiLearningStandardEquivalenceAssociation.LearningStandardEquivalenceStrengthDescriptorOption.IsSet && edFiLearningStandardEquivalenceAssociation.LearningStandardEquivalenceStrengthDescriptor == null)
                throw new ArgumentNullException(nameof(edFiLearningStandardEquivalenceAssociation.LearningStandardEquivalenceStrengthDescriptor), "Property is required for class EdFiLearningStandardEquivalenceAssociation.");
