    ...
    public class EdFiParentJsonConverter : JsonConverter<EdFiParent>
    {
        ...
        public override EdFiParent Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (generationCodeSuffix.IsSet && generationCodeSuffix.Value == null)
                throw new ArgumentNullException(nameof(generationCodeSuffix), "Property is not nullable for class EdFiParent.");

            if (highestCompletedLevelOfEducationDescriptor.IsSet && highestCompletedLevelOfEducationDescriptor.Value == null)
                throw new ArgumentNullException(nameof(highestCompletedLevelOfEducationDescriptor), "Property is not nullable for class EdFiParent.");
            ...
            if (loginId.IsSet && loginId.Value == null)
                throw new ArgumentNullException(nameof(loginId), "Property is not nullable for class EdFiParent.");

            if (maidenName.IsSet && maidenName.Value == null)
                throw new ArgumentNullException(nameof(maidenName), "Property is not nullable for class EdFiParent.");

            if (middleName.IsSet && middleName.Value == null)
                throw new ArgumentNullException(nameof(middleName), "Property is not nullable for class EdFiParent.");
            ...
            if (personalTitlePrefix.IsSet && personalTitlePrefix.Value == null)
                throw new ArgumentNullException(nameof(personalTitlePrefix), "Property is not nullable for class EdFiParent.");

            if (sexDescriptor.IsSet && sexDescriptor.Value == null)
                throw new ArgumentNullException(nameof(sexDescriptor), "Property is not nullable for class EdFiParent.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiParent edFiParent, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiParent.GenerationCodeSuffixOption.IsSet && edFiParent.GenerationCodeSuffix == null)
                throw new ArgumentNullException(nameof(edFiParent.GenerationCodeSuffix), "Property is required for class EdFiParent.");

            if (edFiParent.HighestCompletedLevelOfEducationDescriptorOption.IsSet && edFiParent.HighestCompletedLevelOfEducationDescriptor == null)
                throw new ArgumentNullException(nameof(edFiParent.HighestCompletedLevelOfEducationDescriptor), "Property is required for class EdFiParent.");
            ...
            if (edFiParent.LoginIdOption.IsSet && edFiParent.LoginId == null)
                throw new ArgumentNullException(nameof(edFiParent.LoginId), "Property is required for class EdFiParent.");

            if (edFiParent.MaidenNameOption.IsSet && edFiParent.MaidenName == null)
                throw new ArgumentNullException(nameof(edFiParent.MaidenName), "Property is required for class EdFiParent.");

            if (edFiParent.MiddleNameOption.IsSet && edFiParent.MiddleName == null)
                throw new ArgumentNullException(nameof(edFiParent.MiddleName), "Property is required for class EdFiParent.");
            ...
            if (edFiParent.PersonalTitlePrefixOption.IsSet && edFiParent.PersonalTitlePrefix == null)
                throw new ArgumentNullException(nameof(edFiParent.PersonalTitlePrefix), "Property is required for class EdFiParent.");

            if (edFiParent.SexDescriptorOption.IsSet && edFiParent.SexDescriptor == null)
                throw new ArgumentNullException(nameof(edFiParent.SexDescriptor), "Property is required for class EdFiParent.");
