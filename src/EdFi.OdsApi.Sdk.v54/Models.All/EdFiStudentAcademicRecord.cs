...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public class EdFiStudentAcademicRecordJsonConverter : JsonConverter<EdFiStudentAcademicRecord>
    {
        ...
        public override EdFiStudentAcademicRecord Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (cumulativeAttemptedCreditConversion.IsSet && cumulativeAttemptedCreditConversion.Value == null)
                throw new ArgumentNullException(nameof(cumulativeAttemptedCreditConversion), "Property is not nullable for class EdFiStudentAcademicRecord.");

            if (cumulativeAttemptedCredits.IsSet && cumulativeAttemptedCredits.Value == null)
                throw new ArgumentNullException(nameof(cumulativeAttemptedCredits), "Property is not nullable for class EdFiStudentAcademicRecord.");

            if (cumulativeAttemptedCreditTypeDescriptor.IsSet && cumulativeAttemptedCreditTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(cumulativeAttemptedCreditTypeDescriptor), "Property is not nullable for class EdFiStudentAcademicRecord.");

            if (cumulativeEarnedCreditConversion.IsSet && cumulativeEarnedCreditConversion.Value == null)
                throw new ArgumentNullException(nameof(cumulativeEarnedCreditConversion), "Property is not nullable for class EdFiStudentAcademicRecord.");

            if (cumulativeEarnedCredits.IsSet && cumulativeEarnedCredits.Value == null)
                throw new ArgumentNullException(nameof(cumulativeEarnedCredits), "Property is not nullable for class EdFiStudentAcademicRecord.");

            if (cumulativeEarnedCreditTypeDescriptor.IsSet && cumulativeEarnedCreditTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(cumulativeEarnedCreditTypeDescriptor), "Property is not nullable for class EdFiStudentAcademicRecord.");

            if (cumulativeGradePointAverage.IsSet && cumulativeGradePointAverage.Value == null)
                throw new ArgumentNullException(nameof(cumulativeGradePointAverage), "Property is not nullable for class EdFiStudentAcademicRecord.");

            if (cumulativeGradePointsEarned.IsSet && cumulativeGradePointsEarned.Value == null)
                throw new ArgumentNullException(nameof(cumulativeGradePointsEarned), "Property is not nullable for class EdFiStudentAcademicRecord.");
            ...
            if (gradeValueQualifier.IsSet && gradeValueQualifier.Value == null)
                throw new ArgumentNullException(nameof(gradeValueQualifier), "Property is not nullable for class EdFiStudentAcademicRecord.");

            if (projectedGraduationDate.IsSet && projectedGraduationDate.Value == null)
                throw new ArgumentNullException(nameof(projectedGraduationDate), "Property is not nullable for class EdFiStudentAcademicRecord.");
            ...
            if (sessionAttemptedCreditConversion.IsSet && sessionAttemptedCreditConversion.Value == null)
                throw new ArgumentNullException(nameof(sessionAttemptedCreditConversion), "Property is not nullable for class EdFiStudentAcademicRecord.");

            if (sessionAttemptedCredits.IsSet && sessionAttemptedCredits.Value == null)
                throw new ArgumentNullException(nameof(sessionAttemptedCredits), "Property is not nullable for class EdFiStudentAcademicRecord.");

            if (sessionAttemptedCreditTypeDescriptor.IsSet && sessionAttemptedCreditTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(sessionAttemptedCreditTypeDescriptor), "Property is not nullable for class EdFiStudentAcademicRecord.");

            if (sessionEarnedCreditConversion.IsSet && sessionEarnedCreditConversion.Value == null)
                throw new ArgumentNullException(nameof(sessionEarnedCreditConversion), "Property is not nullable for class EdFiStudentAcademicRecord.");

            if (sessionEarnedCredits.IsSet && sessionEarnedCredits.Value == null)
                throw new ArgumentNullException(nameof(sessionEarnedCredits), "Property is not nullable for class EdFiStudentAcademicRecord.");

            if (sessionEarnedCreditTypeDescriptor.IsSet && sessionEarnedCreditTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(sessionEarnedCreditTypeDescriptor), "Property is not nullable for class EdFiStudentAcademicRecord.");

            if (sessionGradePointAverage.IsSet && sessionGradePointAverage.Value == null)
                throw new ArgumentNullException(nameof(sessionGradePointAverage), "Property is not nullable for class EdFiStudentAcademicRecord.");

            if (sessionGradePointsEarned.IsSet && sessionGradePointsEarned.Value == null)
                throw new ArgumentNullException(nameof(sessionGradePointsEarned), "Property is not nullable for class EdFiStudentAcademicRecord.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentAcademicRecord edFiStudentAcademicRecord, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentAcademicRecord.CumulativeAttemptedCreditTypeDescriptorOption.IsSet && edFiStudentAcademicRecord.CumulativeAttemptedCreditTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecord.CumulativeAttemptedCreditTypeDescriptor), "Property is required for class EdFiStudentAcademicRecord.");

            if (edFiStudentAcademicRecord.CumulativeEarnedCreditTypeDescriptorOption.IsSet && edFiStudentAcademicRecord.CumulativeEarnedCreditTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecord.CumulativeEarnedCreditTypeDescriptor), "Property is required for class EdFiStudentAcademicRecord.");
            ...
            if (edFiStudentAcademicRecord.GradeValueQualifierOption.IsSet && edFiStudentAcademicRecord.GradeValueQualifier == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecord.GradeValueQualifier), "Property is required for class EdFiStudentAcademicRecord.");
            ...
            if (edFiStudentAcademicRecord.SessionAttemptedCreditTypeDescriptorOption.IsSet && edFiStudentAcademicRecord.SessionAttemptedCreditTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecord.SessionAttemptedCreditTypeDescriptor), "Property is required for class EdFiStudentAcademicRecord.");

            if (edFiStudentAcademicRecord.SessionEarnedCreditTypeDescriptorOption.IsSet && edFiStudentAcademicRecord.SessionEarnedCreditTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecord.SessionEarnedCreditTypeDescriptor), "Property is required for class EdFiStudentAcademicRecord.");
