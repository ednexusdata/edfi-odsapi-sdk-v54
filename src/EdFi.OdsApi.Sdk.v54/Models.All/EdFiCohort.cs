    ...
    public class EdFiCohortJsonConverter : JsonConverter<EdFiCohort>
    {
        ...
        public override EdFiCohort Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (academicSubjectDescriptor.IsSet && academicSubjectDescriptor.Value == null)
                throw new ArgumentNullException(nameof(academicSubjectDescriptor), "Property is not nullable for class EdFiCohort.");

            if (cohortDescription.IsSet && cohortDescription.Value == null)
                throw new ArgumentNullException(nameof(cohortDescription), "Property is not nullable for class EdFiCohort.");

            if (cohortScopeDescriptor.IsSet && cohortScopeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(cohortScopeDescriptor), "Property is not nullable for class EdFiCohort.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiCohort edFiCohort, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiCohort.AcademicSubjectDescriptorOption.IsSet && edFiCohort.AcademicSubjectDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCohort.AcademicSubjectDescriptor), "Property is required for class EdFiCohort.");

            if (edFiCohort.CohortDescriptionOption.IsSet && edFiCohort.CohortDescription == null)
                throw new ArgumentNullException(nameof(edFiCohort.CohortDescription), "Property is required for class EdFiCohort.");

            if (edFiCohort.CohortScopeDescriptorOption.IsSet && edFiCohort.CohortScopeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCohort.CohortScopeDescriptor), "Property is required for class EdFiCohort.");
