    ...
    public class EdFiParentInternationalAddressJsonConverter : JsonConverter<EdFiParentInternationalAddress>
    {
        ...
        public override EdFiParentInternationalAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class EdFiParentInternationalAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class EdFiParentInternationalAddress.");

            if (addressLine4.IsSet && addressLine4.Value == null)
                throw new ArgumentNullException(nameof(addressLine4), "Property is not nullable for class EdFiParentInternationalAddress.");

            if (beginDate.IsSet && beginDate.Value == null)
                throw new ArgumentNullException(nameof(beginDate), "Property is not nullable for class EdFiParentInternationalAddress.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class EdFiParentInternationalAddress.");

            if (latitude.IsSet && latitude.Value == null)
                throw new ArgumentNullException(nameof(latitude), "Property is not nullable for class EdFiParentInternationalAddress.");

            if (longitude.IsSet && longitude.Value == null)
                throw new ArgumentNullException(nameof(longitude), "Property is not nullable for class EdFiParentInternationalAddress.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiParentInternationalAddress edFiParentInternationalAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiParentInternationalAddress.AddressLine2Option.IsSet && edFiParentInternationalAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(edFiParentInternationalAddress.AddressLine2), "Property is required for class EdFiParentInternationalAddress.");

            if (edFiParentInternationalAddress.AddressLine3Option.IsSet && edFiParentInternationalAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(edFiParentInternationalAddress.AddressLine3), "Property is required for class EdFiParentInternationalAddress.");

            if (edFiParentInternationalAddress.AddressLine4Option.IsSet && edFiParentInternationalAddress.AddressLine4 == null)
                throw new ArgumentNullException(nameof(edFiParentInternationalAddress.AddressLine4), "Property is required for class EdFiParentInternationalAddress.");

            if (edFiParentInternationalAddress.LatitudeOption.IsSet && edFiParentInternationalAddress.Latitude == null)
                throw new ArgumentNullException(nameof(edFiParentInternationalAddress.Latitude), "Property is required for class EdFiParentInternationalAddress.");

            if (edFiParentInternationalAddress.LongitudeOption.IsSet && edFiParentInternationalAddress.Longitude == null)
                throw new ArgumentNullException(nameof(edFiParentInternationalAddress.Longitude), "Property is required for class EdFiParentInternationalAddress.");
