...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiAssessmentPerformanceLevel : IValidatableObject
    {
        ...
        public EdFiAssessmentPerformanceLevel(string assessmentReportingMethodDescriptor = default, string performanceLevelDescriptor = default, string resultDatatypeTypeDescriptor = default, string maximumScore = default, string minimumScore = default, Object ext = default)
        {
