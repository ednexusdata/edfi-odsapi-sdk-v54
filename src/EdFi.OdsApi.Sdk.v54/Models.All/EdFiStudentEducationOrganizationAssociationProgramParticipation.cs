    ...
    public class EdFiStudentEducationOrganizationAssociationProgramParticipationJsonConverter : JsonConverter<EdFiStudentEducationOrganizationAssociationProgramParticipation>
    {
        ...
        public override EdFiStudentEducationOrganizationAssociationProgramParticipation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (beginDate.IsSet && beginDate.Value == null)
                throw new ArgumentNullException(nameof(beginDate), "Property is not nullable for class EdFiStudentEducationOrganizationAssociationProgramParticipation.");

            if (designatedBy.IsSet && designatedBy.Value == null)
                throw new ArgumentNullException(nameof(designatedBy), "Property is not nullable for class EdFiStudentEducationOrganizationAssociationProgramParticipation.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class EdFiStudentEducationOrganizationAssociationProgramParticipation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentEducationOrganizationAssociationProgramParticipation edFiStudentEducationOrganizationAssociationProgramParticipation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentEducationOrganizationAssociationProgramParticipation.DesignatedByOption.IsSet && edFiStudentEducationOrganizationAssociationProgramParticipation.DesignatedBy == null)
                throw new ArgumentNullException(nameof(edFiStudentEducationOrganizationAssociationProgramParticipation.DesignatedBy), "Property is required for class EdFiStudentEducationOrganizationAssociationProgramParticipation.");
