    ...
    public class EdFiStudentProgramAttendanceEventJsonConverter : JsonConverter<EdFiStudentProgramAttendanceEvent>
    {
        ...
        public override EdFiStudentProgramAttendanceEvent Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (attendanceEventReason.IsSet && attendanceEventReason.Value == null)
                throw new ArgumentNullException(nameof(attendanceEventReason), "Property is not nullable for class EdFiStudentProgramAttendanceEvent.");

            if (educationalEnvironmentDescriptor.IsSet && educationalEnvironmentDescriptor.Value == null)
                throw new ArgumentNullException(nameof(educationalEnvironmentDescriptor), "Property is not nullable for class EdFiStudentProgramAttendanceEvent.");

            if (eventDuration.IsSet && eventDuration.Value == null)
                throw new ArgumentNullException(nameof(eventDuration), "Property is not nullable for class EdFiStudentProgramAttendanceEvent.");

            if (programAttendanceDuration.IsSet && programAttendanceDuration.Value == null)
                throw new ArgumentNullException(nameof(programAttendanceDuration), "Property is not nullable for class EdFiStudentProgramAttendanceEvent.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentProgramAttendanceEvent edFiStudentProgramAttendanceEvent, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentProgramAttendanceEvent.AttendanceEventReasonOption.IsSet && edFiStudentProgramAttendanceEvent.AttendanceEventReason == null)
                throw new ArgumentNullException(nameof(edFiStudentProgramAttendanceEvent.AttendanceEventReason), "Property is required for class EdFiStudentProgramAttendanceEvent.");

            if (edFiStudentProgramAttendanceEvent.EducationalEnvironmentDescriptorOption.IsSet && edFiStudentProgramAttendanceEvent.EducationalEnvironmentDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentProgramAttendanceEvent.EducationalEnvironmentDescriptor), "Property is required for class EdFiStudentProgramAttendanceEvent.");
