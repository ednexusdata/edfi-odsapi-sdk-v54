    ...
    public class EdFiStudentEducationOrganizationAssociationJsonConverter : JsonConverter<EdFiStudentEducationOrganizationAssociation>
    {
        ...
        public override EdFiStudentEducationOrganizationAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (barrierToInternetAccessInResidenceDescriptor.IsSet && barrierToInternetAccessInResidenceDescriptor.Value == null)
                throw new ArgumentNullException(nameof(barrierToInternetAccessInResidenceDescriptor), "Property is not nullable for class EdFiStudentEducationOrganizationAssociation.");
            ...
            if (hispanicLatinoEthnicity.IsSet && hispanicLatinoEthnicity.Value == null)
                throw new ArgumentNullException(nameof(hispanicLatinoEthnicity), "Property is not nullable for class EdFiStudentEducationOrganizationAssociation.");
            ...
            if (internetAccessInResidence.IsSet && internetAccessInResidence.Value == null)
                throw new ArgumentNullException(nameof(internetAccessInResidence), "Property is not nullable for class EdFiStudentEducationOrganizationAssociation.");

            if (internetAccessTypeInResidenceDescriptor.IsSet && internetAccessTypeInResidenceDescriptor.Value == null)
                throw new ArgumentNullException(nameof(internetAccessTypeInResidenceDescriptor), "Property is not nullable for class EdFiStudentEducationOrganizationAssociation.");

            if (internetPerformanceInResidenceDescriptor.IsSet && internetPerformanceInResidenceDescriptor.Value == null)
                throw new ArgumentNullException(nameof(internetPerformanceInResidenceDescriptor), "Property is not nullable for class EdFiStudentEducationOrganizationAssociation.");
            ...
            if (limitedEnglishProficiencyDescriptor.IsSet && limitedEnglishProficiencyDescriptor.Value == null)
                throw new ArgumentNullException(nameof(limitedEnglishProficiencyDescriptor), "Property is not nullable for class EdFiStudentEducationOrganizationAssociation.");

            if (loginId.IsSet && loginId.Value == null)
                throw new ArgumentNullException(nameof(loginId), "Property is not nullable for class EdFiStudentEducationOrganizationAssociation.");

            if (oldEthnicityDescriptor.IsSet && oldEthnicityDescriptor.Value == null)
                throw new ArgumentNullException(nameof(oldEthnicityDescriptor), "Property is not nullable for class EdFiStudentEducationOrganizationAssociation.");

            if (primaryLearningDeviceAccessDescriptor.IsSet && primaryLearningDeviceAccessDescriptor.Value == null)
                throw new ArgumentNullException(nameof(primaryLearningDeviceAccessDescriptor), "Property is not nullable for class EdFiStudentEducationOrganizationAssociation.");

            if (primaryLearningDeviceAwayFromSchoolDescriptor.IsSet && primaryLearningDeviceAwayFromSchoolDescriptor.Value == null)
                throw new ArgumentNullException(nameof(primaryLearningDeviceAwayFromSchoolDescriptor), "Property is not nullable for class EdFiStudentEducationOrganizationAssociation.");

            if (primaryLearningDeviceProviderDescriptor.IsSet && primaryLearningDeviceProviderDescriptor.Value == null)
                throw new ArgumentNullException(nameof(primaryLearningDeviceProviderDescriptor), "Property is not nullable for class EdFiStudentEducationOrganizationAssociation.");

            if (profileThumbnail.IsSet && profileThumbnail.Value == null)
                throw new ArgumentNullException(nameof(profileThumbnail), "Property is not nullable for class EdFiStudentEducationOrganizationAssociation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentEducationOrganizationAssociation edFiStudentEducationOrganizationAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentEducationOrganizationAssociation.BarrierToInternetAccessInResidenceDescriptorOption.IsSet && edFiStudentEducationOrganizationAssociation.BarrierToInternetAccessInResidenceDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentEducationOrganizationAssociation.BarrierToInternetAccessInResidenceDescriptor), "Property is required for class EdFiStudentEducationOrganizationAssociation.");
            ...
            if (edFiStudentEducationOrganizationAssociation.InternetAccessTypeInResidenceDescriptorOption.IsSet && edFiStudentEducationOrganizationAssociation.InternetAccessTypeInResidenceDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentEducationOrganizationAssociation.InternetAccessTypeInResidenceDescriptor), "Property is required for class EdFiStudentEducationOrganizationAssociation.");

            if (edFiStudentEducationOrganizationAssociation.InternetPerformanceInResidenceDescriptorOption.IsSet && edFiStudentEducationOrganizationAssociation.InternetPerformanceInResidenceDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentEducationOrganizationAssociation.InternetPerformanceInResidenceDescriptor), "Property is required for class EdFiStudentEducationOrganizationAssociation.");
            ...
            if (edFiStudentEducationOrganizationAssociation.LimitedEnglishProficiencyDescriptorOption.IsSet && edFiStudentEducationOrganizationAssociation.LimitedEnglishProficiencyDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentEducationOrganizationAssociation.LimitedEnglishProficiencyDescriptor), "Property is required for class EdFiStudentEducationOrganizationAssociation.");

            if (edFiStudentEducationOrganizationAssociation.LoginIdOption.IsSet && edFiStudentEducationOrganizationAssociation.LoginId == null)
                throw new ArgumentNullException(nameof(edFiStudentEducationOrganizationAssociation.LoginId), "Property is required for class EdFiStudentEducationOrganizationAssociation.");

            if (edFiStudentEducationOrganizationAssociation.OldEthnicityDescriptorOption.IsSet && edFiStudentEducationOrganizationAssociation.OldEthnicityDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentEducationOrganizationAssociation.OldEthnicityDescriptor), "Property is required for class EdFiStudentEducationOrganizationAssociation.");

            if (edFiStudentEducationOrganizationAssociation.PrimaryLearningDeviceAccessDescriptorOption.IsSet && edFiStudentEducationOrganizationAssociation.PrimaryLearningDeviceAccessDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentEducationOrganizationAssociation.PrimaryLearningDeviceAccessDescriptor), "Property is required for class EdFiStudentEducationOrganizationAssociation.");

            if (edFiStudentEducationOrganizationAssociation.PrimaryLearningDeviceAwayFromSchoolDescriptorOption.IsSet && edFiStudentEducationOrganizationAssociation.PrimaryLearningDeviceAwayFromSchoolDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentEducationOrganizationAssociation.PrimaryLearningDeviceAwayFromSchoolDescriptor), "Property is required for class EdFiStudentEducationOrganizationAssociation.");

            if (edFiStudentEducationOrganizationAssociation.PrimaryLearningDeviceProviderDescriptorOption.IsSet && edFiStudentEducationOrganizationAssociation.PrimaryLearningDeviceProviderDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentEducationOrganizationAssociation.PrimaryLearningDeviceProviderDescriptor), "Property is required for class EdFiStudentEducationOrganizationAssociation.");

            if (edFiStudentEducationOrganizationAssociation.ProfileThumbnailOption.IsSet && edFiStudentEducationOrganizationAssociation.ProfileThumbnail == null)
                throw new ArgumentNullException(nameof(edFiStudentEducationOrganizationAssociation.ProfileThumbnail), "Property is required for class EdFiStudentEducationOrganizationAssociation.");
