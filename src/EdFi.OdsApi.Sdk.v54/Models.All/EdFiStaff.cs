    ...
    public class EdFiStaffJsonConverter : JsonConverter<EdFiStaff>
    {
        ...
        public override EdFiStaff Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (birthDate.IsSet && birthDate.Value == null)
                throw new ArgumentNullException(nameof(birthDate), "Property is not nullable for class EdFiStaff.");

            if (citizenshipStatusDescriptor.IsSet && citizenshipStatusDescriptor.Value == null)
                throw new ArgumentNullException(nameof(citizenshipStatusDescriptor), "Property is not nullable for class EdFiStaff.");
            ...
            if (generationCodeSuffix.IsSet && generationCodeSuffix.Value == null)
                throw new ArgumentNullException(nameof(generationCodeSuffix), "Property is not nullable for class EdFiStaff.");

            if (highestCompletedLevelOfEducationDescriptor.IsSet && highestCompletedLevelOfEducationDescriptor.Value == null)
                throw new ArgumentNullException(nameof(highestCompletedLevelOfEducationDescriptor), "Property is not nullable for class EdFiStaff.");

            if (highlyQualifiedTeacher.IsSet && highlyQualifiedTeacher.Value == null)
                throw new ArgumentNullException(nameof(highlyQualifiedTeacher), "Property is not nullable for class EdFiStaff.");

            if (hispanicLatinoEthnicity.IsSet && hispanicLatinoEthnicity.Value == null)
                throw new ArgumentNullException(nameof(hispanicLatinoEthnicity), "Property is not nullable for class EdFiStaff.");
            ...
            if (loginId.IsSet && loginId.Value == null)
                throw new ArgumentNullException(nameof(loginId), "Property is not nullable for class EdFiStaff.");

            if (maidenName.IsSet && maidenName.Value == null)
                throw new ArgumentNullException(nameof(maidenName), "Property is not nullable for class EdFiStaff.");

            if (middleName.IsSet && middleName.Value == null)
                throw new ArgumentNullException(nameof(middleName), "Property is not nullable for class EdFiStaff.");

            if (oldEthnicityDescriptor.IsSet && oldEthnicityDescriptor.Value == null)
                throw new ArgumentNullException(nameof(oldEthnicityDescriptor), "Property is not nullable for class EdFiStaff.");
            ...
            if (personalTitlePrefix.IsSet && personalTitlePrefix.Value == null)
                throw new ArgumentNullException(nameof(personalTitlePrefix), "Property is not nullable for class EdFiStaff.");
            ...
            if (sexDescriptor.IsSet && sexDescriptor.Value == null)
                throw new ArgumentNullException(nameof(sexDescriptor), "Property is not nullable for class EdFiStaff.");
            ...
            if (yearsOfPriorProfessionalExperience.IsSet && yearsOfPriorProfessionalExperience.Value == null)
                throw new ArgumentNullException(nameof(yearsOfPriorProfessionalExperience), "Property is not nullable for class EdFiStaff.");

            if (yearsOfPriorTeachingExperience.IsSet && yearsOfPriorTeachingExperience.Value == null)
                throw new ArgumentNullException(nameof(yearsOfPriorTeachingExperience), "Property is not nullable for class EdFiStaff.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStaff edFiStaff, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStaff.CitizenshipStatusDescriptorOption.IsSet && edFiStaff.CitizenshipStatusDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaff.CitizenshipStatusDescriptor), "Property is required for class EdFiStaff.");
            ...
            if (edFiStaff.GenerationCodeSuffixOption.IsSet && edFiStaff.GenerationCodeSuffix == null)
                throw new ArgumentNullException(nameof(edFiStaff.GenerationCodeSuffix), "Property is required for class EdFiStaff.");

            if (edFiStaff.HighestCompletedLevelOfEducationDescriptorOption.IsSet && edFiStaff.HighestCompletedLevelOfEducationDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaff.HighestCompletedLevelOfEducationDescriptor), "Property is required for class EdFiStaff.");
            ...
            if (edFiStaff.LoginIdOption.IsSet && edFiStaff.LoginId == null)
                throw new ArgumentNullException(nameof(edFiStaff.LoginId), "Property is required for class EdFiStaff.");

            if (edFiStaff.MaidenNameOption.IsSet && edFiStaff.MaidenName == null)
                throw new ArgumentNullException(nameof(edFiStaff.MaidenName), "Property is required for class EdFiStaff.");

            if (edFiStaff.MiddleNameOption.IsSet && edFiStaff.MiddleName == null)
                throw new ArgumentNullException(nameof(edFiStaff.MiddleName), "Property is required for class EdFiStaff.");

            if (edFiStaff.OldEthnicityDescriptorOption.IsSet && edFiStaff.OldEthnicityDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaff.OldEthnicityDescriptor), "Property is required for class EdFiStaff.");
            ...
            if (edFiStaff.PersonalTitlePrefixOption.IsSet && edFiStaff.PersonalTitlePrefix == null)
                throw new ArgumentNullException(nameof(edFiStaff.PersonalTitlePrefix), "Property is required for class EdFiStaff.");
            ...
            if (edFiStaff.SexDescriptorOption.IsSet && edFiStaff.SexDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaff.SexDescriptor), "Property is required for class EdFiStaff.");
