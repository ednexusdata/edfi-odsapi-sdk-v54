    ...
    public class EdFiGradeLearningStandardGradeJsonConverter : JsonConverter<EdFiGradeLearningStandardGrade>
    {
        ...
        public override EdFiGradeLearningStandardGrade Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (performanceBaseConversionDescriptor.IsSet && performanceBaseConversionDescriptor.Value == null)
                throw new ArgumentNullException(nameof(performanceBaseConversionDescriptor), "Property is not nullable for class EdFiGradeLearningStandardGrade.");

            if (diagnosticStatement.IsSet && diagnosticStatement.Value == null)
                throw new ArgumentNullException(nameof(diagnosticStatement), "Property is not nullable for class EdFiGradeLearningStandardGrade.");

            if (letterGradeEarned.IsSet && letterGradeEarned.Value == null)
                throw new ArgumentNullException(nameof(letterGradeEarned), "Property is not nullable for class EdFiGradeLearningStandardGrade.");

            if (numericGradeEarned.IsSet && numericGradeEarned.Value == null)
                throw new ArgumentNullException(nameof(numericGradeEarned), "Property is not nullable for class EdFiGradeLearningStandardGrade.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiGradeLearningStandardGrade edFiGradeLearningStandardGrade, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiGradeLearningStandardGrade.PerformanceBaseConversionDescriptorOption.IsSet && edFiGradeLearningStandardGrade.PerformanceBaseConversionDescriptor == null)
                throw new ArgumentNullException(nameof(edFiGradeLearningStandardGrade.PerformanceBaseConversionDescriptor), "Property is required for class EdFiGradeLearningStandardGrade.");

            if (edFiGradeLearningStandardGrade.DiagnosticStatementOption.IsSet && edFiGradeLearningStandardGrade.DiagnosticStatement == null)
                throw new ArgumentNullException(nameof(edFiGradeLearningStandardGrade.DiagnosticStatement), "Property is required for class EdFiGradeLearningStandardGrade.");

            if (edFiGradeLearningStandardGrade.LetterGradeEarnedOption.IsSet && edFiGradeLearningStandardGrade.LetterGradeEarned == null)
                throw new ArgumentNullException(nameof(edFiGradeLearningStandardGrade.LetterGradeEarned), "Property is required for class EdFiGradeLearningStandardGrade.");
