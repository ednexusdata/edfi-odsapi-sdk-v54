    ...
    public class EdFiReportCardGradePointAverageJsonConverter : JsonConverter<EdFiReportCardGradePointAverage>
    {
        ...
        public override EdFiReportCardGradePointAverage Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (isCumulative.IsSet && isCumulative.Value == null)
                throw new ArgumentNullException(nameof(isCumulative), "Property is not nullable for class EdFiReportCardGradePointAverage.");

            if (maxGradePointAverageValue.IsSet && maxGradePointAverageValue.Value == null)
                throw new ArgumentNullException(nameof(maxGradePointAverageValue), "Property is not nullable for class EdFiReportCardGradePointAverage.");
