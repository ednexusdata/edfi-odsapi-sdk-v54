...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public class EdFiStudentPersonalIdentificationDocumentJsonConverter : JsonConverter<EdFiStudentPersonalIdentificationDocument>
    {
        ...
        public override EdFiStudentPersonalIdentificationDocument Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (issuerCountryDescriptor.IsSet && issuerCountryDescriptor.Value == null)
                throw new ArgumentNullException(nameof(issuerCountryDescriptor), "Property is not nullable for class EdFiStudentPersonalIdentificationDocument.");

            if (documentExpirationDate.IsSet && documentExpirationDate.Value == null)
                throw new ArgumentNullException(nameof(documentExpirationDate), "Property is not nullable for class EdFiStudentPersonalIdentificationDocument.");

            if (documentTitle.IsSet && documentTitle.Value == null)
                throw new ArgumentNullException(nameof(documentTitle), "Property is not nullable for class EdFiStudentPersonalIdentificationDocument.");

            if (issuerDocumentIdentificationCode.IsSet && issuerDocumentIdentificationCode.Value == null)
                throw new ArgumentNullException(nameof(issuerDocumentIdentificationCode), "Property is not nullable for class EdFiStudentPersonalIdentificationDocument.");

            if (issuerName.IsSet && issuerName.Value == null)
                throw new ArgumentNullException(nameof(issuerName), "Property is not nullable for class EdFiStudentPersonalIdentificationDocument.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentPersonalIdentificationDocument edFiStudentPersonalIdentificationDocument, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentPersonalIdentificationDocument.IssuerCountryDescriptorOption.IsSet && edFiStudentPersonalIdentificationDocument.IssuerCountryDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentPersonalIdentificationDocument.IssuerCountryDescriptor), "Property is required for class EdFiStudentPersonalIdentificationDocument.");

            if (edFiStudentPersonalIdentificationDocument.DocumentTitleOption.IsSet && edFiStudentPersonalIdentificationDocument.DocumentTitle == null)
                throw new ArgumentNullException(nameof(edFiStudentPersonalIdentificationDocument.DocumentTitle), "Property is required for class EdFiStudentPersonalIdentificationDocument.");

            if (edFiStudentPersonalIdentificationDocument.IssuerDocumentIdentificationCodeOption.IsSet && edFiStudentPersonalIdentificationDocument.IssuerDocumentIdentificationCode == null)
                throw new ArgumentNullException(nameof(edFiStudentPersonalIdentificationDocument.IssuerDocumentIdentificationCode), "Property is required for class EdFiStudentPersonalIdentificationDocument.");

            if (edFiStudentPersonalIdentificationDocument.IssuerNameOption.IsSet && edFiStudentPersonalIdentificationDocument.IssuerName == null)
                throw new ArgumentNullException(nameof(edFiStudentPersonalIdentificationDocument.IssuerName), "Property is required for class EdFiStudentPersonalIdentificationDocument.");
