...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public class EdFiStudentParentAssociationJsonConverter : JsonConverter<EdFiStudentParentAssociation>
    {
        ...
        public override EdFiStudentParentAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (contactPriority.IsSet && contactPriority.Value == null)
                throw new ArgumentNullException(nameof(contactPriority), "Property is not nullable for class EdFiStudentParentAssociation.");

            if (contactRestrictions.IsSet && contactRestrictions.Value == null)
                throw new ArgumentNullException(nameof(contactRestrictions), "Property is not nullable for class EdFiStudentParentAssociation.");

            if (emergencyContactStatus.IsSet && emergencyContactStatus.Value == null)
                throw new ArgumentNullException(nameof(emergencyContactStatus), "Property is not nullable for class EdFiStudentParentAssociation.");

            if (legalGuardian.IsSet && legalGuardian.Value == null)
                throw new ArgumentNullException(nameof(legalGuardian), "Property is not nullable for class EdFiStudentParentAssociation.");

            if (livesWith.IsSet && livesWith.Value == null)
                throw new ArgumentNullException(nameof(livesWith), "Property is not nullable for class EdFiStudentParentAssociation.");

            if (primaryContactStatus.IsSet && primaryContactStatus.Value == null)
                throw new ArgumentNullException(nameof(primaryContactStatus), "Property is not nullable for class EdFiStudentParentAssociation.");

            if (relationDescriptor.IsSet && relationDescriptor.Value == null)
                throw new ArgumentNullException(nameof(relationDescriptor), "Property is not nullable for class EdFiStudentParentAssociation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentParentAssociation edFiStudentParentAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentParentAssociation.ContactRestrictionsOption.IsSet && edFiStudentParentAssociation.ContactRestrictions == null)
                throw new ArgumentNullException(nameof(edFiStudentParentAssociation.ContactRestrictions), "Property is required for class EdFiStudentParentAssociation.");

            if (edFiStudentParentAssociation.RelationDescriptorOption.IsSet && edFiStudentParentAssociation.RelationDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentParentAssociation.RelationDescriptor), "Property is required for class EdFiStudentParentAssociation.");
