    ...
    public class EdFiSurveyQuestionMatrixJsonConverter : JsonConverter<EdFiSurveyQuestionMatrix>
    {
        ...
        public override EdFiSurveyQuestionMatrix Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (maxRawScore.IsSet && maxRawScore.Value == null)
                throw new ArgumentNullException(nameof(maxRawScore), "Property is not nullable for class EdFiSurveyQuestionMatrix.");

            if (minRawScore.IsSet && minRawScore.Value == null)
                throw new ArgumentNullException(nameof(minRawScore), "Property is not nullable for class EdFiSurveyQuestionMatrix.");
