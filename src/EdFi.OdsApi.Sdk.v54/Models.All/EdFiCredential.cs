    ...
    public class EdFiCredentialJsonConverter : JsonConverter<EdFiCredential>
    {
        ...
        public override EdFiCredential Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (credentialFieldDescriptor.IsSet && credentialFieldDescriptor.Value == null)
                throw new ArgumentNullException(nameof(credentialFieldDescriptor), "Property is not nullable for class EdFiCredential.");

            if (effectiveDate.IsSet && effectiveDate.Value == null)
                throw new ArgumentNullException(nameof(effectiveDate), "Property is not nullable for class EdFiCredential.");
            ...
            if (expirationDate.IsSet && expirationDate.Value == null)
                throw new ArgumentNullException(nameof(expirationDate), "Property is not nullable for class EdFiCredential.");
            ...
            if (teachingCredentialBasisDescriptor.IsSet && teachingCredentialBasisDescriptor.Value == null)
                throw new ArgumentNullException(nameof(teachingCredentialBasisDescriptor), "Property is not nullable for class EdFiCredential.");

            if (teachingCredentialDescriptor.IsSet && teachingCredentialDescriptor.Value == null)
                throw new ArgumentNullException(nameof(teachingCredentialDescriptor), "Property is not nullable for class EdFiCredential.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiCredential edFiCredential, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiCredential.CredentialFieldDescriptorOption.IsSet && edFiCredential.CredentialFieldDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCredential.CredentialFieldDescriptor), "Property is required for class EdFiCredential.");
            ...
            if (edFiCredential.TeachingCredentialBasisDescriptorOption.IsSet && edFiCredential.TeachingCredentialBasisDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCredential.TeachingCredentialBasisDescriptor), "Property is required for class EdFiCredential.");

            if (edFiCredential.TeachingCredentialDescriptorOption.IsSet && edFiCredential.TeachingCredentialDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCredential.TeachingCredentialDescriptor), "Property is required for class EdFiCredential.");
