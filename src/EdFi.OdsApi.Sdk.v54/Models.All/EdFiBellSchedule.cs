...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiBellSchedule : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="bellScheduleName">Name or title of the BellSchedule.</param>
        /// <param name="classPeriods">An unordered collection of bellScheduleClassPeriods. The class periods that compose this BellSchedule.</param>
    ...
    public class EdFiBellScheduleJsonConverter : JsonConverter<EdFiBellSchedule>
    {
        ...
        public override EdFiBellSchedule Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (alternateDayName.IsSet && alternateDayName.Value == null)
                throw new ArgumentNullException(nameof(alternateDayName), "Property is not nullable for class EdFiBellSchedule.");
            ...
            if (endTime.IsSet && endTime.Value == null)
                throw new ArgumentNullException(nameof(endTime), "Property is not nullable for class EdFiBellSchedule.");
            ...
            if (startTime.IsSet && startTime.Value == null)
                throw new ArgumentNullException(nameof(startTime), "Property is not nullable for class EdFiBellSchedule.");

            if (totalInstructionalTime.IsSet && totalInstructionalTime.Value == null)
                throw new ArgumentNullException(nameof(totalInstructionalTime), "Property is not nullable for class EdFiBellSchedule.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiBellSchedule edFiBellSchedule, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiBellSchedule.AlternateDayNameOption.IsSet && edFiBellSchedule.AlternateDayName == null)
                throw new ArgumentNullException(nameof(edFiBellSchedule.AlternateDayName), "Property is required for class EdFiBellSchedule.");
            ...
            if (edFiBellSchedule.EndTimeOption.IsSet && edFiBellSchedule.EndTime == null)
                throw new ArgumentNullException(nameof(edFiBellSchedule.EndTime), "Property is required for class EdFiBellSchedule.");
            ...
            if (edFiBellSchedule.StartTimeOption.IsSet && edFiBellSchedule.StartTime == null)
                throw new ArgumentNullException(nameof(edFiBellSchedule.StartTime), "Property is required for class EdFiBellSchedule.");
