...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiCommunityProvider : IValidatableObject
    {
        ...
        /// <param name="communityProviderId">The identifier assigned to a CommunityProvider.</param>
    ...
    public class EdFiCommunityProviderJsonConverter : JsonConverter<EdFiCommunityProvider>
    {
        ...
        public override EdFiCommunityProvider Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (licenseExemptIndicator.IsSet && licenseExemptIndicator.Value == null)
                throw new ArgumentNullException(nameof(licenseExemptIndicator), "Property is not nullable for class EdFiCommunityProvider.");

            if (operationalStatusDescriptor.IsSet && operationalStatusDescriptor.Value == null)
                throw new ArgumentNullException(nameof(operationalStatusDescriptor), "Property is not nullable for class EdFiCommunityProvider.");

            if (providerProfitabilityDescriptor.IsSet && providerProfitabilityDescriptor.Value == null)
                throw new ArgumentNullException(nameof(providerProfitabilityDescriptor), "Property is not nullable for class EdFiCommunityProvider.");

            if (schoolIndicator.IsSet && schoolIndicator.Value == null)
                throw new ArgumentNullException(nameof(schoolIndicator), "Property is not nullable for class EdFiCommunityProvider.");

            if (shortNameOfInstitution.IsSet && shortNameOfInstitution.Value == null)
                throw new ArgumentNullException(nameof(shortNameOfInstitution), "Property is not nullable for class EdFiCommunityProvider.");

            if (webSite.IsSet && webSite.Value == null)
                throw new ArgumentNullException(nameof(webSite), "Property is not nullable for class EdFiCommunityProvider.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiCommunityProvider edFiCommunityProvider, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiCommunityProvider.OperationalStatusDescriptorOption.IsSet && edFiCommunityProvider.OperationalStatusDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCommunityProvider.OperationalStatusDescriptor), "Property is required for class EdFiCommunityProvider.");

            if (edFiCommunityProvider.ProviderProfitabilityDescriptorOption.IsSet && edFiCommunityProvider.ProviderProfitabilityDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCommunityProvider.ProviderProfitabilityDescriptor), "Property is required for class EdFiCommunityProvider.");

            if (edFiCommunityProvider.ShortNameOfInstitutionOption.IsSet && edFiCommunityProvider.ShortNameOfInstitution == null)
                throw new ArgumentNullException(nameof(edFiCommunityProvider.ShortNameOfInstitution), "Property is required for class EdFiCommunityProvider.");

            if (edFiCommunityProvider.WebSiteOption.IsSet && edFiCommunityProvider.WebSite == null)
                throw new ArgumentNullException(nameof(edFiCommunityProvider.WebSite), "Property is required for class EdFiCommunityProvider.");
