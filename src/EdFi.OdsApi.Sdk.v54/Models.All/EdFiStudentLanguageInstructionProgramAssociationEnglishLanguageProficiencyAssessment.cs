...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public class EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessmentJsonConverter : JsonConverter<EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment>
    {
        ...
        public override EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (monitoredDescriptor.IsSet && monitoredDescriptor.Value == null)
                throw new ArgumentNullException(nameof(monitoredDescriptor), "Property is not nullable for class EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.");

            if (participationDescriptor.IsSet && participationDescriptor.Value == null)
                throw new ArgumentNullException(nameof(participationDescriptor), "Property is not nullable for class EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.");

            if (proficiencyDescriptor.IsSet && proficiencyDescriptor.Value == null)
                throw new ArgumentNullException(nameof(proficiencyDescriptor), "Property is not nullable for class EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.");

            if (progressDescriptor.IsSet && progressDescriptor.Value == null)
                throw new ArgumentNullException(nameof(progressDescriptor), "Property is not nullable for class EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment edFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.MonitoredDescriptorOption.IsSet && edFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.MonitoredDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.MonitoredDescriptor), "Property is required for class EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.");

            if (edFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.ParticipationDescriptorOption.IsSet && edFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.ParticipationDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.ParticipationDescriptor), "Property is required for class EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.");

            if (edFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.ProficiencyDescriptorOption.IsSet && edFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.ProficiencyDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.ProficiencyDescriptor), "Property is required for class EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.");

            if (edFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.ProgressDescriptorOption.IsSet && edFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.ProgressDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.ProgressDescriptor), "Property is required for class EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment.");
