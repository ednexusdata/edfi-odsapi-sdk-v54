...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiEducationContent : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="contentIdentifier">A unique identifier for the EducationContent.</param>
    ...
    public class EdFiEducationContentJsonConverter : JsonConverter<EdFiEducationContent>
    {
        ...
        public override EdFiEducationContent Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (additionalAuthorsIndicator.IsSet && additionalAuthorsIndicator.Value == null)
                throw new ArgumentNullException(nameof(additionalAuthorsIndicator), "Property is not nullable for class EdFiEducationContent.");
            ...
            if (contentClassDescriptor.IsSet && contentClassDescriptor.Value == null)
                throw new ArgumentNullException(nameof(contentClassDescriptor), "Property is not nullable for class EdFiEducationContent.");

            if (cost.IsSet && cost.Value == null)
                throw new ArgumentNullException(nameof(cost), "Property is not nullable for class EdFiEducationContent.");

            if (costRateDescriptor.IsSet && costRateDescriptor.Value == null)
                throw new ArgumentNullException(nameof(costRateDescriptor), "Property is not nullable for class EdFiEducationContent.");
            ...
            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class EdFiEducationContent.");

            if (interactivityStyleDescriptor.IsSet && interactivityStyleDescriptor.Value == null)
                throw new ArgumentNullException(nameof(interactivityStyleDescriptor), "Property is not nullable for class EdFiEducationContent.");
            ...
            if (learningResourceMetadataURI.IsSet && learningResourceMetadataURI.Value == null)
                throw new ArgumentNullException(nameof(learningResourceMetadataURI), "Property is not nullable for class EdFiEducationContent.");

            if (publicationDate.IsSet && publicationDate.Value == null)
                throw new ArgumentNullException(nameof(publicationDate), "Property is not nullable for class EdFiEducationContent.");

            if (publicationYear.IsSet && publicationYear.Value == null)
                throw new ArgumentNullException(nameof(publicationYear), "Property is not nullable for class EdFiEducationContent.");

            if (publisher.IsSet && publisher.Value == null)
                throw new ArgumentNullException(nameof(publisher), "Property is not nullable for class EdFiEducationContent.");

            if (shortDescription.IsSet && shortDescription.Value == null)
                throw new ArgumentNullException(nameof(shortDescription), "Property is not nullable for class EdFiEducationContent.");

            if (timeRequired.IsSet && timeRequired.Value == null)
                throw new ArgumentNullException(nameof(timeRequired), "Property is not nullable for class EdFiEducationContent.");

            if (useRightsURL.IsSet && useRightsURL.Value == null)
                throw new ArgumentNullException(nameof(useRightsURL), "Property is not nullable for class EdFiEducationContent.");

            if (varVersion.IsSet && varVersion.Value == null)
                throw new ArgumentNullException(nameof(varVersion), "Property is not nullable for class EdFiEducationContent.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiEducationContent edFiEducationContent, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiEducationContent.ContentClassDescriptorOption.IsSet && edFiEducationContent.ContentClassDescriptor == null)
                throw new ArgumentNullException(nameof(edFiEducationContent.ContentClassDescriptor), "Property is required for class EdFiEducationContent.");

            if (edFiEducationContent.CostRateDescriptorOption.IsSet && edFiEducationContent.CostRateDescriptor == null)
                throw new ArgumentNullException(nameof(edFiEducationContent.CostRateDescriptor), "Property is required for class EdFiEducationContent.");
            ...
            if (edFiEducationContent.DescriptionOption.IsSet && edFiEducationContent.Description == null)
                throw new ArgumentNullException(nameof(edFiEducationContent.Description), "Property is required for class EdFiEducationContent.");

            if (edFiEducationContent.InteractivityStyleDescriptorOption.IsSet && edFiEducationContent.InteractivityStyleDescriptor == null)
                throw new ArgumentNullException(nameof(edFiEducationContent.InteractivityStyleDescriptor), "Property is required for class EdFiEducationContent.");
            ...
            if (edFiEducationContent.LearningResourceMetadataURIOption.IsSet && edFiEducationContent.LearningResourceMetadataURI == null)
                throw new ArgumentNullException(nameof(edFiEducationContent.LearningResourceMetadataURI), "Property is required for class EdFiEducationContent.");

            if (edFiEducationContent.PublisherOption.IsSet && edFiEducationContent.Publisher == null)
                throw new ArgumentNullException(nameof(edFiEducationContent.Publisher), "Property is required for class EdFiEducationContent.");

            if (edFiEducationContent.ShortDescriptionOption.IsSet && edFiEducationContent.ShortDescription == null)
                throw new ArgumentNullException(nameof(edFiEducationContent.ShortDescription), "Property is required for class EdFiEducationContent.");

            if (edFiEducationContent.TimeRequiredOption.IsSet && edFiEducationContent.TimeRequired == null)
                throw new ArgumentNullException(nameof(edFiEducationContent.TimeRequired), "Property is required for class EdFiEducationContent.");

            if (edFiEducationContent.UseRightsURLOption.IsSet && edFiEducationContent.UseRightsURL == null)
                throw new ArgumentNullException(nameof(edFiEducationContent.UseRightsURL), "Property is required for class EdFiEducationContent.");

            if (edFiEducationContent.VarVersionOption.IsSet && edFiEducationContent.VarVersion == null)
                throw new ArgumentNullException(nameof(edFiEducationContent.VarVersion), "Property is required for class EdFiEducationContent.");
