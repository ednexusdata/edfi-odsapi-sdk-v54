    ...
    public class EdFiStaffAddressJsonConverter : JsonConverter<EdFiStaffAddress>
    {
        ...
        public override EdFiStaffAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (localeDescriptor.IsSet && localeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(localeDescriptor), "Property is not nullable for class EdFiStaffAddress.");

            if (apartmentRoomSuiteNumber.IsSet && apartmentRoomSuiteNumber.Value == null)
                throw new ArgumentNullException(nameof(apartmentRoomSuiteNumber), "Property is not nullable for class EdFiStaffAddress.");

            if (buildingSiteNumber.IsSet && buildingSiteNumber.Value == null)
                throw new ArgumentNullException(nameof(buildingSiteNumber), "Property is not nullable for class EdFiStaffAddress.");

            if (congressionalDistrict.IsSet && congressionalDistrict.Value == null)
                throw new ArgumentNullException(nameof(congressionalDistrict), "Property is not nullable for class EdFiStaffAddress.");

            if (countyFIPSCode.IsSet && countyFIPSCode.Value == null)
                throw new ArgumentNullException(nameof(countyFIPSCode), "Property is not nullable for class EdFiStaffAddress.");

            if (doNotPublishIndicator.IsSet && doNotPublishIndicator.Value == null)
                throw new ArgumentNullException(nameof(doNotPublishIndicator), "Property is not nullable for class EdFiStaffAddress.");

            if (latitude.IsSet && latitude.Value == null)
                throw new ArgumentNullException(nameof(latitude), "Property is not nullable for class EdFiStaffAddress.");

            if (longitude.IsSet && longitude.Value == null)
                throw new ArgumentNullException(nameof(longitude), "Property is not nullable for class EdFiStaffAddress.");

            if (nameOfCounty.IsSet && nameOfCounty.Value == null)
                throw new ArgumentNullException(nameof(nameOfCounty), "Property is not nullable for class EdFiStaffAddress.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStaffAddress edFiStaffAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStaffAddress.LocaleDescriptorOption.IsSet && edFiStaffAddress.LocaleDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaffAddress.LocaleDescriptor), "Property is required for class EdFiStaffAddress.");

            if (edFiStaffAddress.ApartmentRoomSuiteNumberOption.IsSet && edFiStaffAddress.ApartmentRoomSuiteNumber == null)
                throw new ArgumentNullException(nameof(edFiStaffAddress.ApartmentRoomSuiteNumber), "Property is required for class EdFiStaffAddress.");

            if (edFiStaffAddress.BuildingSiteNumberOption.IsSet && edFiStaffAddress.BuildingSiteNumber == null)
                throw new ArgumentNullException(nameof(edFiStaffAddress.BuildingSiteNumber), "Property is required for class EdFiStaffAddress.");

            if (edFiStaffAddress.CongressionalDistrictOption.IsSet && edFiStaffAddress.CongressionalDistrict == null)
                throw new ArgumentNullException(nameof(edFiStaffAddress.CongressionalDistrict), "Property is required for class EdFiStaffAddress.");

            if (edFiStaffAddress.CountyFIPSCodeOption.IsSet && edFiStaffAddress.CountyFIPSCode == null)
                throw new ArgumentNullException(nameof(edFiStaffAddress.CountyFIPSCode), "Property is required for class EdFiStaffAddress.");

            if (edFiStaffAddress.LatitudeOption.IsSet && edFiStaffAddress.Latitude == null)
                throw new ArgumentNullException(nameof(edFiStaffAddress.Latitude), "Property is required for class EdFiStaffAddress.");

            if (edFiStaffAddress.LongitudeOption.IsSet && edFiStaffAddress.Longitude == null)
                throw new ArgumentNullException(nameof(edFiStaffAddress.Longitude), "Property is required for class EdFiStaffAddress.");

            if (edFiStaffAddress.NameOfCountyOption.IsSet && edFiStaffAddress.NameOfCounty == null)
                throw new ArgumentNullException(nameof(edFiStaffAddress.NameOfCounty), "Property is required for class EdFiStaffAddress.");
