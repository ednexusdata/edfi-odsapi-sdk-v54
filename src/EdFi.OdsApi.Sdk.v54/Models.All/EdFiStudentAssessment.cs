...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiStudentAssessment : IValidatableObject
    {
        ...
        public EdFiStudentAssessment(string id = default, string studentAssessmentIdentifier = default, EdFiAssessmentReference assessmentReference = default, EdFiSchoolYearTypeReference schoolYearTypeReference = default, EdFiStudentReference studentReference = default, List<EdFiStudentAssessmentAccommodation> accommodations = default, DateTime administrationDate = default, DateTime administrationEndDate = default, string administrationEnvironmentDescriptor = default, string administrationLanguageDescriptor = default, string eventCircumstanceDescriptor = default, string eventDescription = default, List<EdFiStudentAssessmentItem> items = default, List<EdFiStudentAssessmentPerformanceLevel> performanceLevels = default, string platformTypeDescriptor = default, string reasonNotTestedDescriptor = default, string retestIndicatorDescriptor = default, List<EdFiStudentAssessmentScoreResult> scoreResults = default, string serialNumber = default, List<EdFiStudentAssessmentStudentObjectiveAssessment> studentObjectiveAssessments = default, string whenAssessedGradeLevelDescriptor = default, string etag = default, Object ext = default)
        {
        ...
        [DataMember(Name = "administrationDate", IsRequired = true, EmitDefaultValue = true)]
