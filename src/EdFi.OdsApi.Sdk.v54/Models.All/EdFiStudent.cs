    ...
    public class EdFiStudentJsonConverter : JsonConverter<EdFiStudent>
    {
        ...
        public override EdFiStudent Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (birthCity.IsSet && birthCity.Value == null)
                throw new ArgumentNullException(nameof(birthCity), "Property is not nullable for class EdFiStudent.");

            if (birthCountryDescriptor.IsSet && birthCountryDescriptor.Value == null)
                throw new ArgumentNullException(nameof(birthCountryDescriptor), "Property is not nullable for class EdFiStudent.");

            if (birthInternationalProvince.IsSet && birthInternationalProvince.Value == null)
                throw new ArgumentNullException(nameof(birthInternationalProvince), "Property is not nullable for class EdFiStudent.");

            if (birthSexDescriptor.IsSet && birthSexDescriptor.Value == null)
                throw new ArgumentNullException(nameof(birthSexDescriptor), "Property is not nullable for class EdFiStudent.");

            if (birthStateAbbreviationDescriptor.IsSet && birthStateAbbreviationDescriptor.Value == null)
                throw new ArgumentNullException(nameof(birthStateAbbreviationDescriptor), "Property is not nullable for class EdFiStudent.");

            if (citizenshipStatusDescriptor.IsSet && citizenshipStatusDescriptor.Value == null)
                throw new ArgumentNullException(nameof(citizenshipStatusDescriptor), "Property is not nullable for class EdFiStudent.");

            if (dateEnteredUS.IsSet && dateEnteredUS.Value == null)
                throw new ArgumentNullException(nameof(dateEnteredUS), "Property is not nullable for class EdFiStudent.");

            if (generationCodeSuffix.IsSet && generationCodeSuffix.Value == null)
                throw new ArgumentNullException(nameof(generationCodeSuffix), "Property is not nullable for class EdFiStudent.");
            ...
            if (maidenName.IsSet && maidenName.Value == null)
                throw new ArgumentNullException(nameof(maidenName), "Property is not nullable for class EdFiStudent.");

            if (middleName.IsSet && middleName.Value == null)
                throw new ArgumentNullException(nameof(middleName), "Property is not nullable for class EdFiStudent.");

            if (multipleBirthStatus.IsSet && multipleBirthStatus.Value == null)
                throw new ArgumentNullException(nameof(multipleBirthStatus), "Property is not nullable for class EdFiStudent.");
            ...
            if (personalTitlePrefix.IsSet && personalTitlePrefix.Value == null)
                throw new ArgumentNullException(nameof(personalTitlePrefix), "Property is not nullable for class EdFiStudent.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudent edFiStudent, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudent.BirthCityOption.IsSet && edFiStudent.BirthCity == null)
                throw new ArgumentNullException(nameof(edFiStudent.BirthCity), "Property is required for class EdFiStudent.");

            if (edFiStudent.BirthCountryDescriptorOption.IsSet && edFiStudent.BirthCountryDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudent.BirthCountryDescriptor), "Property is required for class EdFiStudent.");

            if (edFiStudent.BirthInternationalProvinceOption.IsSet && edFiStudent.BirthInternationalProvince == null)
                throw new ArgumentNullException(nameof(edFiStudent.BirthInternationalProvince), "Property is required for class EdFiStudent.");

            if (edFiStudent.BirthSexDescriptorOption.IsSet && edFiStudent.BirthSexDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudent.BirthSexDescriptor), "Property is required for class EdFiStudent.");

            if (edFiStudent.BirthStateAbbreviationDescriptorOption.IsSet && edFiStudent.BirthStateAbbreviationDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudent.BirthStateAbbreviationDescriptor), "Property is required for class EdFiStudent.");

            if (edFiStudent.CitizenshipStatusDescriptorOption.IsSet && edFiStudent.CitizenshipStatusDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudent.CitizenshipStatusDescriptor), "Property is required for class EdFiStudent.");

            if (edFiStudent.GenerationCodeSuffixOption.IsSet && edFiStudent.GenerationCodeSuffix == null)
                throw new ArgumentNullException(nameof(edFiStudent.GenerationCodeSuffix), "Property is required for class EdFiStudent.");
            ...
            if (edFiStudent.MaidenNameOption.IsSet && edFiStudent.MaidenName == null)
                throw new ArgumentNullException(nameof(edFiStudent.MaidenName), "Property is required for class EdFiStudent.");

            if (edFiStudent.MiddleNameOption.IsSet && edFiStudent.MiddleName == null)
                throw new ArgumentNullException(nameof(edFiStudent.MiddleName), "Property is required for class EdFiStudent.");
            ...
            if (edFiStudent.PersonalTitlePrefixOption.IsSet && edFiStudent.PersonalTitlePrefix == null)
                throw new ArgumentNullException(nameof(edFiStudent.PersonalTitlePrefix), "Property is required for class EdFiStudent.");
