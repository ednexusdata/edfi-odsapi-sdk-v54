    ...
    public class EdFiAssessmentContentStandardJsonConverter : JsonConverter<EdFiAssessmentContentStandard>
    {
        ...
        public override EdFiAssessmentContentStandard Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (publicationStatusDescriptor.IsSet && publicationStatusDescriptor.Value == null)
                throw new ArgumentNullException(nameof(publicationStatusDescriptor), "Property is not nullable for class EdFiAssessmentContentStandard.");

            if (beginDate.IsSet && beginDate.Value == null)
                throw new ArgumentNullException(nameof(beginDate), "Property is not nullable for class EdFiAssessmentContentStandard.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class EdFiAssessmentContentStandard.");

            if (publicationDate.IsSet && publicationDate.Value == null)
                throw new ArgumentNullException(nameof(publicationDate), "Property is not nullable for class EdFiAssessmentContentStandard.");

            if (publicationYear.IsSet && publicationYear.Value == null)
                throw new ArgumentNullException(nameof(publicationYear), "Property is not nullable for class EdFiAssessmentContentStandard.");

            if (uri.IsSet && uri.Value == null)
                throw new ArgumentNullException(nameof(uri), "Property is not nullable for class EdFiAssessmentContentStandard.");

            if (varVersion.IsSet && varVersion.Value == null)
                throw new ArgumentNullException(nameof(varVersion), "Property is not nullable for class EdFiAssessmentContentStandard.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiAssessmentContentStandard edFiAssessmentContentStandard, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiAssessmentContentStandard.PublicationStatusDescriptorOption.IsSet && edFiAssessmentContentStandard.PublicationStatusDescriptor == null)
                throw new ArgumentNullException(nameof(edFiAssessmentContentStandard.PublicationStatusDescriptor), "Property is required for class EdFiAssessmentContentStandard.");

            if (edFiAssessmentContentStandard.UriOption.IsSet && edFiAssessmentContentStandard.Uri == null)
                throw new ArgumentNullException(nameof(edFiAssessmentContentStandard.Uri), "Property is required for class EdFiAssessmentContentStandard.");

            if (edFiAssessmentContentStandard.VarVersionOption.IsSet && edFiAssessmentContentStandard.VarVersion == null)
                throw new ArgumentNullException(nameof(edFiAssessmentContentStandard.VarVersion), "Property is required for class EdFiAssessmentContentStandard.");
