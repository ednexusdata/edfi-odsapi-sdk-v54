    ...
    public class EdFiStaffEducationOrganizationAssignmentAssociationJsonConverter : JsonConverter<EdFiStaffEducationOrganizationAssignmentAssociation>
    {
        ...
        public override EdFiStaffEducationOrganizationAssignmentAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class EdFiStaffEducationOrganizationAssignmentAssociation.");

            if (fullTimeEquivalency.IsSet && fullTimeEquivalency.Value == null)
                throw new ArgumentNullException(nameof(fullTimeEquivalency), "Property is not nullable for class EdFiStaffEducationOrganizationAssignmentAssociation.");

            if (orderOfAssignment.IsSet && orderOfAssignment.Value == null)
                throw new ArgumentNullException(nameof(orderOfAssignment), "Property is not nullable for class EdFiStaffEducationOrganizationAssignmentAssociation.");

            if (positionTitle.IsSet && positionTitle.Value == null)
                throw new ArgumentNullException(nameof(positionTitle), "Property is not nullable for class EdFiStaffEducationOrganizationAssignmentAssociation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStaffEducationOrganizationAssignmentAssociation edFiStaffEducationOrganizationAssignmentAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStaffEducationOrganizationAssignmentAssociation.PositionTitleOption.IsSet && edFiStaffEducationOrganizationAssignmentAssociation.PositionTitle == null)
                throw new ArgumentNullException(nameof(edFiStaffEducationOrganizationAssignmentAssociation.PositionTitle), "Property is required for class EdFiStaffEducationOrganizationAssignmentAssociation.");
