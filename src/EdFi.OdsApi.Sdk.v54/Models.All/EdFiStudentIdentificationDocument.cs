    ...
    public class EdFiStudentIdentificationDocumentJsonConverter : JsonConverter<EdFiStudentIdentificationDocument>
    {
        ...
        public override EdFiStudentIdentificationDocument Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (issuerCountryDescriptor.IsSet && issuerCountryDescriptor.Value == null)
                throw new ArgumentNullException(nameof(issuerCountryDescriptor), "Property is not nullable for class EdFiStudentIdentificationDocument.");

            if (documentExpirationDate.IsSet && documentExpirationDate.Value == null)
                throw new ArgumentNullException(nameof(documentExpirationDate), "Property is not nullable for class EdFiStudentIdentificationDocument.");

            if (documentTitle.IsSet && documentTitle.Value == null)
                throw new ArgumentNullException(nameof(documentTitle), "Property is not nullable for class EdFiStudentIdentificationDocument.");

            if (issuerDocumentIdentificationCode.IsSet && issuerDocumentIdentificationCode.Value == null)
                throw new ArgumentNullException(nameof(issuerDocumentIdentificationCode), "Property is not nullable for class EdFiStudentIdentificationDocument.");

            if (issuerName.IsSet && issuerName.Value == null)
                throw new ArgumentNullException(nameof(issuerName), "Property is not nullable for class EdFiStudentIdentificationDocument.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentIdentificationDocument edFiStudentIdentificationDocument, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentIdentificationDocument.IssuerCountryDescriptorOption.IsSet && edFiStudentIdentificationDocument.IssuerCountryDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentIdentificationDocument.IssuerCountryDescriptor), "Property is required for class EdFiStudentIdentificationDocument.");

            if (edFiStudentIdentificationDocument.DocumentTitleOption.IsSet && edFiStudentIdentificationDocument.DocumentTitle == null)
                throw new ArgumentNullException(nameof(edFiStudentIdentificationDocument.DocumentTitle), "Property is required for class EdFiStudentIdentificationDocument.");

            if (edFiStudentIdentificationDocument.IssuerDocumentIdentificationCodeOption.IsSet && edFiStudentIdentificationDocument.IssuerDocumentIdentificationCode == null)
                throw new ArgumentNullException(nameof(edFiStudentIdentificationDocument.IssuerDocumentIdentificationCode), "Property is required for class EdFiStudentIdentificationDocument.");

            if (edFiStudentIdentificationDocument.IssuerNameOption.IsSet && edFiStudentIdentificationDocument.IssuerName == null)
                throw new ArgumentNullException(nameof(edFiStudentIdentificationDocument.IssuerName), "Property is required for class EdFiStudentIdentificationDocument.");
