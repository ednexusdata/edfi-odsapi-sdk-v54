    ...
    public class EdFiStaffCohortAssociationJsonConverter : JsonConverter<EdFiStaffCohortAssociation>
    {
        ...
        public override EdFiStaffCohortAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class EdFiStaffCohortAssociation.");

            if (studentRecordAccess.IsSet && studentRecordAccess.Value == null)
                throw new ArgumentNullException(nameof(studentRecordAccess), "Property is not nullable for class EdFiStaffCohortAssociation.");
