    ...
    public class EdFiStudentLearningObjectiveJsonConverter : JsonConverter<EdFiStudentLearningObjective>
    {
        ...
        public override EdFiStudentLearningObjective Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (diagnosticStatement.IsSet && diagnosticStatement.Value == null)
                throw new ArgumentNullException(nameof(diagnosticStatement), "Property is not nullable for class EdFiStudentLearningObjective.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentLearningObjective edFiStudentLearningObjective, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentLearningObjective.DiagnosticStatementOption.IsSet && edFiStudentLearningObjective.DiagnosticStatement == null)
                throw new ArgumentNullException(nameof(edFiStudentLearningObjective.DiagnosticStatement), "Property is required for class EdFiStudentLearningObjective.");
