...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiStaffSectionAssociation : IValidatableObject
    {
        ...
        /// <param name="classroomPositionDescriptor">The type of position the Staff member holds in the specific class/section; for example:        Teacher of Record, Assistant Teacher, Support Teacher, Substitute Teacher...</param>
    ...
    public class EdFiStaffSectionAssociationJsonConverter : JsonConverter<EdFiStaffSectionAssociation>
    {
        ...
        public override EdFiStaffSectionAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class EdFiStaffSectionAssociation.");

            if (highlyQualifiedTeacher.IsSet && highlyQualifiedTeacher.Value == null)
                throw new ArgumentNullException(nameof(highlyQualifiedTeacher), "Property is not nullable for class EdFiStaffSectionAssociation.");

            if (percentageContribution.IsSet && percentageContribution.Value == null)
                throw new ArgumentNullException(nameof(percentageContribution), "Property is not nullable for class EdFiStaffSectionAssociation.");

            if (teacherStudentDataLinkExclusion.IsSet && teacherStudentDataLinkExclusion.Value == null)
                throw new ArgumentNullException(nameof(teacherStudentDataLinkExclusion), "Property is not nullable for class EdFiStaffSectionAssociation.");
