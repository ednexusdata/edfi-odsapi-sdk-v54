...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiStudentAcademicRecordRecognition : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="recognitionTypeDescriptor">The nature of recognition given to the learner for accomplishments in a co-curricular, or extra-curricular activity.</param>
    ...
    public class EdFiStudentAcademicRecordRecognitionJsonConverter : JsonConverter<EdFiStudentAcademicRecordRecognition>
    {
        ...
        public override EdFiStudentAcademicRecordRecognition Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (achievementCategoryDescriptor.IsSet && achievementCategoryDescriptor.Value == null)
                throw new ArgumentNullException(nameof(achievementCategoryDescriptor), "Property is not nullable for class EdFiStudentAcademicRecordRecognition.");

            if (achievementCategorySystem.IsSet && achievementCategorySystem.Value == null)
                throw new ArgumentNullException(nameof(achievementCategorySystem), "Property is not nullable for class EdFiStudentAcademicRecordRecognition.");

            if (achievementTitle.IsSet && achievementTitle.Value == null)
                throw new ArgumentNullException(nameof(achievementTitle), "Property is not nullable for class EdFiStudentAcademicRecordRecognition.");

            if (criteria.IsSet && criteria.Value == null)
                throw new ArgumentNullException(nameof(criteria), "Property is not nullable for class EdFiStudentAcademicRecordRecognition.");

            if (criteriaURL.IsSet && criteriaURL.Value == null)
                throw new ArgumentNullException(nameof(criteriaURL), "Property is not nullable for class EdFiStudentAcademicRecordRecognition.");

            if (evidenceStatement.IsSet && evidenceStatement.Value == null)
                throw new ArgumentNullException(nameof(evidenceStatement), "Property is not nullable for class EdFiStudentAcademicRecordRecognition.");

            if (imageURL.IsSet && imageURL.Value == null)
                throw new ArgumentNullException(nameof(imageURL), "Property is not nullable for class EdFiStudentAcademicRecordRecognition.");

            if (issuerName.IsSet && issuerName.Value == null)
                throw new ArgumentNullException(nameof(issuerName), "Property is not nullable for class EdFiStudentAcademicRecordRecognition.");

            if (issuerOriginURL.IsSet && issuerOriginURL.Value == null)
                throw new ArgumentNullException(nameof(issuerOriginURL), "Property is not nullable for class EdFiStudentAcademicRecordRecognition.");

            if (recognitionAwardDate.IsSet && recognitionAwardDate.Value == null)
                throw new ArgumentNullException(nameof(recognitionAwardDate), "Property is not nullable for class EdFiStudentAcademicRecordRecognition.");

            if (recognitionAwardExpiresDate.IsSet && recognitionAwardExpiresDate.Value == null)
                throw new ArgumentNullException(nameof(recognitionAwardExpiresDate), "Property is not nullable for class EdFiStudentAcademicRecordRecognition.");

            if (recognitionDescription.IsSet && recognitionDescription.Value == null)
                throw new ArgumentNullException(nameof(recognitionDescription), "Property is not nullable for class EdFiStudentAcademicRecordRecognition.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentAcademicRecordRecognition edFiStudentAcademicRecordRecognition, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentAcademicRecordRecognition.AchievementCategoryDescriptorOption.IsSet && edFiStudentAcademicRecordRecognition.AchievementCategoryDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecordRecognition.AchievementCategoryDescriptor), "Property is required for class EdFiStudentAcademicRecordRecognition.");

            if (edFiStudentAcademicRecordRecognition.AchievementCategorySystemOption.IsSet && edFiStudentAcademicRecordRecognition.AchievementCategorySystem == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecordRecognition.AchievementCategorySystem), "Property is required for class EdFiStudentAcademicRecordRecognition.");

            if (edFiStudentAcademicRecordRecognition.AchievementTitleOption.IsSet && edFiStudentAcademicRecordRecognition.AchievementTitle == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecordRecognition.AchievementTitle), "Property is required for class EdFiStudentAcademicRecordRecognition.");

            if (edFiStudentAcademicRecordRecognition.CriteriaOption.IsSet && edFiStudentAcademicRecordRecognition.Criteria == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecordRecognition.Criteria), "Property is required for class EdFiStudentAcademicRecordRecognition.");

            if (edFiStudentAcademicRecordRecognition.CriteriaURLOption.IsSet && edFiStudentAcademicRecordRecognition.CriteriaURL == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecordRecognition.CriteriaURL), "Property is required for class EdFiStudentAcademicRecordRecognition.");

            if (edFiStudentAcademicRecordRecognition.EvidenceStatementOption.IsSet && edFiStudentAcademicRecordRecognition.EvidenceStatement == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecordRecognition.EvidenceStatement), "Property is required for class EdFiStudentAcademicRecordRecognition.");

            if (edFiStudentAcademicRecordRecognition.ImageURLOption.IsSet && edFiStudentAcademicRecordRecognition.ImageURL == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecordRecognition.ImageURL), "Property is required for class EdFiStudentAcademicRecordRecognition.");

            if (edFiStudentAcademicRecordRecognition.IssuerNameOption.IsSet && edFiStudentAcademicRecordRecognition.IssuerName == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecordRecognition.IssuerName), "Property is required for class EdFiStudentAcademicRecordRecognition.");

            if (edFiStudentAcademicRecordRecognition.IssuerOriginURLOption.IsSet && edFiStudentAcademicRecordRecognition.IssuerOriginURL == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecordRecognition.IssuerOriginURL), "Property is required for class EdFiStudentAcademicRecordRecognition.");

            if (edFiStudentAcademicRecordRecognition.RecognitionDescriptionOption.IsSet && edFiStudentAcademicRecordRecognition.RecognitionDescription == null)
                throw new ArgumentNullException(nameof(edFiStudentAcademicRecordRecognition.RecognitionDescription), "Property is required for class EdFiStudentAcademicRecordRecognition.");
