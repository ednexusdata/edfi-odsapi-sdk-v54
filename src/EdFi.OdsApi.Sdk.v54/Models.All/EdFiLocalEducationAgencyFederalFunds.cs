...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public class EdFiLocalEducationAgencyFederalFundsJsonConverter : JsonConverter<EdFiLocalEducationAgencyFederalFunds>
    {
        ...
        public override EdFiLocalEducationAgencyFederalFunds Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (innovativeDollarsSpent.IsSet && innovativeDollarsSpent.Value == null)
                throw new ArgumentNullException(nameof(innovativeDollarsSpent), "Property is not nullable for class EdFiLocalEducationAgencyFederalFunds.");

            if (innovativeDollarsSpentStrategicPriorities.IsSet && innovativeDollarsSpentStrategicPriorities.Value == null)
                throw new ArgumentNullException(nameof(innovativeDollarsSpentStrategicPriorities), "Property is not nullable for class EdFiLocalEducationAgencyFederalFunds.");

            if (innovativeProgramsFundsReceived.IsSet && innovativeProgramsFundsReceived.Value == null)
                throw new ArgumentNullException(nameof(innovativeProgramsFundsReceived), "Property is not nullable for class EdFiLocalEducationAgencyFederalFunds.");

            if (schoolImprovementAllocation.IsSet && schoolImprovementAllocation.Value == null)
                throw new ArgumentNullException(nameof(schoolImprovementAllocation), "Property is not nullable for class EdFiLocalEducationAgencyFederalFunds.");

            if (schoolImprovementReservedFundsPercentage.IsSet && schoolImprovementReservedFundsPercentage.Value == null)
                throw new ArgumentNullException(nameof(schoolImprovementReservedFundsPercentage), "Property is not nullable for class EdFiLocalEducationAgencyFederalFunds.");

            if (stateAssessmentAdministrationFunding.IsSet && stateAssessmentAdministrationFunding.Value == null)
                throw new ArgumentNullException(nameof(stateAssessmentAdministrationFunding), "Property is not nullable for class EdFiLocalEducationAgencyFederalFunds.");

            if (supplementalEducationalServicesFundsSpent.IsSet && supplementalEducationalServicesFundsSpent.Value == null)
                throw new ArgumentNullException(nameof(supplementalEducationalServicesFundsSpent), "Property is not nullable for class EdFiLocalEducationAgencyFederalFunds.");

            if (supplementalEducationalServicesPerPupilExpenditure.IsSet && supplementalEducationalServicesPerPupilExpenditure.Value == null)
                throw new ArgumentNullException(nameof(supplementalEducationalServicesPerPupilExpenditure), "Property is not nullable for class EdFiLocalEducationAgencyFederalFunds.");
