...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiDisciplineAction : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="disciplineActionIdentifier">Identifier assigned by the education organization to the DisciplineAction.</param>
        ...
        /// <param name="studentDisciplineIncidentAssociations">An unordered collection of disciplineActionStudentDisciplineIncidentAssociations. Reference to the DisciplineIncident associated with the DisciplineAction.</param>
        ...
        [JsonConstructor]
        public EdFiDisciplineAction(string disciplineActionIdentifier, DateOnly disciplineDate, List<EdFiDisciplineActionDiscipline> disciplines, List<EdFiDisciplineActionStudentDisciplineIncidentAssociation> studentDisciplineIncidentAssociations, EdFiSchoolReference responsibilitySchoolReference, EdFiStudentReference studentReference, Option<string?> id = default, Option<EdFiSchoolReference?> assignmentSchoolReference = default, Option<double?> actualDisciplineActionLength = default, Option<double?> disciplineActionLength = default, Option<string?> disciplineActionLengthDifferenceReasonDescriptor = default, Option<bool?> iepPlacementMeetingIndicator = default, Option<bool?> receivedEducationServicesDuringExpulsion = default, Option<bool?> relatedToZeroTolerancePolicy = default, Option<List<EdFiDisciplineActionStaff>?> staffs = default, Option<List<EdFiDisciplineActionStudentDisciplineIncidentBehaviorAssociation>?> studentDisciplineIncidentBehaviorAssociations = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
            DisciplineActionIdentifier = disciplineActionIdentifier;
            DisciplineDate = disciplineDate;
            Disciplines = disciplines;
            StudentDisciplineIncidentAssociations = studentDisciplineIncidentAssociations;
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for DisciplineActionIdentifier, length must be less than 20.", new [] { "DisciplineActionIdentifier" });
            }
    ...
    public class EdFiDisciplineActionJsonConverter : JsonConverter<EdFiDisciplineAction>
    {
        ...
        public override EdFiDisciplineAction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!studentDisciplineIncidentAssociations.IsSet)
                throw new ArgumentException("Property is required for class EdFiDisciplineAction.", nameof(studentDisciplineIncidentAssociations));
            ...
            if (actualDisciplineActionLength.IsSet && actualDisciplineActionLength.Value == null)
                throw new ArgumentNullException(nameof(actualDisciplineActionLength), "Property is not nullable for class EdFiDisciplineAction.");

            if (disciplineActionLength.IsSet && disciplineActionLength.Value == null)
                throw new ArgumentNullException(nameof(disciplineActionLength), "Property is not nullable for class EdFiDisciplineAction.");

            if (disciplineActionLengthDifferenceReasonDescriptor.IsSet && disciplineActionLengthDifferenceReasonDescriptor.Value == null)
                throw new ArgumentNullException(nameof(disciplineActionLengthDifferenceReasonDescriptor), "Property is not nullable for class EdFiDisciplineAction.");

            if (iepPlacementMeetingIndicator.IsSet && iepPlacementMeetingIndicator.Value == null)
                throw new ArgumentNullException(nameof(iepPlacementMeetingIndicator), "Property is not nullable for class EdFiDisciplineAction.");

            if (receivedEducationServicesDuringExpulsion.IsSet && receivedEducationServicesDuringExpulsion.Value == null)
                throw new ArgumentNullException(nameof(receivedEducationServicesDuringExpulsion), "Property is not nullable for class EdFiDisciplineAction.");

            if (relatedToZeroTolerancePolicy.IsSet && relatedToZeroTolerancePolicy.Value == null)
                throw new ArgumentNullException(nameof(relatedToZeroTolerancePolicy), "Property is not nullable for class EdFiDisciplineAction.");
            ...
            return new EdFiDisciplineAction(disciplineActionIdentifier.Value!, disciplineDate.Value!.Value!, disciplines.Value!, studentDisciplineIncidentAssociations.Value!, responsibilitySchoolReference.Value!, studentReference.Value!, id, assignmentSchoolReference, actualDisciplineActionLength, disciplineActionLength, disciplineActionLengthDifferenceReasonDescriptor, iepPlacementMeetingIndicator, receivedEducationServicesDuringExpulsion, relatedToZeroTolerancePolicy, staffs, studentDisciplineIncidentBehaviorAssociations, etag, ext);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiDisciplineAction edFiDisciplineAction, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiDisciplineAction.StudentDisciplineIncidentAssociations == null)
            ...
            if (edFiDisciplineAction.DisciplineActionLengthDifferenceReasonDescriptorOption.IsSet && edFiDisciplineAction.DisciplineActionLengthDifferenceReasonDescriptor == null)
                throw new ArgumentNullException(nameof(edFiDisciplineAction.DisciplineActionLengthDifferenceReasonDescriptor), "Property is required for class EdFiDisciplineAction.");
