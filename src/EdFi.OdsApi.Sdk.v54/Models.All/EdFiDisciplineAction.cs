...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiDisciplineAction : IValidatableObject
    {
        ...
        public EdFiDisciplineAction(string id = default, string disciplineActionIdentifier = default, DateOnly disciplineDate = default, List<EdFiDisciplineActionDiscipline> disciplines = default, List<EdFiDisciplineActionStudentDisciplineIncidentAssociation> studentDisciplineIncidentAssociations = default, EdFiSchoolReference assignmentSchoolReference = default, EdFiSchoolReference responsibilitySchoolReference = default, EdFiStudentReference studentReference = default, double actualDisciplineActionLength = default, double disciplineActionLength = default, string disciplineActionLengthDifferenceReasonDescriptor = default, bool iepPlacementMeetingIndicator = default, bool receivedEducationServicesDuringExpulsion = default, bool relatedToZeroTolerancePolicy = default, List<EdFiDisciplineActionStaff> staffs = default, List<EdFiDisciplineActionStudentDisciplineIncidentBehaviorAssociation> studentDisciplineIncidentBehaviorAssociations = default, string etag = default, Object ext = default)
        {
            ...
            {
                throw new ArgumentNullException("studentDisciplineIncidentAssociations is a required property for EdFiDisciplineAction and cannot be null");
            }
        ...
        [DataMember(Name = "studentDisciplineIncidentAssociations", IsRequired = true, EmitDefaultValue = true)]
