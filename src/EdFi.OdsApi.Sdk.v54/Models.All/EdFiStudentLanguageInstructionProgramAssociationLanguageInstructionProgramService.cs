    ...
    public class EdFiStudentLanguageInstructionProgramAssociationLanguageInstructionProgramServiceJsonConverter : JsonConverter<EdFiStudentLanguageInstructionProgramAssociationLanguageInstructionProgramService>
    {
        ...
        public override EdFiStudentLanguageInstructionProgramAssociationLanguageInstructionProgramService Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (primaryIndicator.IsSet && primaryIndicator.Value == null)
                throw new ArgumentNullException(nameof(primaryIndicator), "Property is not nullable for class EdFiStudentLanguageInstructionProgramAssociationLanguageInstructionProgramService.");

            if (serviceBeginDate.IsSet && serviceBeginDate.Value == null)
                throw new ArgumentNullException(nameof(serviceBeginDate), "Property is not nullable for class EdFiStudentLanguageInstructionProgramAssociationLanguageInstructionProgramService.");

            if (serviceEndDate.IsSet && serviceEndDate.Value == null)
                throw new ArgumentNullException(nameof(serviceEndDate), "Property is not nullable for class EdFiStudentLanguageInstructionProgramAssociationLanguageInstructionProgramService.");
