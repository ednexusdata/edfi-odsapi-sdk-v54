...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel : IValidatableObject
    {
        ...
        /// <param name="performanceLevelMet">Indicator of whether the performance level was met.</param>
        /// <param name="ext">Extensions to the StudentAssessmentStudentObjectiveAssessmentPerformanceLevel entity.</param>
        [JsonConstructor]
        public EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel(string assessmentReportingMethodDescriptor, string performanceLevelDescriptor, bool performanceLevelMet, Option<Object?> ext = default)
        {
            ...
            PerformanceLevelMet = performanceLevelMet;
            ExtOption = ext;
            OnCreated();
        }
        ...
        [JsonPropertyName("performanceLevelMet")]
    ...
    public class EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevelJsonConverter : JsonConverter<EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel>
    {
        ...
        public override EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<bool?> performanceLevelMet = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "performanceLevelDescriptor":
                            ...
                            break;
                        case "performanceLevelMet":
                            performanceLevelMet = new Option<bool?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (bool?)null : utf8JsonReader.GetBoolean());
                            break;
                        case "_ext":
            ...
            if (!performanceLevelMet.IsSet)
                throw new ArgumentException("Property is required for class EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel.", nameof(performanceLevelMet));
            ...
            if (performanceLevelMet.IsSet && performanceLevelMet.Value == null)
                throw new ArgumentNullException(nameof(performanceLevelMet), "Property is not nullable for class EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel.");
            ...
            return new EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel(assessmentReportingMethodDescriptor.Value!, performanceLevelDescriptor.Value!, performanceLevelMet.Value!.Value!, ext);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel edFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteBoolean("performanceLevelMet", edFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel.PerformanceLevelMet);
