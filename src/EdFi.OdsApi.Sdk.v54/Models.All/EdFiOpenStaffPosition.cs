...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiOpenStaffPosition : IValidatableObject
    {
        ...
        /// <param name="employmentStatusDescriptor">Reflects the type of employment or contract desired for the position; for example:        Probationary        Contractual        Substitute/temporary        Tenured or permanent        Volunteer/no contract        ...</param>
    ...
    public class EdFiOpenStaffPositionJsonConverter : JsonConverter<EdFiOpenStaffPosition>
    {
        ...
        public override EdFiOpenStaffPosition Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (datePostingRemoved.IsSet && datePostingRemoved.Value == null)
                throw new ArgumentNullException(nameof(datePostingRemoved), "Property is not nullable for class EdFiOpenStaffPosition.");
            ...
            if (positionTitle.IsSet && positionTitle.Value == null)
                throw new ArgumentNullException(nameof(positionTitle), "Property is not nullable for class EdFiOpenStaffPosition.");

            if (postingResultDescriptor.IsSet && postingResultDescriptor.Value == null)
                throw new ArgumentNullException(nameof(postingResultDescriptor), "Property is not nullable for class EdFiOpenStaffPosition.");

            if (programAssignmentDescriptor.IsSet && programAssignmentDescriptor.Value == null)
                throw new ArgumentNullException(nameof(programAssignmentDescriptor), "Property is not nullable for class EdFiOpenStaffPosition.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiOpenStaffPosition edFiOpenStaffPosition, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiOpenStaffPosition.PositionTitleOption.IsSet && edFiOpenStaffPosition.PositionTitle == null)
                throw new ArgumentNullException(nameof(edFiOpenStaffPosition.PositionTitle), "Property is required for class EdFiOpenStaffPosition.");

            if (edFiOpenStaffPosition.PostingResultDescriptorOption.IsSet && edFiOpenStaffPosition.PostingResultDescriptor == null)
                throw new ArgumentNullException(nameof(edFiOpenStaffPosition.PostingResultDescriptor), "Property is required for class EdFiOpenStaffPosition.");

            if (edFiOpenStaffPosition.ProgramAssignmentDescriptorOption.IsSet && edFiOpenStaffPosition.ProgramAssignmentDescriptor == null)
                throw new ArgumentNullException(nameof(edFiOpenStaffPosition.ProgramAssignmentDescriptor), "Property is required for class EdFiOpenStaffPosition.");
