...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiGraduationPlanRequiredAssessmentPerformanceLevel : IValidatableObject
    {
        ...
        public EdFiGraduationPlanRequiredAssessmentPerformanceLevel(string assessmentReportingMethodDescriptor = default, string performanceLevelDescriptor = default, string resultDatatypeTypeDescriptor = default, string maximumScore = default, string minimumScore = default, Object ext = default)
        {
