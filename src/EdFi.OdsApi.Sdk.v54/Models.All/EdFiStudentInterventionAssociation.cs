    ...
    public class EdFiStudentInterventionAssociationJsonConverter : JsonConverter<EdFiStudentInterventionAssociation>
    {
        ...
        public override EdFiStudentInterventionAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (diagnosticStatement.IsSet && diagnosticStatement.Value == null)
                throw new ArgumentNullException(nameof(diagnosticStatement), "Property is not nullable for class EdFiStudentInterventionAssociation.");

            if (dosage.IsSet && dosage.Value == null)
                throw new ArgumentNullException(nameof(dosage), "Property is not nullable for class EdFiStudentInterventionAssociation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentInterventionAssociation edFiStudentInterventionAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentInterventionAssociation.DiagnosticStatementOption.IsSet && edFiStudentInterventionAssociation.DiagnosticStatement == null)
                throw new ArgumentNullException(nameof(edFiStudentInterventionAssociation.DiagnosticStatement), "Property is required for class EdFiStudentInterventionAssociation.");
