    ...
    public class EdFiGradeJsonConverter : JsonConverter<EdFiGrade>
    {
        ...
        public override EdFiGrade Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (diagnosticStatement.IsSet && diagnosticStatement.Value == null)
                throw new ArgumentNullException(nameof(diagnosticStatement), "Property is not nullable for class EdFiGrade.");
            ...
            if (letterGradeEarned.IsSet && letterGradeEarned.Value == null)
                throw new ArgumentNullException(nameof(letterGradeEarned), "Property is not nullable for class EdFiGrade.");

            if (numericGradeEarned.IsSet && numericGradeEarned.Value == null)
                throw new ArgumentNullException(nameof(numericGradeEarned), "Property is not nullable for class EdFiGrade.");

            if (performanceBaseConversionDescriptor.IsSet && performanceBaseConversionDescriptor.Value == null)
                throw new ArgumentNullException(nameof(performanceBaseConversionDescriptor), "Property is not nullable for class EdFiGrade.");
            ...
            return new EdFiGrade(gradeTypeDescriptor.Value!, gradingPeriodReference.Value!, studentSectionAssociationReference.Value!, id, diagnosticStatement, learningStandardGrades, letterGradeEarned, numericGradeEarned, performanceBaseConversionDescriptor, etag, ext);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiGrade edFiGrade, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiGrade.DiagnosticStatementOption.IsSet && edFiGrade.DiagnosticStatement == null)
                throw new ArgumentNullException(nameof(edFiGrade.DiagnosticStatement), "Property is required for class EdFiGrade.");
            ...
            if (edFiGrade.LetterGradeEarnedOption.IsSet && edFiGrade.LetterGradeEarned == null)
                throw new ArgumentNullException(nameof(edFiGrade.LetterGradeEarned), "Property is required for class EdFiGrade.");

            if (edFiGrade.PerformanceBaseConversionDescriptorOption.IsSet && edFiGrade.PerformanceBaseConversionDescriptor == null)
                throw new ArgumentNullException(nameof(edFiGrade.PerformanceBaseConversionDescriptor), "Property is required for class EdFiGrade.");
