    ...
    public class EdFiPostSecondaryInstitutionJsonConverter : JsonConverter<EdFiPostSecondaryInstitution>
    {
        ...
        public override EdFiPostSecondaryInstitution Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (administrativeFundingControlDescriptor.IsSet && administrativeFundingControlDescriptor.Value == null)
                throw new ArgumentNullException(nameof(administrativeFundingControlDescriptor), "Property is not nullable for class EdFiPostSecondaryInstitution.");
            ...
            if (operationalStatusDescriptor.IsSet && operationalStatusDescriptor.Value == null)
                throw new ArgumentNullException(nameof(operationalStatusDescriptor), "Property is not nullable for class EdFiPostSecondaryInstitution.");

            if (postSecondaryInstitutionLevelDescriptor.IsSet && postSecondaryInstitutionLevelDescriptor.Value == null)
                throw new ArgumentNullException(nameof(postSecondaryInstitutionLevelDescriptor), "Property is not nullable for class EdFiPostSecondaryInstitution.");

            if (shortNameOfInstitution.IsSet && shortNameOfInstitution.Value == null)
                throw new ArgumentNullException(nameof(shortNameOfInstitution), "Property is not nullable for class EdFiPostSecondaryInstitution.");

            if (webSite.IsSet && webSite.Value == null)
                throw new ArgumentNullException(nameof(webSite), "Property is not nullable for class EdFiPostSecondaryInstitution.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiPostSecondaryInstitution edFiPostSecondaryInstitution, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiPostSecondaryInstitution.AdministrativeFundingControlDescriptorOption.IsSet && edFiPostSecondaryInstitution.AdministrativeFundingControlDescriptor == null)
                throw new ArgumentNullException(nameof(edFiPostSecondaryInstitution.AdministrativeFundingControlDescriptor), "Property is required for class EdFiPostSecondaryInstitution.");
            ...
            if (edFiPostSecondaryInstitution.OperationalStatusDescriptorOption.IsSet && edFiPostSecondaryInstitution.OperationalStatusDescriptor == null)
                throw new ArgumentNullException(nameof(edFiPostSecondaryInstitution.OperationalStatusDescriptor), "Property is required for class EdFiPostSecondaryInstitution.");

            if (edFiPostSecondaryInstitution.PostSecondaryInstitutionLevelDescriptorOption.IsSet && edFiPostSecondaryInstitution.PostSecondaryInstitutionLevelDescriptor == null)
                throw new ArgumentNullException(nameof(edFiPostSecondaryInstitution.PostSecondaryInstitutionLevelDescriptor), "Property is required for class EdFiPostSecondaryInstitution.");

            if (edFiPostSecondaryInstitution.ShortNameOfInstitutionOption.IsSet && edFiPostSecondaryInstitution.ShortNameOfInstitution == null)
                throw new ArgumentNullException(nameof(edFiPostSecondaryInstitution.ShortNameOfInstitution), "Property is required for class EdFiPostSecondaryInstitution.");

            if (edFiPostSecondaryInstitution.WebSiteOption.IsSet && edFiPostSecondaryInstitution.WebSite == null)
                throw new ArgumentNullException(nameof(edFiPostSecondaryInstitution.WebSite), "Property is required for class EdFiPostSecondaryInstitution.");
