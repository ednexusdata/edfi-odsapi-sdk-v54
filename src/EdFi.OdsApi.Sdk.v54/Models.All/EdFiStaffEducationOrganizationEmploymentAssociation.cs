...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiStaffEducationOrganizationEmploymentAssociation : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="employmentStatusDescriptor">Reflects the type of employment or contract; for example:        Probationary        Contractual        Substitute/temporary        Tenured or permanent        Volunteer/no contract        ...</param>
    ...
    public class EdFiStaffEducationOrganizationEmploymentAssociationJsonConverter : JsonConverter<EdFiStaffEducationOrganizationEmploymentAssociation>
    {
        ...
        public override EdFiStaffEducationOrganizationEmploymentAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (department.IsSet && department.Value == null)
                throw new ArgumentNullException(nameof(department), "Property is not nullable for class EdFiStaffEducationOrganizationEmploymentAssociation.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class EdFiStaffEducationOrganizationEmploymentAssociation.");

            if (fullTimeEquivalency.IsSet && fullTimeEquivalency.Value == null)
                throw new ArgumentNullException(nameof(fullTimeEquivalency), "Property is not nullable for class EdFiStaffEducationOrganizationEmploymentAssociation.");

            if (hourlyWage.IsSet && hourlyWage.Value == null)
                throw new ArgumentNullException(nameof(hourlyWage), "Property is not nullable for class EdFiStaffEducationOrganizationEmploymentAssociation.");

            if (offerDate.IsSet && offerDate.Value == null)
                throw new ArgumentNullException(nameof(offerDate), "Property is not nullable for class EdFiStaffEducationOrganizationEmploymentAssociation.");

            if (separationDescriptor.IsSet && separationDescriptor.Value == null)
                throw new ArgumentNullException(nameof(separationDescriptor), "Property is not nullable for class EdFiStaffEducationOrganizationEmploymentAssociation.");

            if (separationReasonDescriptor.IsSet && separationReasonDescriptor.Value == null)
                throw new ArgumentNullException(nameof(separationReasonDescriptor), "Property is not nullable for class EdFiStaffEducationOrganizationEmploymentAssociation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStaffEducationOrganizationEmploymentAssociation edFiStaffEducationOrganizationEmploymentAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStaffEducationOrganizationEmploymentAssociation.DepartmentOption.IsSet && edFiStaffEducationOrganizationEmploymentAssociation.Department == null)
                throw new ArgumentNullException(nameof(edFiStaffEducationOrganizationEmploymentAssociation.Department), "Property is required for class EdFiStaffEducationOrganizationEmploymentAssociation.");

            if (edFiStaffEducationOrganizationEmploymentAssociation.SeparationDescriptorOption.IsSet && edFiStaffEducationOrganizationEmploymentAssociation.SeparationDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaffEducationOrganizationEmploymentAssociation.SeparationDescriptor), "Property is required for class EdFiStaffEducationOrganizationEmploymentAssociation.");

            if (edFiStaffEducationOrganizationEmploymentAssociation.SeparationReasonDescriptorOption.IsSet && edFiStaffEducationOrganizationEmploymentAssociation.SeparationReasonDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaffEducationOrganizationEmploymentAssociation.SeparationReasonDescriptor), "Property is required for class EdFiStaffEducationOrganizationEmploymentAssociation.");
