    ...
    public class EdFiStudentSpecialEducationProgramAssociationJsonConverter : JsonConverter<EdFiStudentSpecialEducationProgramAssociation>
    {
        ...
        public override EdFiStudentSpecialEducationProgramAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class EdFiStudentSpecialEducationProgramAssociation.");

            if (ideaEligibility.IsSet && ideaEligibility.Value == null)
                throw new ArgumentNullException(nameof(ideaEligibility), "Property is not nullable for class EdFiStudentSpecialEducationProgramAssociation.");

            if (iepBeginDate.IsSet && iepBeginDate.Value == null)
                throw new ArgumentNullException(nameof(iepBeginDate), "Property is not nullable for class EdFiStudentSpecialEducationProgramAssociation.");

            if (iepEndDate.IsSet && iepEndDate.Value == null)
                throw new ArgumentNullException(nameof(iepEndDate), "Property is not nullable for class EdFiStudentSpecialEducationProgramAssociation.");

            if (iepReviewDate.IsSet && iepReviewDate.Value == null)
                throw new ArgumentNullException(nameof(iepReviewDate), "Property is not nullable for class EdFiStudentSpecialEducationProgramAssociation.");

            if (lastEvaluationDate.IsSet && lastEvaluationDate.Value == null)
                throw new ArgumentNullException(nameof(lastEvaluationDate), "Property is not nullable for class EdFiStudentSpecialEducationProgramAssociation.");

            if (medicallyFragile.IsSet && medicallyFragile.Value == null)
                throw new ArgumentNullException(nameof(medicallyFragile), "Property is not nullable for class EdFiStudentSpecialEducationProgramAssociation.");

            if (multiplyDisabled.IsSet && multiplyDisabled.Value == null)
                throw new ArgumentNullException(nameof(multiplyDisabled), "Property is not nullable for class EdFiStudentSpecialEducationProgramAssociation.");
            ...
            if (reasonExitedDescriptor.IsSet && reasonExitedDescriptor.Value == null)
                throw new ArgumentNullException(nameof(reasonExitedDescriptor), "Property is not nullable for class EdFiStudentSpecialEducationProgramAssociation.");

            if (schoolHoursPerWeek.IsSet && schoolHoursPerWeek.Value == null)
                throw new ArgumentNullException(nameof(schoolHoursPerWeek), "Property is not nullable for class EdFiStudentSpecialEducationProgramAssociation.");

            if (servedOutsideOfRegularSession.IsSet && servedOutsideOfRegularSession.Value == null)
                throw new ArgumentNullException(nameof(servedOutsideOfRegularSession), "Property is not nullable for class EdFiStudentSpecialEducationProgramAssociation.");
            ...
            if (specialEducationHoursPerWeek.IsSet && specialEducationHoursPerWeek.Value == null)
                throw new ArgumentNullException(nameof(specialEducationHoursPerWeek), "Property is not nullable for class EdFiStudentSpecialEducationProgramAssociation.");
            ...
            if (specialEducationSettingDescriptor.IsSet && specialEducationSettingDescriptor.Value == null)
                throw new ArgumentNullException(nameof(specialEducationSettingDescriptor), "Property is not nullable for class EdFiStudentSpecialEducationProgramAssociation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentSpecialEducationProgramAssociation edFiStudentSpecialEducationProgramAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentSpecialEducationProgramAssociation.ReasonExitedDescriptorOption.IsSet && edFiStudentSpecialEducationProgramAssociation.ReasonExitedDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentSpecialEducationProgramAssociation.ReasonExitedDescriptor), "Property is required for class EdFiStudentSpecialEducationProgramAssociation.");
            ...
            if (edFiStudentSpecialEducationProgramAssociation.SpecialEducationSettingDescriptorOption.IsSet && edFiStudentSpecialEducationProgramAssociation.SpecialEducationSettingDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentSpecialEducationProgramAssociation.SpecialEducationSettingDescriptor), "Property is required for class EdFiStudentSpecialEducationProgramAssociation.");
