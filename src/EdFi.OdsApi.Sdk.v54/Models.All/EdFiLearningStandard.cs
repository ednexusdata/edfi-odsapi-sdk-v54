...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiLearningStandard : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="academicSubjects">An unordered collection of learningStandardAcademicSubjects. Subject area for the LearningStandard.</param>
    ...
    public class EdFiLearningStandardJsonConverter : JsonConverter<EdFiLearningStandard>
    {
        ...
        public override EdFiLearningStandard Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (courseTitle.IsSet && courseTitle.Value == null)
                throw new ArgumentNullException(nameof(courseTitle), "Property is not nullable for class EdFiLearningStandard.");
            ...
            if (learningStandardCategoryDescriptor.IsSet && learningStandardCategoryDescriptor.Value == null)
                throw new ArgumentNullException(nameof(learningStandardCategoryDescriptor), "Property is not nullable for class EdFiLearningStandard.");

            if (learningStandardItemCode.IsSet && learningStandardItemCode.Value == null)
                throw new ArgumentNullException(nameof(learningStandardItemCode), "Property is not nullable for class EdFiLearningStandard.");

            if (learningStandardScopeDescriptor.IsSet && learningStandardScopeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(learningStandardScopeDescriptor), "Property is not nullable for class EdFiLearningStandard.");
            ...
            if (successCriteria.IsSet && successCriteria.Value == null)
                throw new ArgumentNullException(nameof(successCriteria), "Property is not nullable for class EdFiLearningStandard.");

            if (uri.IsSet && uri.Value == null)
                throw new ArgumentNullException(nameof(uri), "Property is not nullable for class EdFiLearningStandard.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiLearningStandard edFiLearningStandard, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiLearningStandard.CourseTitleOption.IsSet && edFiLearningStandard.CourseTitle == null)
                throw new ArgumentNullException(nameof(edFiLearningStandard.CourseTitle), "Property is required for class EdFiLearningStandard.");
            ...
            if (edFiLearningStandard.LearningStandardCategoryDescriptorOption.IsSet && edFiLearningStandard.LearningStandardCategoryDescriptor == null)
                throw new ArgumentNullException(nameof(edFiLearningStandard.LearningStandardCategoryDescriptor), "Property is required for class EdFiLearningStandard.");

            if (edFiLearningStandard.LearningStandardItemCodeOption.IsSet && edFiLearningStandard.LearningStandardItemCode == null)
                throw new ArgumentNullException(nameof(edFiLearningStandard.LearningStandardItemCode), "Property is required for class EdFiLearningStandard.");

            if (edFiLearningStandard.LearningStandardScopeDescriptorOption.IsSet && edFiLearningStandard.LearningStandardScopeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiLearningStandard.LearningStandardScopeDescriptor), "Property is required for class EdFiLearningStandard.");
            ...
            if (edFiLearningStandard.SuccessCriteriaOption.IsSet && edFiLearningStandard.SuccessCriteria == null)
                throw new ArgumentNullException(nameof(edFiLearningStandard.SuccessCriteria), "Property is required for class EdFiLearningStandard.");

            if (edFiLearningStandard.UriOption.IsSet && edFiLearningStandard.Uri == null)
                throw new ArgumentNullException(nameof(edFiLearningStandard.Uri), "Property is required for class EdFiLearningStandard.");
