...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiCompetencyObjective : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="objective">The designated title of the CompetencyObjective.</param>
        /// <param name="objectiveGradeLevelDescriptor">The grade level for which the CompetencyObjective is targeted.</param>
    ...
    public class EdFiCompetencyObjectiveJsonConverter : JsonConverter<EdFiCompetencyObjective>
    {
        ...
        public override EdFiCompetencyObjective Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (competencyObjectiveId.IsSet && competencyObjectiveId.Value == null)
                throw new ArgumentNullException(nameof(competencyObjectiveId), "Property is not nullable for class EdFiCompetencyObjective.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class EdFiCompetencyObjective.");

            if (successCriteria.IsSet && successCriteria.Value == null)
                throw new ArgumentNullException(nameof(successCriteria), "Property is not nullable for class EdFiCompetencyObjective.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiCompetencyObjective edFiCompetencyObjective, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiCompetencyObjective.CompetencyObjectiveIdOption.IsSet && edFiCompetencyObjective.CompetencyObjectiveId == null)
                throw new ArgumentNullException(nameof(edFiCompetencyObjective.CompetencyObjectiveId), "Property is required for class EdFiCompetencyObjective.");

            if (edFiCompetencyObjective.DescriptionOption.IsSet && edFiCompetencyObjective.Description == null)
                throw new ArgumentNullException(nameof(edFiCompetencyObjective.Description), "Property is required for class EdFiCompetencyObjective.");

            if (edFiCompetencyObjective.SuccessCriteriaOption.IsSet && edFiCompetencyObjective.SuccessCriteria == null)
                throw new ArgumentNullException(nameof(edFiCompetencyObjective.SuccessCriteria), "Property is required for class EdFiCompetencyObjective.");
