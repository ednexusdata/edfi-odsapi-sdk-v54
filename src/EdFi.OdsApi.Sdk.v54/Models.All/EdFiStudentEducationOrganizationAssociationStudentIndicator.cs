    ...
    public class EdFiStudentEducationOrganizationAssociationStudentIndicatorJsonConverter : JsonConverter<EdFiStudentEducationOrganizationAssociationStudentIndicator>
    {
        ...
        public override EdFiStudentEducationOrganizationAssociationStudentIndicator Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (designatedBy.IsSet && designatedBy.Value == null)
                throw new ArgumentNullException(nameof(designatedBy), "Property is not nullable for class EdFiStudentEducationOrganizationAssociationStudentIndicator.");

            if (indicatorGroup.IsSet && indicatorGroup.Value == null)
                throw new ArgumentNullException(nameof(indicatorGroup), "Property is not nullable for class EdFiStudentEducationOrganizationAssociationStudentIndicator.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentEducationOrganizationAssociationStudentIndicator edFiStudentEducationOrganizationAssociationStudentIndicator, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentEducationOrganizationAssociationStudentIndicator.DesignatedByOption.IsSet && edFiStudentEducationOrganizationAssociationStudentIndicator.DesignatedBy == null)
                throw new ArgumentNullException(nameof(edFiStudentEducationOrganizationAssociationStudentIndicator.DesignatedBy), "Property is required for class EdFiStudentEducationOrganizationAssociationStudentIndicator.");

            if (edFiStudentEducationOrganizationAssociationStudentIndicator.IndicatorGroupOption.IsSet && edFiStudentEducationOrganizationAssociationStudentIndicator.IndicatorGroup == null)
                throw new ArgumentNullException(nameof(edFiStudentEducationOrganizationAssociationStudentIndicator.IndicatorGroup), "Property is required for class EdFiStudentEducationOrganizationAssociationStudentIndicator.");
