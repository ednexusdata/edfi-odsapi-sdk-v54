    ...
    public class EdFiStateEducationAgencyJsonConverter : JsonConverter<EdFiStateEducationAgency>
    {
        ...
        public override EdFiStateEducationAgency Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (operationalStatusDescriptor.IsSet && operationalStatusDescriptor.Value == null)
                throw new ArgumentNullException(nameof(operationalStatusDescriptor), "Property is not nullable for class EdFiStateEducationAgency.");

            if (shortNameOfInstitution.IsSet && shortNameOfInstitution.Value == null)
                throw new ArgumentNullException(nameof(shortNameOfInstitution), "Property is not nullable for class EdFiStateEducationAgency.");

            if (webSite.IsSet && webSite.Value == null)
                throw new ArgumentNullException(nameof(webSite), "Property is not nullable for class EdFiStateEducationAgency.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStateEducationAgency edFiStateEducationAgency, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStateEducationAgency.OperationalStatusDescriptorOption.IsSet && edFiStateEducationAgency.OperationalStatusDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStateEducationAgency.OperationalStatusDescriptor), "Property is required for class EdFiStateEducationAgency.");

            if (edFiStateEducationAgency.ShortNameOfInstitutionOption.IsSet && edFiStateEducationAgency.ShortNameOfInstitution == null)
                throw new ArgumentNullException(nameof(edFiStateEducationAgency.ShortNameOfInstitution), "Property is required for class EdFiStateEducationAgency.");

            if (edFiStateEducationAgency.WebSiteOption.IsSet && edFiStateEducationAgency.WebSite == null)
                throw new ArgumentNullException(nameof(edFiStateEducationAgency.WebSite), "Property is required for class EdFiStateEducationAgency.");
