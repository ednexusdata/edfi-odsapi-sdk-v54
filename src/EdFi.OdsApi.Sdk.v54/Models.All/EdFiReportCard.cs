...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public class EdFiReportCardJsonConverter : JsonConverter<EdFiReportCard>
    {
        ...
        public override EdFiReportCard Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (gpaCumulative.IsSet && gpaCumulative.Value == null)
                throw new ArgumentNullException(nameof(gpaCumulative), "Property is not nullable for class EdFiReportCard.");

            if (gpaGivenGradingPeriod.IsSet && gpaGivenGradingPeriod.Value == null)
                throw new ArgumentNullException(nameof(gpaGivenGradingPeriod), "Property is not nullable for class EdFiReportCard.");
            ...
            if (numberOfDaysAbsent.IsSet && numberOfDaysAbsent.Value == null)
                throw new ArgumentNullException(nameof(numberOfDaysAbsent), "Property is not nullable for class EdFiReportCard.");

            if (numberOfDaysInAttendance.IsSet && numberOfDaysInAttendance.Value == null)
                throw new ArgumentNullException(nameof(numberOfDaysInAttendance), "Property is not nullable for class EdFiReportCard.");

            if (numberOfDaysTardy.IsSet && numberOfDaysTardy.Value == null)
                throw new ArgumentNullException(nameof(numberOfDaysTardy), "Property is not nullable for class EdFiReportCard.");
