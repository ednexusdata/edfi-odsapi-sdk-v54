    ...
    public class EdFiCourseJsonConverter : JsonConverter<EdFiCourse>
    {
        ...
        public override EdFiCourse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (academicSubjectDescriptor.IsSet && academicSubjectDescriptor.Value == null)
                throw new ArgumentNullException(nameof(academicSubjectDescriptor), "Property is not nullable for class EdFiCourse.");

            if (careerPathwayDescriptor.IsSet && careerPathwayDescriptor.Value == null)
                throw new ArgumentNullException(nameof(careerPathwayDescriptor), "Property is not nullable for class EdFiCourse.");
            ...
            if (courseDefinedByDescriptor.IsSet && courseDefinedByDescriptor.Value == null)
                throw new ArgumentNullException(nameof(courseDefinedByDescriptor), "Property is not nullable for class EdFiCourse.");

            if (courseDescription.IsSet && courseDescription.Value == null)
                throw new ArgumentNullException(nameof(courseDescription), "Property is not nullable for class EdFiCourse.");

            if (courseGPAApplicabilityDescriptor.IsSet && courseGPAApplicabilityDescriptor.Value == null)
                throw new ArgumentNullException(nameof(courseGPAApplicabilityDescriptor), "Property is not nullable for class EdFiCourse.");

            if (dateCourseAdopted.IsSet && dateCourseAdopted.Value == null)
                throw new ArgumentNullException(nameof(dateCourseAdopted), "Property is not nullable for class EdFiCourse.");

            if (highSchoolCourseRequirement.IsSet && highSchoolCourseRequirement.Value == null)
                throw new ArgumentNullException(nameof(highSchoolCourseRequirement), "Property is not nullable for class EdFiCourse.");
            ...
            if (maxCompletionsForCredit.IsSet && maxCompletionsForCredit.Value == null)
                throw new ArgumentNullException(nameof(maxCompletionsForCredit), "Property is not nullable for class EdFiCourse.");

            if (maximumAvailableCreditConversion.IsSet && maximumAvailableCreditConversion.Value == null)
                throw new ArgumentNullException(nameof(maximumAvailableCreditConversion), "Property is not nullable for class EdFiCourse.");

            if (maximumAvailableCredits.IsSet && maximumAvailableCredits.Value == null)
                throw new ArgumentNullException(nameof(maximumAvailableCredits), "Property is not nullable for class EdFiCourse.");

            if (maximumAvailableCreditTypeDescriptor.IsSet && maximumAvailableCreditTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(maximumAvailableCreditTypeDescriptor), "Property is not nullable for class EdFiCourse.");

            if (minimumAvailableCreditConversion.IsSet && minimumAvailableCreditConversion.Value == null)
                throw new ArgumentNullException(nameof(minimumAvailableCreditConversion), "Property is not nullable for class EdFiCourse.");

            if (minimumAvailableCredits.IsSet && minimumAvailableCredits.Value == null)
                throw new ArgumentNullException(nameof(minimumAvailableCredits), "Property is not nullable for class EdFiCourse.");

            if (minimumAvailableCreditTypeDescriptor.IsSet && minimumAvailableCreditTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(minimumAvailableCreditTypeDescriptor), "Property is not nullable for class EdFiCourse.");
            ...
            if (timeRequiredForCompletion.IsSet && timeRequiredForCompletion.Value == null)
                throw new ArgumentNullException(nameof(timeRequiredForCompletion), "Property is not nullable for class EdFiCourse.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiCourse edFiCourse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiCourse.AcademicSubjectDescriptorOption.IsSet && edFiCourse.AcademicSubjectDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCourse.AcademicSubjectDescriptor), "Property is required for class EdFiCourse.");

            if (edFiCourse.CareerPathwayDescriptorOption.IsSet && edFiCourse.CareerPathwayDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCourse.CareerPathwayDescriptor), "Property is required for class EdFiCourse.");
            ...
            if (edFiCourse.CourseDefinedByDescriptorOption.IsSet && edFiCourse.CourseDefinedByDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCourse.CourseDefinedByDescriptor), "Property is required for class EdFiCourse.");

            if (edFiCourse.CourseDescriptionOption.IsSet && edFiCourse.CourseDescription == null)
                throw new ArgumentNullException(nameof(edFiCourse.CourseDescription), "Property is required for class EdFiCourse.");

            if (edFiCourse.CourseGPAApplicabilityDescriptorOption.IsSet && edFiCourse.CourseGPAApplicabilityDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCourse.CourseGPAApplicabilityDescriptor), "Property is required for class EdFiCourse.");
            ...
            if (edFiCourse.MaximumAvailableCreditTypeDescriptorOption.IsSet && edFiCourse.MaximumAvailableCreditTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCourse.MaximumAvailableCreditTypeDescriptor), "Property is required for class EdFiCourse.");

            if (edFiCourse.MinimumAvailableCreditTypeDescriptorOption.IsSet && edFiCourse.MinimumAvailableCreditTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCourse.MinimumAvailableCreditTypeDescriptor), "Property is required for class EdFiCourse.");
