    ...
    public class EdFiGraduationPlanCreditsBySubjectJsonConverter : JsonConverter<EdFiGraduationPlanCreditsBySubject>
    {
        ...
        public override EdFiGraduationPlanCreditsBySubject Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (creditTypeDescriptor.IsSet && creditTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(creditTypeDescriptor), "Property is not nullable for class EdFiGraduationPlanCreditsBySubject.");

            if (creditConversion.IsSet && creditConversion.Value == null)
                throw new ArgumentNullException(nameof(creditConversion), "Property is not nullable for class EdFiGraduationPlanCreditsBySubject.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiGraduationPlanCreditsBySubject edFiGraduationPlanCreditsBySubject, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiGraduationPlanCreditsBySubject.CreditTypeDescriptorOption.IsSet && edFiGraduationPlanCreditsBySubject.CreditTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiGraduationPlanCreditsBySubject.CreditTypeDescriptor), "Property is required for class EdFiGraduationPlanCreditsBySubject.");
