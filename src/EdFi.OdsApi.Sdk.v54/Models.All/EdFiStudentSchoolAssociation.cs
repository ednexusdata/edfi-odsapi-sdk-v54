...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public class EdFiStudentSchoolAssociationJsonConverter : JsonConverter<EdFiStudentSchoolAssociation>
    {
        ...
        public override EdFiStudentSchoolAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (employedWhileEnrolled.IsSet && employedWhileEnrolled.Value == null)
                throw new ArgumentNullException(nameof(employedWhileEnrolled), "Property is not nullable for class EdFiStudentSchoolAssociation.");

            if (entryGradeLevelReasonDescriptor.IsSet && entryGradeLevelReasonDescriptor.Value == null)
                throw new ArgumentNullException(nameof(entryGradeLevelReasonDescriptor), "Property is not nullable for class EdFiStudentSchoolAssociation.");

            if (entryTypeDescriptor.IsSet && entryTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(entryTypeDescriptor), "Property is not nullable for class EdFiStudentSchoolAssociation.");

            if (exitWithdrawDate.IsSet && exitWithdrawDate.Value == null)
                throw new ArgumentNullException(nameof(exitWithdrawDate), "Property is not nullable for class EdFiStudentSchoolAssociation.");

            if (exitWithdrawTypeDescriptor.IsSet && exitWithdrawTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(exitWithdrawTypeDescriptor), "Property is not nullable for class EdFiStudentSchoolAssociation.");

            if (fullTimeEquivalency.IsSet && fullTimeEquivalency.Value == null)
                throw new ArgumentNullException(nameof(fullTimeEquivalency), "Property is not nullable for class EdFiStudentSchoolAssociation.");

            if (primarySchool.IsSet && primarySchool.Value == null)
                throw new ArgumentNullException(nameof(primarySchool), "Property is not nullable for class EdFiStudentSchoolAssociation.");

            if (repeatGradeIndicator.IsSet && repeatGradeIndicator.Value == null)
                throw new ArgumentNullException(nameof(repeatGradeIndicator), "Property is not nullable for class EdFiStudentSchoolAssociation.");

            if (residencyStatusDescriptor.IsSet && residencyStatusDescriptor.Value == null)
                throw new ArgumentNullException(nameof(residencyStatusDescriptor), "Property is not nullable for class EdFiStudentSchoolAssociation.");

            if (schoolChoiceTransfer.IsSet && schoolChoiceTransfer.Value == null)
                throw new ArgumentNullException(nameof(schoolChoiceTransfer), "Property is not nullable for class EdFiStudentSchoolAssociation.");

            if (termCompletionIndicator.IsSet && termCompletionIndicator.Value == null)
                throw new ArgumentNullException(nameof(termCompletionIndicator), "Property is not nullable for class EdFiStudentSchoolAssociation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentSchoolAssociation edFiStudentSchoolAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentSchoolAssociation.EntryGradeLevelReasonDescriptorOption.IsSet && edFiStudentSchoolAssociation.EntryGradeLevelReasonDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentSchoolAssociation.EntryGradeLevelReasonDescriptor), "Property is required for class EdFiStudentSchoolAssociation.");

            if (edFiStudentSchoolAssociation.EntryTypeDescriptorOption.IsSet && edFiStudentSchoolAssociation.EntryTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentSchoolAssociation.EntryTypeDescriptor), "Property is required for class EdFiStudentSchoolAssociation.");

            if (edFiStudentSchoolAssociation.ExitWithdrawTypeDescriptorOption.IsSet && edFiStudentSchoolAssociation.ExitWithdrawTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentSchoolAssociation.ExitWithdrawTypeDescriptor), "Property is required for class EdFiStudentSchoolAssociation.");

            if (edFiStudentSchoolAssociation.ResidencyStatusDescriptorOption.IsSet && edFiStudentSchoolAssociation.ResidencyStatusDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentSchoolAssociation.ResidencyStatusDescriptor), "Property is required for class EdFiStudentSchoolAssociation.");
