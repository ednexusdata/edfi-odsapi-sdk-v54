    ...
    public class EdFiParentOtherNameJsonConverter : JsonConverter<EdFiParentOtherName>
    {
        ...
        public override EdFiParentOtherName Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (generationCodeSuffix.IsSet && generationCodeSuffix.Value == null)
                throw new ArgumentNullException(nameof(generationCodeSuffix), "Property is not nullable for class EdFiParentOtherName.");

            if (middleName.IsSet && middleName.Value == null)
                throw new ArgumentNullException(nameof(middleName), "Property is not nullable for class EdFiParentOtherName.");

            if (personalTitlePrefix.IsSet && personalTitlePrefix.Value == null)
                throw new ArgumentNullException(nameof(personalTitlePrefix), "Property is not nullable for class EdFiParentOtherName.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiParentOtherName edFiParentOtherName, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiParentOtherName.GenerationCodeSuffixOption.IsSet && edFiParentOtherName.GenerationCodeSuffix == null)
                throw new ArgumentNullException(nameof(edFiParentOtherName.GenerationCodeSuffix), "Property is required for class EdFiParentOtherName.");

            if (edFiParentOtherName.MiddleNameOption.IsSet && edFiParentOtherName.MiddleName == null)
                throw new ArgumentNullException(nameof(edFiParentOtherName.MiddleName), "Property is required for class EdFiParentOtherName.");

            if (edFiParentOtherName.PersonalTitlePrefixOption.IsSet && edFiParentOtherName.PersonalTitlePrefix == null)
                throw new ArgumentNullException(nameof(edFiParentOtherName.PersonalTitlePrefix), "Property is required for class EdFiParentOtherName.");
