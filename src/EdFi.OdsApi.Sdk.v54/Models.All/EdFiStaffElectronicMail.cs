    ...
    public class EdFiStaffElectronicMailJsonConverter : JsonConverter<EdFiStaffElectronicMail>
    {
        ...
        public override EdFiStaffElectronicMail Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (doNotPublishIndicator.IsSet && doNotPublishIndicator.Value == null)
                throw new ArgumentNullException(nameof(doNotPublishIndicator), "Property is not nullable for class EdFiStaffElectronicMail.");

            if (primaryEmailAddressIndicator.IsSet && primaryEmailAddressIndicator.Value == null)
                throw new ArgumentNullException(nameof(primaryEmailAddressIndicator), "Property is not nullable for class EdFiStaffElectronicMail.");
