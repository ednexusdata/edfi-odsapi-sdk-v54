...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public class EdFiAccountabilityRatingJsonConverter : JsonConverter<EdFiAccountabilityRating>
    {
        ...
        public override EdFiAccountabilityRating Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (ratingDate.IsSet && ratingDate.Value == null)
                throw new ArgumentNullException(nameof(ratingDate), "Property is not nullable for class EdFiAccountabilityRating.");

            if (ratingOrganization.IsSet && ratingOrganization.Value == null)
                throw new ArgumentNullException(nameof(ratingOrganization), "Property is not nullable for class EdFiAccountabilityRating.");

            if (ratingProgram.IsSet && ratingProgram.Value == null)
                throw new ArgumentNullException(nameof(ratingProgram), "Property is not nullable for class EdFiAccountabilityRating.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiAccountabilityRating edFiAccountabilityRating, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiAccountabilityRating.RatingOrganizationOption.IsSet && edFiAccountabilityRating.RatingOrganization == null)
                throw new ArgumentNullException(nameof(edFiAccountabilityRating.RatingOrganization), "Property is required for class EdFiAccountabilityRating.");

            if (edFiAccountabilityRating.RatingProgramOption.IsSet && edFiAccountabilityRating.RatingProgram == null)
                throw new ArgumentNullException(nameof(edFiAccountabilityRating.RatingProgram), "Property is required for class EdFiAccountabilityRating.");
