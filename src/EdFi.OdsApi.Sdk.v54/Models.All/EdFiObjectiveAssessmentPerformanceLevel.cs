...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiObjectiveAssessmentPerformanceLevel : IValidatableObject
    {
        ...
        public EdFiObjectiveAssessmentPerformanceLevel(string assessmentReportingMethodDescriptor = default, string performanceLevelDescriptor = default, string resultDatatypeTypeDescriptor = default, string maximumScore = default, string minimumScore = default, Object ext = default)
        {
