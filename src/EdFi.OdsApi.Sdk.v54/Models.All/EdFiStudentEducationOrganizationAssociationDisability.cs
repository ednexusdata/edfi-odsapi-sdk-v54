    ...
    public class EdFiStudentEducationOrganizationAssociationDisabilityJsonConverter : JsonConverter<EdFiStudentEducationOrganizationAssociationDisability>
    {
        ...
        public override EdFiStudentEducationOrganizationAssociationDisability Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (disabilityDeterminationSourceTypeDescriptor.IsSet && disabilityDeterminationSourceTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(disabilityDeterminationSourceTypeDescriptor), "Property is not nullable for class EdFiStudentEducationOrganizationAssociationDisability.");

            if (disabilityDiagnosis.IsSet && disabilityDiagnosis.Value == null)
                throw new ArgumentNullException(nameof(disabilityDiagnosis), "Property is not nullable for class EdFiStudentEducationOrganizationAssociationDisability.");

            if (orderOfDisability.IsSet && orderOfDisability.Value == null)
                throw new ArgumentNullException(nameof(orderOfDisability), "Property is not nullable for class EdFiStudentEducationOrganizationAssociationDisability.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentEducationOrganizationAssociationDisability edFiStudentEducationOrganizationAssociationDisability, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentEducationOrganizationAssociationDisability.DisabilityDeterminationSourceTypeDescriptorOption.IsSet && edFiStudentEducationOrganizationAssociationDisability.DisabilityDeterminationSourceTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentEducationOrganizationAssociationDisability.DisabilityDeterminationSourceTypeDescriptor), "Property is required for class EdFiStudentEducationOrganizationAssociationDisability.");

            if (edFiStudentEducationOrganizationAssociationDisability.DisabilityDiagnosisOption.IsSet && edFiStudentEducationOrganizationAssociationDisability.DisabilityDiagnosis == null)
                throw new ArgumentNullException(nameof(edFiStudentEducationOrganizationAssociationDisability.DisabilityDiagnosis), "Property is required for class EdFiStudentEducationOrganizationAssociationDisability.");
