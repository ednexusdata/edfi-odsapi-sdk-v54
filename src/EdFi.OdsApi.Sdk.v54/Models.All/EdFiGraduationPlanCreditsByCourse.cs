...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public class EdFiGraduationPlanCreditsByCourseJsonConverter : JsonConverter<EdFiGraduationPlanCreditsByCourse>
    {
        ...
        public override EdFiGraduationPlanCreditsByCourse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (creditTypeDescriptor.IsSet && creditTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(creditTypeDescriptor), "Property is not nullable for class EdFiGraduationPlanCreditsByCourse.");

            if (whenTakenGradeLevelDescriptor.IsSet && whenTakenGradeLevelDescriptor.Value == null)
                throw new ArgumentNullException(nameof(whenTakenGradeLevelDescriptor), "Property is not nullable for class EdFiGraduationPlanCreditsByCourse.");

            if (creditConversion.IsSet && creditConversion.Value == null)
                throw new ArgumentNullException(nameof(creditConversion), "Property is not nullable for class EdFiGraduationPlanCreditsByCourse.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiGraduationPlanCreditsByCourse edFiGraduationPlanCreditsByCourse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiGraduationPlanCreditsByCourse.CreditTypeDescriptorOption.IsSet && edFiGraduationPlanCreditsByCourse.CreditTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiGraduationPlanCreditsByCourse.CreditTypeDescriptor), "Property is required for class EdFiGraduationPlanCreditsByCourse.");

            if (edFiGraduationPlanCreditsByCourse.WhenTakenGradeLevelDescriptorOption.IsSet && edFiGraduationPlanCreditsByCourse.WhenTakenGradeLevelDescriptor == null)
                throw new ArgumentNullException(nameof(edFiGraduationPlanCreditsByCourse.WhenTakenGradeLevelDescriptor), "Property is required for class EdFiGraduationPlanCreditsByCourse.");
