    ...
    public class EdFiStudentNeglectedOrDelinquentProgramAssociationJsonConverter : JsonConverter<EdFiStudentNeglectedOrDelinquentProgramAssociation>
    {
        ...
        public override EdFiStudentNeglectedOrDelinquentProgramAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (elaProgressLevelDescriptor.IsSet && elaProgressLevelDescriptor.Value == null)
                throw new ArgumentNullException(nameof(elaProgressLevelDescriptor), "Property is not nullable for class EdFiStudentNeglectedOrDelinquentProgramAssociation.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class EdFiStudentNeglectedOrDelinquentProgramAssociation.");

            if (mathematicsProgressLevelDescriptor.IsSet && mathematicsProgressLevelDescriptor.Value == null)
                throw new ArgumentNullException(nameof(mathematicsProgressLevelDescriptor), "Property is not nullable for class EdFiStudentNeglectedOrDelinquentProgramAssociation.");

            if (neglectedOrDelinquentProgramDescriptor.IsSet && neglectedOrDelinquentProgramDescriptor.Value == null)
                throw new ArgumentNullException(nameof(neglectedOrDelinquentProgramDescriptor), "Property is not nullable for class EdFiStudentNeglectedOrDelinquentProgramAssociation.");
            ...
            if (reasonExitedDescriptor.IsSet && reasonExitedDescriptor.Value == null)
                throw new ArgumentNullException(nameof(reasonExitedDescriptor), "Property is not nullable for class EdFiStudentNeglectedOrDelinquentProgramAssociation.");

            if (servedOutsideOfRegularSession.IsSet && servedOutsideOfRegularSession.Value == null)
                throw new ArgumentNullException(nameof(servedOutsideOfRegularSession), "Property is not nullable for class EdFiStudentNeglectedOrDelinquentProgramAssociation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentNeglectedOrDelinquentProgramAssociation edFiStudentNeglectedOrDelinquentProgramAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentNeglectedOrDelinquentProgramAssociation.ElaProgressLevelDescriptorOption.IsSet && edFiStudentNeglectedOrDelinquentProgramAssociation.ElaProgressLevelDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentNeglectedOrDelinquentProgramAssociation.ElaProgressLevelDescriptor), "Property is required for class EdFiStudentNeglectedOrDelinquentProgramAssociation.");

            if (edFiStudentNeglectedOrDelinquentProgramAssociation.MathematicsProgressLevelDescriptorOption.IsSet && edFiStudentNeglectedOrDelinquentProgramAssociation.MathematicsProgressLevelDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentNeglectedOrDelinquentProgramAssociation.MathematicsProgressLevelDescriptor), "Property is required for class EdFiStudentNeglectedOrDelinquentProgramAssociation.");

            if (edFiStudentNeglectedOrDelinquentProgramAssociation.NeglectedOrDelinquentProgramDescriptorOption.IsSet && edFiStudentNeglectedOrDelinquentProgramAssociation.NeglectedOrDelinquentProgramDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentNeglectedOrDelinquentProgramAssociation.NeglectedOrDelinquentProgramDescriptor), "Property is required for class EdFiStudentNeglectedOrDelinquentProgramAssociation.");
            ...
            if (edFiStudentNeglectedOrDelinquentProgramAssociation.ReasonExitedDescriptorOption.IsSet && edFiStudentNeglectedOrDelinquentProgramAssociation.ReasonExitedDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentNeglectedOrDelinquentProgramAssociation.ReasonExitedDescriptor), "Property is required for class EdFiStudentNeglectedOrDelinquentProgramAssociation.");
