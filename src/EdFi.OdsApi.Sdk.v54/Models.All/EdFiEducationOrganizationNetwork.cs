    ...
    public class EdFiEducationOrganizationNetworkJsonConverter : JsonConverter<EdFiEducationOrganizationNetwork>
    {
        ...
        public override EdFiEducationOrganizationNetwork Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (operationalStatusDescriptor.IsSet && operationalStatusDescriptor.Value == null)
                throw new ArgumentNullException(nameof(operationalStatusDescriptor), "Property is not nullable for class EdFiEducationOrganizationNetwork.");

            if (shortNameOfInstitution.IsSet && shortNameOfInstitution.Value == null)
                throw new ArgumentNullException(nameof(shortNameOfInstitution), "Property is not nullable for class EdFiEducationOrganizationNetwork.");

            if (webSite.IsSet && webSite.Value == null)
                throw new ArgumentNullException(nameof(webSite), "Property is not nullable for class EdFiEducationOrganizationNetwork.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiEducationOrganizationNetwork edFiEducationOrganizationNetwork, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiEducationOrganizationNetwork.OperationalStatusDescriptorOption.IsSet && edFiEducationOrganizationNetwork.OperationalStatusDescriptor == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationNetwork.OperationalStatusDescriptor), "Property is required for class EdFiEducationOrganizationNetwork.");

            if (edFiEducationOrganizationNetwork.ShortNameOfInstitutionOption.IsSet && edFiEducationOrganizationNetwork.ShortNameOfInstitution == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationNetwork.ShortNameOfInstitution), "Property is required for class EdFiEducationOrganizationNetwork.");

            if (edFiEducationOrganizationNetwork.WebSiteOption.IsSet && edFiEducationOrganizationNetwork.WebSite == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationNetwork.WebSite), "Property is required for class EdFiEducationOrganizationNetwork.");
