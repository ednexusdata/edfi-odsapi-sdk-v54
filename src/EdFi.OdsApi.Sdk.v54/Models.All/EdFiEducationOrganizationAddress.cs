    ...
    public class EdFiEducationOrganizationAddressJsonConverter : JsonConverter<EdFiEducationOrganizationAddress>
    {
        ...
        public override EdFiEducationOrganizationAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (localeDescriptor.IsSet && localeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(localeDescriptor), "Property is not nullable for class EdFiEducationOrganizationAddress.");

            if (apartmentRoomSuiteNumber.IsSet && apartmentRoomSuiteNumber.Value == null)
                throw new ArgumentNullException(nameof(apartmentRoomSuiteNumber), "Property is not nullable for class EdFiEducationOrganizationAddress.");

            if (buildingSiteNumber.IsSet && buildingSiteNumber.Value == null)
                throw new ArgumentNullException(nameof(buildingSiteNumber), "Property is not nullable for class EdFiEducationOrganizationAddress.");

            if (congressionalDistrict.IsSet && congressionalDistrict.Value == null)
                throw new ArgumentNullException(nameof(congressionalDistrict), "Property is not nullable for class EdFiEducationOrganizationAddress.");

            if (countyFIPSCode.IsSet && countyFIPSCode.Value == null)
                throw new ArgumentNullException(nameof(countyFIPSCode), "Property is not nullable for class EdFiEducationOrganizationAddress.");

            if (doNotPublishIndicator.IsSet && doNotPublishIndicator.Value == null)
                throw new ArgumentNullException(nameof(doNotPublishIndicator), "Property is not nullable for class EdFiEducationOrganizationAddress.");

            if (latitude.IsSet && latitude.Value == null)
                throw new ArgumentNullException(nameof(latitude), "Property is not nullable for class EdFiEducationOrganizationAddress.");

            if (longitude.IsSet && longitude.Value == null)
                throw new ArgumentNullException(nameof(longitude), "Property is not nullable for class EdFiEducationOrganizationAddress.");

            if (nameOfCounty.IsSet && nameOfCounty.Value == null)
                throw new ArgumentNullException(nameof(nameOfCounty), "Property is not nullable for class EdFiEducationOrganizationAddress.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiEducationOrganizationAddress edFiEducationOrganizationAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiEducationOrganizationAddress.LocaleDescriptorOption.IsSet && edFiEducationOrganizationAddress.LocaleDescriptor == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationAddress.LocaleDescriptor), "Property is required for class EdFiEducationOrganizationAddress.");

            if (edFiEducationOrganizationAddress.ApartmentRoomSuiteNumberOption.IsSet && edFiEducationOrganizationAddress.ApartmentRoomSuiteNumber == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationAddress.ApartmentRoomSuiteNumber), "Property is required for class EdFiEducationOrganizationAddress.");

            if (edFiEducationOrganizationAddress.BuildingSiteNumberOption.IsSet && edFiEducationOrganizationAddress.BuildingSiteNumber == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationAddress.BuildingSiteNumber), "Property is required for class EdFiEducationOrganizationAddress.");

            if (edFiEducationOrganizationAddress.CongressionalDistrictOption.IsSet && edFiEducationOrganizationAddress.CongressionalDistrict == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationAddress.CongressionalDistrict), "Property is required for class EdFiEducationOrganizationAddress.");

            if (edFiEducationOrganizationAddress.CountyFIPSCodeOption.IsSet && edFiEducationOrganizationAddress.CountyFIPSCode == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationAddress.CountyFIPSCode), "Property is required for class EdFiEducationOrganizationAddress.");

            if (edFiEducationOrganizationAddress.LatitudeOption.IsSet && edFiEducationOrganizationAddress.Latitude == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationAddress.Latitude), "Property is required for class EdFiEducationOrganizationAddress.");

            if (edFiEducationOrganizationAddress.LongitudeOption.IsSet && edFiEducationOrganizationAddress.Longitude == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationAddress.Longitude), "Property is required for class EdFiEducationOrganizationAddress.");

            if (edFiEducationOrganizationAddress.NameOfCountyOption.IsSet && edFiEducationOrganizationAddress.NameOfCounty == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationAddress.NameOfCounty), "Property is required for class EdFiEducationOrganizationAddress.");
