    ...
    public class EdFiStaffPersonalIdentificationDocumentJsonConverter : JsonConverter<EdFiStaffPersonalIdentificationDocument>
    {
        ...
        public override EdFiStaffPersonalIdentificationDocument Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (issuerCountryDescriptor.IsSet && issuerCountryDescriptor.Value == null)
                throw new ArgumentNullException(nameof(issuerCountryDescriptor), "Property is not nullable for class EdFiStaffPersonalIdentificationDocument.");

            if (documentExpirationDate.IsSet && documentExpirationDate.Value == null)
                throw new ArgumentNullException(nameof(documentExpirationDate), "Property is not nullable for class EdFiStaffPersonalIdentificationDocument.");

            if (documentTitle.IsSet && documentTitle.Value == null)
                throw new ArgumentNullException(nameof(documentTitle), "Property is not nullable for class EdFiStaffPersonalIdentificationDocument.");

            if (issuerDocumentIdentificationCode.IsSet && issuerDocumentIdentificationCode.Value == null)
                throw new ArgumentNullException(nameof(issuerDocumentIdentificationCode), "Property is not nullable for class EdFiStaffPersonalIdentificationDocument.");

            if (issuerName.IsSet && issuerName.Value == null)
                throw new ArgumentNullException(nameof(issuerName), "Property is not nullable for class EdFiStaffPersonalIdentificationDocument.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStaffPersonalIdentificationDocument edFiStaffPersonalIdentificationDocument, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStaffPersonalIdentificationDocument.IssuerCountryDescriptorOption.IsSet && edFiStaffPersonalIdentificationDocument.IssuerCountryDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaffPersonalIdentificationDocument.IssuerCountryDescriptor), "Property is required for class EdFiStaffPersonalIdentificationDocument.");

            if (edFiStaffPersonalIdentificationDocument.DocumentTitleOption.IsSet && edFiStaffPersonalIdentificationDocument.DocumentTitle == null)
                throw new ArgumentNullException(nameof(edFiStaffPersonalIdentificationDocument.DocumentTitle), "Property is required for class EdFiStaffPersonalIdentificationDocument.");

            if (edFiStaffPersonalIdentificationDocument.IssuerDocumentIdentificationCodeOption.IsSet && edFiStaffPersonalIdentificationDocument.IssuerDocumentIdentificationCode == null)
                throw new ArgumentNullException(nameof(edFiStaffPersonalIdentificationDocument.IssuerDocumentIdentificationCode), "Property is required for class EdFiStaffPersonalIdentificationDocument.");

            if (edFiStaffPersonalIdentificationDocument.IssuerNameOption.IsSet && edFiStaffPersonalIdentificationDocument.IssuerName == null)
                throw new ArgumentNullException(nameof(edFiStaffPersonalIdentificationDocument.IssuerName), "Property is required for class EdFiStaffPersonalIdentificationDocument.");
