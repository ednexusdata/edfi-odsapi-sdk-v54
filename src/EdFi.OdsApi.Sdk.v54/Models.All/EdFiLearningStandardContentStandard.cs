    ...
    public class EdFiLearningStandardContentStandardJsonConverter : JsonConverter<EdFiLearningStandardContentStandard>
    {
        ...
        public override EdFiLearningStandardContentStandard Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (publicationStatusDescriptor.IsSet && publicationStatusDescriptor.Value == null)
                throw new ArgumentNullException(nameof(publicationStatusDescriptor), "Property is not nullable for class EdFiLearningStandardContentStandard.");

            if (beginDate.IsSet && beginDate.Value == null)
                throw new ArgumentNullException(nameof(beginDate), "Property is not nullable for class EdFiLearningStandardContentStandard.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class EdFiLearningStandardContentStandard.");

            if (publicationDate.IsSet && publicationDate.Value == null)
                throw new ArgumentNullException(nameof(publicationDate), "Property is not nullable for class EdFiLearningStandardContentStandard.");

            if (publicationYear.IsSet && publicationYear.Value == null)
                throw new ArgumentNullException(nameof(publicationYear), "Property is not nullable for class EdFiLearningStandardContentStandard.");

            if (uri.IsSet && uri.Value == null)
                throw new ArgumentNullException(nameof(uri), "Property is not nullable for class EdFiLearningStandardContentStandard.");

            if (varVersion.IsSet && varVersion.Value == null)
                throw new ArgumentNullException(nameof(varVersion), "Property is not nullable for class EdFiLearningStandardContentStandard.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiLearningStandardContentStandard edFiLearningStandardContentStandard, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiLearningStandardContentStandard.PublicationStatusDescriptorOption.IsSet && edFiLearningStandardContentStandard.PublicationStatusDescriptor == null)
                throw new ArgumentNullException(nameof(edFiLearningStandardContentStandard.PublicationStatusDescriptor), "Property is required for class EdFiLearningStandardContentStandard.");

            if (edFiLearningStandardContentStandard.UriOption.IsSet && edFiLearningStandardContentStandard.Uri == null)
                throw new ArgumentNullException(nameof(edFiLearningStandardContentStandard.Uri), "Property is required for class EdFiLearningStandardContentStandard.");

            if (edFiLearningStandardContentStandard.VarVersionOption.IsSet && edFiLearningStandardContentStandard.VarVersion == null)
                throw new ArgumentNullException(nameof(edFiLearningStandardContentStandard.VarVersion), "Property is required for class EdFiLearningStandardContentStandard.");
