...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiCommunityOrganization : IValidatableObject
    {
        ...
        /// <param name="communityOrganizationId">The identifier assigned to a CommunityOrganization.</param>
    ...
    public class EdFiCommunityOrganizationJsonConverter : JsonConverter<EdFiCommunityOrganization>
    {
        ...
        public override EdFiCommunityOrganization Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (operationalStatusDescriptor.IsSet && operationalStatusDescriptor.Value == null)
                throw new ArgumentNullException(nameof(operationalStatusDescriptor), "Property is not nullable for class EdFiCommunityOrganization.");

            if (shortNameOfInstitution.IsSet && shortNameOfInstitution.Value == null)
                throw new ArgumentNullException(nameof(shortNameOfInstitution), "Property is not nullable for class EdFiCommunityOrganization.");

            if (webSite.IsSet && webSite.Value == null)
                throw new ArgumentNullException(nameof(webSite), "Property is not nullable for class EdFiCommunityOrganization.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiCommunityOrganization edFiCommunityOrganization, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiCommunityOrganization.OperationalStatusDescriptorOption.IsSet && edFiCommunityOrganization.OperationalStatusDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCommunityOrganization.OperationalStatusDescriptor), "Property is required for class EdFiCommunityOrganization.");

            if (edFiCommunityOrganization.ShortNameOfInstitutionOption.IsSet && edFiCommunityOrganization.ShortNameOfInstitution == null)
                throw new ArgumentNullException(nameof(edFiCommunityOrganization.ShortNameOfInstitution), "Property is required for class EdFiCommunityOrganization.");

            if (edFiCommunityOrganization.WebSiteOption.IsSet && edFiCommunityOrganization.WebSite == null)
                throw new ArgumentNullException(nameof(edFiCommunityOrganization.WebSite), "Property is required for class EdFiCommunityOrganization.");
