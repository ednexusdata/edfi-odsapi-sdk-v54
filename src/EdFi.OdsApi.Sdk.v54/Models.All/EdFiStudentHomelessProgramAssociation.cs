...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public class EdFiStudentHomelessProgramAssociationJsonConverter : JsonConverter<EdFiStudentHomelessProgramAssociation>
    {
        ...
        public override EdFiStudentHomelessProgramAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (awaitingFosterCare.IsSet && awaitingFosterCare.Value == null)
                throw new ArgumentNullException(nameof(awaitingFosterCare), "Property is not nullable for class EdFiStudentHomelessProgramAssociation.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class EdFiStudentHomelessProgramAssociation.");

            if (homelessPrimaryNighttimeResidenceDescriptor.IsSet && homelessPrimaryNighttimeResidenceDescriptor.Value == null)
                throw new ArgumentNullException(nameof(homelessPrimaryNighttimeResidenceDescriptor), "Property is not nullable for class EdFiStudentHomelessProgramAssociation.");
            ...
            if (homelessUnaccompaniedYouth.IsSet && homelessUnaccompaniedYouth.Value == null)
                throw new ArgumentNullException(nameof(homelessUnaccompaniedYouth), "Property is not nullable for class EdFiStudentHomelessProgramAssociation.");
            ...
            if (reasonExitedDescriptor.IsSet && reasonExitedDescriptor.Value == null)
                throw new ArgumentNullException(nameof(reasonExitedDescriptor), "Property is not nullable for class EdFiStudentHomelessProgramAssociation.");

            if (servedOutsideOfRegularSession.IsSet && servedOutsideOfRegularSession.Value == null)
                throw new ArgumentNullException(nameof(servedOutsideOfRegularSession), "Property is not nullable for class EdFiStudentHomelessProgramAssociation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentHomelessProgramAssociation edFiStudentHomelessProgramAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentHomelessProgramAssociation.HomelessPrimaryNighttimeResidenceDescriptorOption.IsSet && edFiStudentHomelessProgramAssociation.HomelessPrimaryNighttimeResidenceDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentHomelessProgramAssociation.HomelessPrimaryNighttimeResidenceDescriptor), "Property is required for class EdFiStudentHomelessProgramAssociation.");
            ...
            if (edFiStudentHomelessProgramAssociation.ReasonExitedDescriptorOption.IsSet && edFiStudentHomelessProgramAssociation.ReasonExitedDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentHomelessProgramAssociation.ReasonExitedDescriptor), "Property is required for class EdFiStudentHomelessProgramAssociation.");
