...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public class EdFiCourseOfferingJsonConverter : JsonConverter<EdFiCourseOffering>
    {
        ...
        public override EdFiCourseOffering Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (instructionalTimePlanned.IsSet && instructionalTimePlanned.Value == null)
                throw new ArgumentNullException(nameof(instructionalTimePlanned), "Property is not nullable for class EdFiCourseOffering.");

            if (localCourseTitle.IsSet && localCourseTitle.Value == null)
                throw new ArgumentNullException(nameof(localCourseTitle), "Property is not nullable for class EdFiCourseOffering.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiCourseOffering edFiCourseOffering, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiCourseOffering.LocalCourseTitleOption.IsSet && edFiCourseOffering.LocalCourseTitle == null)
                throw new ArgumentNullException(nameof(edFiCourseOffering.LocalCourseTitle), "Property is required for class EdFiCourseOffering.");
