...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiStudentAssessmentPerformanceLevel : IValidatableObject
    {
        ...
        public EdFiStudentAssessmentPerformanceLevel(string assessmentReportingMethodDescriptor = default, string performanceLevelDescriptor = default, bool performanceLevelMet = default, Object ext = default)
        {
