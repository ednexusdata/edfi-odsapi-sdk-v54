    ...
    public class EdFiDisciplineIncidentJsonConverter : JsonConverter<EdFiDisciplineIncident>
    {
        ...
        public override EdFiDisciplineIncident Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (caseNumber.IsSet && caseNumber.Value == null)
                throw new ArgumentNullException(nameof(caseNumber), "Property is not nullable for class EdFiDisciplineIncident.");
            ...
            if (incidentCost.IsSet && incidentCost.Value == null)
                throw new ArgumentNullException(nameof(incidentCost), "Property is not nullable for class EdFiDisciplineIncident.");

            if (incidentDescription.IsSet && incidentDescription.Value == null)
                throw new ArgumentNullException(nameof(incidentDescription), "Property is not nullable for class EdFiDisciplineIncident.");

            if (incidentLocationDescriptor.IsSet && incidentLocationDescriptor.Value == null)
                throw new ArgumentNullException(nameof(incidentLocationDescriptor), "Property is not nullable for class EdFiDisciplineIncident.");

            if (incidentTime.IsSet && incidentTime.Value == null)
                throw new ArgumentNullException(nameof(incidentTime), "Property is not nullable for class EdFiDisciplineIncident.");

            if (reportedToLawEnforcement.IsSet && reportedToLawEnforcement.Value == null)
                throw new ArgumentNullException(nameof(reportedToLawEnforcement), "Property is not nullable for class EdFiDisciplineIncident.");

            if (reporterDescriptionDescriptor.IsSet && reporterDescriptionDescriptor.Value == null)
                throw new ArgumentNullException(nameof(reporterDescriptionDescriptor), "Property is not nullable for class EdFiDisciplineIncident.");

            if (reporterName.IsSet && reporterName.Value == null)
                throw new ArgumentNullException(nameof(reporterName), "Property is not nullable for class EdFiDisciplineIncident.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiDisciplineIncident edFiDisciplineIncident, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiDisciplineIncident.CaseNumberOption.IsSet && edFiDisciplineIncident.CaseNumber == null)
                throw new ArgumentNullException(nameof(edFiDisciplineIncident.CaseNumber), "Property is required for class EdFiDisciplineIncident.");
            ...
            if (edFiDisciplineIncident.IncidentDescriptionOption.IsSet && edFiDisciplineIncident.IncidentDescription == null)
                throw new ArgumentNullException(nameof(edFiDisciplineIncident.IncidentDescription), "Property is required for class EdFiDisciplineIncident.");

            if (edFiDisciplineIncident.IncidentLocationDescriptorOption.IsSet && edFiDisciplineIncident.IncidentLocationDescriptor == null)
                throw new ArgumentNullException(nameof(edFiDisciplineIncident.IncidentLocationDescriptor), "Property is required for class EdFiDisciplineIncident.");

            if (edFiDisciplineIncident.IncidentTimeOption.IsSet && edFiDisciplineIncident.IncidentTime == null)
                throw new ArgumentNullException(nameof(edFiDisciplineIncident.IncidentTime), "Property is required for class EdFiDisciplineIncident.");

            if (edFiDisciplineIncident.ReporterDescriptionDescriptorOption.IsSet && edFiDisciplineIncident.ReporterDescriptionDescriptor == null)
                throw new ArgumentNullException(nameof(edFiDisciplineIncident.ReporterDescriptionDescriptor), "Property is required for class EdFiDisciplineIncident.");

            if (edFiDisciplineIncident.ReporterNameOption.IsSet && edFiDisciplineIncident.ReporterName == null)
                throw new ArgumentNullException(nameof(edFiDisciplineIncident.ReporterName), "Property is required for class EdFiDisciplineIncident.");
