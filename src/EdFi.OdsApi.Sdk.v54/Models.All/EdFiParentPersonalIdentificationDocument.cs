    ...
    public class EdFiParentPersonalIdentificationDocumentJsonConverter : JsonConverter<EdFiParentPersonalIdentificationDocument>
    {
        ...
        public override EdFiParentPersonalIdentificationDocument Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (issuerCountryDescriptor.IsSet && issuerCountryDescriptor.Value == null)
                throw new ArgumentNullException(nameof(issuerCountryDescriptor), "Property is not nullable for class EdFiParentPersonalIdentificationDocument.");

            if (documentExpirationDate.IsSet && documentExpirationDate.Value == null)
                throw new ArgumentNullException(nameof(documentExpirationDate), "Property is not nullable for class EdFiParentPersonalIdentificationDocument.");

            if (documentTitle.IsSet && documentTitle.Value == null)
                throw new ArgumentNullException(nameof(documentTitle), "Property is not nullable for class EdFiParentPersonalIdentificationDocument.");

            if (issuerDocumentIdentificationCode.IsSet && issuerDocumentIdentificationCode.Value == null)
                throw new ArgumentNullException(nameof(issuerDocumentIdentificationCode), "Property is not nullable for class EdFiParentPersonalIdentificationDocument.");

            if (issuerName.IsSet && issuerName.Value == null)
                throw new ArgumentNullException(nameof(issuerName), "Property is not nullable for class EdFiParentPersonalIdentificationDocument.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiParentPersonalIdentificationDocument edFiParentPersonalIdentificationDocument, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiParentPersonalIdentificationDocument.IssuerCountryDescriptorOption.IsSet && edFiParentPersonalIdentificationDocument.IssuerCountryDescriptor == null)
                throw new ArgumentNullException(nameof(edFiParentPersonalIdentificationDocument.IssuerCountryDescriptor), "Property is required for class EdFiParentPersonalIdentificationDocument.");

            if (edFiParentPersonalIdentificationDocument.DocumentTitleOption.IsSet && edFiParentPersonalIdentificationDocument.DocumentTitle == null)
                throw new ArgumentNullException(nameof(edFiParentPersonalIdentificationDocument.DocumentTitle), "Property is required for class EdFiParentPersonalIdentificationDocument.");

            if (edFiParentPersonalIdentificationDocument.IssuerDocumentIdentificationCodeOption.IsSet && edFiParentPersonalIdentificationDocument.IssuerDocumentIdentificationCode == null)
                throw new ArgumentNullException(nameof(edFiParentPersonalIdentificationDocument.IssuerDocumentIdentificationCode), "Property is required for class EdFiParentPersonalIdentificationDocument.");

            if (edFiParentPersonalIdentificationDocument.IssuerNameOption.IsSet && edFiParentPersonalIdentificationDocument.IssuerName == null)
                throw new ArgumentNullException(nameof(edFiParentPersonalIdentificationDocument.IssuerName), "Property is required for class EdFiParentPersonalIdentificationDocument.");
