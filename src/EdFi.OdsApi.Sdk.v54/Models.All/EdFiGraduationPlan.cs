...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiGraduationPlan : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="graduationPlanTypeDescriptor">The type of academic plan the student is following for graduation: for example, Minimum, Recommended, Distinguished, or Standard.</param>
    ...
    public class EdFiGraduationPlanJsonConverter : JsonConverter<EdFiGraduationPlan>
    {
        ...
        public override EdFiGraduationPlan Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (individualPlan.IsSet && individualPlan.Value == null)
                throw new ArgumentNullException(nameof(individualPlan), "Property is not nullable for class EdFiGraduationPlan.");
            ...
            if (totalRequiredCreditConversion.IsSet && totalRequiredCreditConversion.Value == null)
                throw new ArgumentNullException(nameof(totalRequiredCreditConversion), "Property is not nullable for class EdFiGraduationPlan.");

            if (totalRequiredCreditTypeDescriptor.IsSet && totalRequiredCreditTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(totalRequiredCreditTypeDescriptor), "Property is not nullable for class EdFiGraduationPlan.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiGraduationPlan edFiGraduationPlan, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiGraduationPlan.TotalRequiredCreditTypeDescriptorOption.IsSet && edFiGraduationPlan.TotalRequiredCreditTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiGraduationPlan.TotalRequiredCreditTypeDescriptor), "Property is required for class EdFiGraduationPlan.");
