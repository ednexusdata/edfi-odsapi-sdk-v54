...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiObjectiveAssessment : IValidatableObject
    {
        ...
        public EdFiObjectiveAssessment(string id = default, string identificationCode = default, EdFiAssessmentReference assessmentReference = default, EdFiObjectiveAssessmentReference parentObjectiveAssessmentReference = default, string academicSubjectDescriptor = default, List<EdFiObjectiveAssessmentAssessmentItem> assessmentItems = default, string description = default, List<EdFiObjectiveAssessmentLearningObjective> learningObjectives = default, List<EdFiObjectiveAssessmentLearningStandard> learningStandards = default, double maxRawScore = default, string nomenclature = default, double percentOfAssessment = default, List<EdFiObjectiveAssessmentPerformanceLevel> performanceLevels = default, List<EdFiObjectiveAssessmentScore> scores = default, string etag = default, Object ext = default)
        {
