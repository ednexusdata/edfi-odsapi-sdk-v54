...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiObjectiveAssessment : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiObjectiveAssessment(string identificationCode, EdFiAssessmentReference assessmentReference, Option<string?> id = default, Option<EdFiObjectiveAssessmentReference?> parentObjectiveAssessmentReference = default, Option<string?> academicSubjectDescriptor = default, Option<List<EdFiObjectiveAssessmentAssessmentItem>?> assessmentItems = default, Option<string?> description = default, Option<List<EdFiObjectiveAssessmentLearningObjective>?> learningObjectives = default, Option<List<EdFiObjectiveAssessmentLearningStandard>?> learningStandards = default, Option<double?> maxRawScore = default, Option<string?> nomenclature = default, Option<double?> percentOfAssessment = default, Option<List<EdFiObjectiveAssessmentPerformanceLevel>?> performanceLevels = default, Option<List<EdFiObjectiveAssessmentScore>?> scores = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<EdFiObjectiveAssessmentLearningObjective>?> LearningObjectivesOption { get; private set; }
        ...
        public List<EdFiObjectiveAssessmentLearningObjective>? LearningObjectives { get { return this.LearningObjectivesOption; } set { this.LearningObjectivesOption = new(value); } }
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for Nomenclature, length must be less than 35.", new [] { "Nomenclature" });
            }
    ...
    public class EdFiObjectiveAssessmentJsonConverter : JsonConverter<EdFiObjectiveAssessment>
    {
        ...
        public override EdFiObjectiveAssessment Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<EdFiObjectiveAssessmentLearningObjective>?> learningObjectives = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "learningObjectives":
                            learningObjectives = new Option<List<EdFiObjectiveAssessmentLearningObjective>?>(JsonSerializer.Deserialize<List<EdFiObjectiveAssessmentLearningObjective>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
            ...
            if (academicSubjectDescriptor.IsSet && academicSubjectDescriptor.Value == null)
                throw new ArgumentNullException(nameof(academicSubjectDescriptor), "Property is not nullable for class EdFiObjectiveAssessment.");
            ...
            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class EdFiObjectiveAssessment.");

            if (learningObjectives.IsSet && learningObjectives.Value == null)
                throw new ArgumentNullException(nameof(learningObjectives), "Property is not nullable for class EdFiObjectiveAssessment.");
            ...
            if (maxRawScore.IsSet && maxRawScore.Value == null)
                throw new ArgumentNullException(nameof(maxRawScore), "Property is not nullable for class EdFiObjectiveAssessment.");

            if (nomenclature.IsSet && nomenclature.Value == null)
                throw new ArgumentNullException(nameof(nomenclature), "Property is not nullable for class EdFiObjectiveAssessment.");

            if (percentOfAssessment.IsSet && percentOfAssessment.Value == null)
                throw new ArgumentNullException(nameof(percentOfAssessment), "Property is not nullable for class EdFiObjectiveAssessment.");
            ...
            return new EdFiObjectiveAssessment(identificationCode.Value!, assessmentReference.Value!, id, parentObjectiveAssessmentReference, academicSubjectDescriptor, assessmentItems, description, learningObjectives, learningStandards, maxRawScore, nomenclature, percentOfAssessment, performanceLevels, scores, etag, ext);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiObjectiveAssessment edFiObjectiveAssessment, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiObjectiveAssessment.AcademicSubjectDescriptorOption.IsSet && edFiObjectiveAssessment.AcademicSubjectDescriptor == null)
                throw new ArgumentNullException(nameof(edFiObjectiveAssessment.AcademicSubjectDescriptor), "Property is required for class EdFiObjectiveAssessment.");
            ...
            if (edFiObjectiveAssessment.DescriptionOption.IsSet && edFiObjectiveAssessment.Description == null)
                throw new ArgumentNullException(nameof(edFiObjectiveAssessment.Description), "Property is required for class EdFiObjectiveAssessment.");

            if (edFiObjectiveAssessment.LearningObjectivesOption.IsSet && edFiObjectiveAssessment.LearningObjectives == null)
                throw new ArgumentNullException(nameof(edFiObjectiveAssessment.LearningObjectives), "Property is required for class EdFiObjectiveAssessment.");
            ...
            if (edFiObjectiveAssessment.NomenclatureOption.IsSet && edFiObjectiveAssessment.Nomenclature == null)
                throw new ArgumentNullException(nameof(edFiObjectiveAssessment.Nomenclature), "Property is required for class EdFiObjectiveAssessment.");
            ...
            if (edFiObjectiveAssessment.LearningObjectivesOption.IsSet)
            {
                writer.WritePropertyName("learningObjectives");
                JsonSerializer.Serialize(writer, edFiObjectiveAssessment.LearningObjectives, jsonSerializerOptions);
            }
