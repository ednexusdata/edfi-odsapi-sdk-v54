...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiStaffEducationOrganizationContactAssociation : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="contactTitle">The title of the contact in the context of the EducationOrganization.</param>
        ...
        /// <param name="electronicMailAddress">The email for the contact associated with the EducationOrganization.</param>
    ...
    public class EdFiStaffEducationOrganizationContactAssociationJsonConverter : JsonConverter<EdFiStaffEducationOrganizationContactAssociation>
    {
        ...
        public override EdFiStaffEducationOrganizationContactAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (contactTypeDescriptor.IsSet && contactTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(contactTypeDescriptor), "Property is not nullable for class EdFiStaffEducationOrganizationContactAssociation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStaffEducationOrganizationContactAssociation edFiStaffEducationOrganizationContactAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStaffEducationOrganizationContactAssociation.ContactTypeDescriptorOption.IsSet && edFiStaffEducationOrganizationContactAssociation.ContactTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaffEducationOrganizationContactAssociation.ContactTypeDescriptor), "Property is required for class EdFiStaffEducationOrganizationContactAssociation.");
