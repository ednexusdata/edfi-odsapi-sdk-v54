...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public class EdFiCommunityProviderLicenseJsonConverter : JsonConverter<EdFiCommunityProviderLicense>
    {
        ...
        public override EdFiCommunityProviderLicense Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (authorizedFacilityCapacity.IsSet && authorizedFacilityCapacity.Value == null)
                throw new ArgumentNullException(nameof(authorizedFacilityCapacity), "Property is not nullable for class EdFiCommunityProviderLicense.");

            if (licenseExpirationDate.IsSet && licenseExpirationDate.Value == null)
                throw new ArgumentNullException(nameof(licenseExpirationDate), "Property is not nullable for class EdFiCommunityProviderLicense.");

            if (licenseIssueDate.IsSet && licenseIssueDate.Value == null)
                throw new ArgumentNullException(nameof(licenseIssueDate), "Property is not nullable for class EdFiCommunityProviderLicense.");

            if (licenseStatusDescriptor.IsSet && licenseStatusDescriptor.Value == null)
                throw new ArgumentNullException(nameof(licenseStatusDescriptor), "Property is not nullable for class EdFiCommunityProviderLicense.");

            if (oldestAgeAuthorizedToServe.IsSet && oldestAgeAuthorizedToServe.Value == null)
                throw new ArgumentNullException(nameof(oldestAgeAuthorizedToServe), "Property is not nullable for class EdFiCommunityProviderLicense.");

            if (youngestAgeAuthorizedToServe.IsSet && youngestAgeAuthorizedToServe.Value == null)
                throw new ArgumentNullException(nameof(youngestAgeAuthorizedToServe), "Property is not nullable for class EdFiCommunityProviderLicense.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiCommunityProviderLicense edFiCommunityProviderLicense, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiCommunityProviderLicense.LicenseStatusDescriptorOption.IsSet && edFiCommunityProviderLicense.LicenseStatusDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCommunityProviderLicense.LicenseStatusDescriptor), "Property is required for class EdFiCommunityProviderLicense.");
