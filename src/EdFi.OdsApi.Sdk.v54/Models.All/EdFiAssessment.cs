...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiAssessment : IValidatableObject
    {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<EdFiAssessmentPeriod?> PeriodOption { get; private set; }

        /// <summary>
        /// Gets or Sets Period
        /// </summary>
        [JsonPropertyName("period")]
        public EdFiAssessmentPeriod? Period { get { return this.PeriodOption; } set { this.PeriodOption = new(value); } }
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for AssessmentTitle, length must be less than 100.", new [] { "AssessmentTitle" });
            }
    ...
    public class EdFiAssessmentJsonConverter : JsonConverter<EdFiAssessment>
    {
        ...
        public override EdFiAssessment Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EdFiAssessmentPeriod?> period = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "performanceLevels":
                            ...
                            break;
                        case "period":
                            period = new Option<EdFiAssessmentPeriod?>(JsonSerializer.Deserialize<EdFiAssessmentPeriod>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "platformTypes":
            ...
            if (adaptiveAssessment.IsSet && adaptiveAssessment.Value == null)
                throw new ArgumentNullException(nameof(adaptiveAssessment), "Property is not nullable for class EdFiAssessment.");
            ...
            if (assessmentCategoryDescriptor.IsSet && assessmentCategoryDescriptor.Value == null)
                throw new ArgumentNullException(nameof(assessmentCategoryDescriptor), "Property is not nullable for class EdFiAssessment.");

            if (assessmentFamily.IsSet && assessmentFamily.Value == null)
                throw new ArgumentNullException(nameof(assessmentFamily), "Property is not nullable for class EdFiAssessment.");

            if (assessmentForm.IsSet && assessmentForm.Value == null)
                throw new ArgumentNullException(nameof(assessmentForm), "Property is not nullable for class EdFiAssessment.");

            if (assessmentVersion.IsSet && assessmentVersion.Value == null)
                throw new ArgumentNullException(nameof(assessmentVersion), "Property is not nullable for class EdFiAssessment.");
            ...
            if (maxRawScore.IsSet && maxRawScore.Value == null)
                throw new ArgumentNullException(nameof(maxRawScore), "Property is not nullable for class EdFiAssessment.");

            if (nomenclature.IsSet && nomenclature.Value == null)
                throw new ArgumentNullException(nameof(nomenclature), "Property is not nullable for class EdFiAssessment.");
            ...
            if (period.IsSet && period.Value == null)
                throw new ArgumentNullException(nameof(period), "Property is not nullable for class EdFiAssessment.");
            ...
            if (revisionDate.IsSet && revisionDate.Value == null)
                throw new ArgumentNullException(nameof(revisionDate), "Property is not nullable for class EdFiAssessment.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiAssessment edFiAssessment, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiAssessment.AssessmentCategoryDescriptorOption.IsSet && edFiAssessment.AssessmentCategoryDescriptor == null)
                throw new ArgumentNullException(nameof(edFiAssessment.AssessmentCategoryDescriptor), "Property is required for class EdFiAssessment.");

            if (edFiAssessment.AssessmentFamilyOption.IsSet && edFiAssessment.AssessmentFamily == null)
                throw new ArgumentNullException(nameof(edFiAssessment.AssessmentFamily), "Property is required for class EdFiAssessment.");

            if (edFiAssessment.AssessmentFormOption.IsSet && edFiAssessment.AssessmentForm == null)
                throw new ArgumentNullException(nameof(edFiAssessment.AssessmentForm), "Property is required for class EdFiAssessment.");
            ...
            if (edFiAssessment.NomenclatureOption.IsSet && edFiAssessment.Nomenclature == null)
                throw new ArgumentNullException(nameof(edFiAssessment.Nomenclature), "Property is required for class EdFiAssessment.");
            ...
            if (edFiAssessment.PeriodOption.IsSet && edFiAssessment.Period == null)
                throw new ArgumentNullException(nameof(edFiAssessment.Period), "Property is required for class EdFiAssessment.");
            ...
            if (edFiAssessment.PeriodOption.IsSet)
            {
                writer.WritePropertyName("period");
                JsonSerializer.Serialize(writer, edFiAssessment.Period, jsonSerializerOptions);
            }
