    ...
    public class EdFiAssessmentItemPossibleResponseJsonConverter : JsonConverter<EdFiAssessmentItemPossibleResponse>
    {
        ...
        public override EdFiAssessmentItemPossibleResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (correctResponse.IsSet && correctResponse.Value == null)
                throw new ArgumentNullException(nameof(correctResponse), "Property is not nullable for class EdFiAssessmentItemPossibleResponse.");

            if (responseDescription.IsSet && responseDescription.Value == null)
                throw new ArgumentNullException(nameof(responseDescription), "Property is not nullable for class EdFiAssessmentItemPossibleResponse.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiAssessmentItemPossibleResponse edFiAssessmentItemPossibleResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiAssessmentItemPossibleResponse.ResponseDescriptionOption.IsSet && edFiAssessmentItemPossibleResponse.ResponseDescription == null)
                throw new ArgumentNullException(nameof(edFiAssessmentItemPossibleResponse.ResponseDescription), "Property is required for class EdFiAssessmentItemPossibleResponse.");
