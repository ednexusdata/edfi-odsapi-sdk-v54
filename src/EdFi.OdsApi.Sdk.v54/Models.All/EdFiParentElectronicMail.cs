    ...
    public class EdFiParentElectronicMailJsonConverter : JsonConverter<EdFiParentElectronicMail>
    {
        ...
        public override EdFiParentElectronicMail Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (doNotPublishIndicator.IsSet && doNotPublishIndicator.Value == null)
                throw new ArgumentNullException(nameof(doNotPublishIndicator), "Property is not nullable for class EdFiParentElectronicMail.");

            if (primaryEmailAddressIndicator.IsSet && primaryEmailAddressIndicator.Value == null)
                throw new ArgumentNullException(nameof(primaryEmailAddressIndicator), "Property is not nullable for class EdFiParentElectronicMail.");
