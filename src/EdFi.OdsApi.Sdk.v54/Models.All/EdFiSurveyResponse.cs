    ...
    public class EdFiSurveyResponseJsonConverter : JsonConverter<EdFiSurveyResponse>
    {
        ...
        public override EdFiSurveyResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (electronicMailAddress.IsSet && electronicMailAddress.Value == null)
                throw new ArgumentNullException(nameof(electronicMailAddress), "Property is not nullable for class EdFiSurveyResponse.");

            if (fullName.IsSet && fullName.Value == null)
                throw new ArgumentNullException(nameof(fullName), "Property is not nullable for class EdFiSurveyResponse.");

            if (location.IsSet && location.Value == null)
                throw new ArgumentNullException(nameof(location), "Property is not nullable for class EdFiSurveyResponse.");

            if (responseTime.IsSet && responseTime.Value == null)
                throw new ArgumentNullException(nameof(responseTime), "Property is not nullable for class EdFiSurveyResponse.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiSurveyResponse edFiSurveyResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiSurveyResponse.ElectronicMailAddressOption.IsSet && edFiSurveyResponse.ElectronicMailAddress == null)
                throw new ArgumentNullException(nameof(edFiSurveyResponse.ElectronicMailAddress), "Property is required for class EdFiSurveyResponse.");

            if (edFiSurveyResponse.FullNameOption.IsSet && edFiSurveyResponse.FullName == null)
                throw new ArgumentNullException(nameof(edFiSurveyResponse.FullName), "Property is required for class EdFiSurveyResponse.");

            if (edFiSurveyResponse.LocationOption.IsSet && edFiSurveyResponse.Location == null)
                throw new ArgumentNullException(nameof(edFiSurveyResponse.Location), "Property is required for class EdFiSurveyResponse.");
