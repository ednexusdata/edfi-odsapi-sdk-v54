    ...
    public class EdFiObjectiveAssessmentScoreJsonConverter : JsonConverter<EdFiObjectiveAssessmentScore>
    {
        ...
        public override EdFiObjectiveAssessmentScore Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (resultDatatypeTypeDescriptor.IsSet && resultDatatypeTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(resultDatatypeTypeDescriptor), "Property is not nullable for class EdFiObjectiveAssessmentScore.");

            if (maximumScore.IsSet && maximumScore.Value == null)
                throw new ArgumentNullException(nameof(maximumScore), "Property is not nullable for class EdFiObjectiveAssessmentScore.");

            if (minimumScore.IsSet && minimumScore.Value == null)
                throw new ArgumentNullException(nameof(minimumScore), "Property is not nullable for class EdFiObjectiveAssessmentScore.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiObjectiveAssessmentScore edFiObjectiveAssessmentScore, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiObjectiveAssessmentScore.ResultDatatypeTypeDescriptorOption.IsSet && edFiObjectiveAssessmentScore.ResultDatatypeTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiObjectiveAssessmentScore.ResultDatatypeTypeDescriptor), "Property is required for class EdFiObjectiveAssessmentScore.");

            if (edFiObjectiveAssessmentScore.MaximumScoreOption.IsSet && edFiObjectiveAssessmentScore.MaximumScore == null)
                throw new ArgumentNullException(nameof(edFiObjectiveAssessmentScore.MaximumScore), "Property is required for class EdFiObjectiveAssessmentScore.");

            if (edFiObjectiveAssessmentScore.MinimumScoreOption.IsSet && edFiObjectiveAssessmentScore.MinimumScore == null)
                throw new ArgumentNullException(nameof(edFiObjectiveAssessmentScore.MinimumScore), "Property is required for class EdFiObjectiveAssessmentScore.");
