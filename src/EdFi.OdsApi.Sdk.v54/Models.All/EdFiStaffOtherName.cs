    ...
    public class EdFiStaffOtherNameJsonConverter : JsonConverter<EdFiStaffOtherName>
    {
        ...
        public override EdFiStaffOtherName Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (generationCodeSuffix.IsSet && generationCodeSuffix.Value == null)
                throw new ArgumentNullException(nameof(generationCodeSuffix), "Property is not nullable for class EdFiStaffOtherName.");

            if (middleName.IsSet && middleName.Value == null)
                throw new ArgumentNullException(nameof(middleName), "Property is not nullable for class EdFiStaffOtherName.");

            if (personalTitlePrefix.IsSet && personalTitlePrefix.Value == null)
                throw new ArgumentNullException(nameof(personalTitlePrefix), "Property is not nullable for class EdFiStaffOtherName.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStaffOtherName edFiStaffOtherName, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStaffOtherName.GenerationCodeSuffixOption.IsSet && edFiStaffOtherName.GenerationCodeSuffix == null)
                throw new ArgumentNullException(nameof(edFiStaffOtherName.GenerationCodeSuffix), "Property is required for class EdFiStaffOtherName.");

            if (edFiStaffOtherName.MiddleNameOption.IsSet && edFiStaffOtherName.MiddleName == null)
                throw new ArgumentNullException(nameof(edFiStaffOtherName.MiddleName), "Property is required for class EdFiStaffOtherName.");

            if (edFiStaffOtherName.PersonalTitlePrefixOption.IsSet && edFiStaffOtherName.PersonalTitlePrefix == null)
                throw new ArgumentNullException(nameof(edFiStaffOtherName.PersonalTitlePrefix), "Property is required for class EdFiStaffOtherName.");
