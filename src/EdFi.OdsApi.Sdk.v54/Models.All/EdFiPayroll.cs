...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiPayroll : IValidatableObject
    {
        ...
        public EdFiPayroll(string id = default, DateOnly asOfDate = default, EdFiAccountReference accountReference = default, EdFiStaffReference staffReference = default, double amountToDate = default, string etag = default, Object ext = default)
        {
            this.AsOfDate = asOfDate;
            // to ensure "accountReference" is required (not null)
            if (accountReference == null)
            {
                throw new ArgumentNullException("accountReference is a required property for EdFiPayroll and cannot be null");
            }
            this.AccountReference = accountReference;
            // to ensure "staffReference" is required (not null)
            if (staffReference == null)
            {
                throw new ArgumentNullException("staffReference is a required property for EdFiPayroll and cannot be null");
            }
