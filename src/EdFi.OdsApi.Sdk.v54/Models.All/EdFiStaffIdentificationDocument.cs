    ...
    public class EdFiStaffIdentificationDocumentJsonConverter : JsonConverter<EdFiStaffIdentificationDocument>
    {
        ...
        public override EdFiStaffIdentificationDocument Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (issuerCountryDescriptor.IsSet && issuerCountryDescriptor.Value == null)
                throw new ArgumentNullException(nameof(issuerCountryDescriptor), "Property is not nullable for class EdFiStaffIdentificationDocument.");

            if (documentExpirationDate.IsSet && documentExpirationDate.Value == null)
                throw new ArgumentNullException(nameof(documentExpirationDate), "Property is not nullable for class EdFiStaffIdentificationDocument.");

            if (documentTitle.IsSet && documentTitle.Value == null)
                throw new ArgumentNullException(nameof(documentTitle), "Property is not nullable for class EdFiStaffIdentificationDocument.");

            if (issuerDocumentIdentificationCode.IsSet && issuerDocumentIdentificationCode.Value == null)
                throw new ArgumentNullException(nameof(issuerDocumentIdentificationCode), "Property is not nullable for class EdFiStaffIdentificationDocument.");

            if (issuerName.IsSet && issuerName.Value == null)
                throw new ArgumentNullException(nameof(issuerName), "Property is not nullable for class EdFiStaffIdentificationDocument.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStaffIdentificationDocument edFiStaffIdentificationDocument, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStaffIdentificationDocument.IssuerCountryDescriptorOption.IsSet && edFiStaffIdentificationDocument.IssuerCountryDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStaffIdentificationDocument.IssuerCountryDescriptor), "Property is required for class EdFiStaffIdentificationDocument.");

            if (edFiStaffIdentificationDocument.DocumentTitleOption.IsSet && edFiStaffIdentificationDocument.DocumentTitle == null)
                throw new ArgumentNullException(nameof(edFiStaffIdentificationDocument.DocumentTitle), "Property is required for class EdFiStaffIdentificationDocument.");

            if (edFiStaffIdentificationDocument.IssuerDocumentIdentificationCodeOption.IsSet && edFiStaffIdentificationDocument.IssuerDocumentIdentificationCode == null)
                throw new ArgumentNullException(nameof(edFiStaffIdentificationDocument.IssuerDocumentIdentificationCode), "Property is required for class EdFiStaffIdentificationDocument.");

            if (edFiStaffIdentificationDocument.IssuerNameOption.IsSet && edFiStaffIdentificationDocument.IssuerName == null)
                throw new ArgumentNullException(nameof(edFiStaffIdentificationDocument.IssuerName), "Property is required for class EdFiStaffIdentificationDocument.");
