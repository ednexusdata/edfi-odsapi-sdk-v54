...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public class EdFiLocationJsonConverter : JsonConverter<EdFiLocation>
    {
        ...
        public override EdFiLocation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (maximumNumberOfSeats.IsSet && maximumNumberOfSeats.Value == null)
                throw new ArgumentNullException(nameof(maximumNumberOfSeats), "Property is not nullable for class EdFiLocation.");

            if (optimalNumberOfSeats.IsSet && optimalNumberOfSeats.Value == null)
                throw new ArgumentNullException(nameof(optimalNumberOfSeats), "Property is not nullable for class EdFiLocation.");
