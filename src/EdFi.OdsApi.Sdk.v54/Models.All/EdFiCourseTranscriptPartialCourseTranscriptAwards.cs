    ...
    public class EdFiCourseTranscriptPartialCourseTranscriptAwardsJsonConverter : JsonConverter<EdFiCourseTranscriptPartialCourseTranscriptAwards>
    {
        ...
        public override EdFiCourseTranscriptPartialCourseTranscriptAwards Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (methodCreditEarnedDescriptor.IsSet && methodCreditEarnedDescriptor.Value == null)
                throw new ArgumentNullException(nameof(methodCreditEarnedDescriptor), "Property is not nullable for class EdFiCourseTranscriptPartialCourseTranscriptAwards.");

            if (letterGradeEarned.IsSet && letterGradeEarned.Value == null)
                throw new ArgumentNullException(nameof(letterGradeEarned), "Property is not nullable for class EdFiCourseTranscriptPartialCourseTranscriptAwards.");

            if (numericGradeEarned.IsSet && numericGradeEarned.Value == null)
                throw new ArgumentNullException(nameof(numericGradeEarned), "Property is not nullable for class EdFiCourseTranscriptPartialCourseTranscriptAwards.");
        ...
        {
            if (edFiCourseTranscriptPartialCourseTranscriptAwards.MethodCreditEarnedDescriptorOption.IsSet && edFiCourseTranscriptPartialCourseTranscriptAwards.MethodCreditEarnedDescriptor == null)
                throw new ArgumentNullException(nameof(edFiCourseTranscriptPartialCourseTranscriptAwards.MethodCreditEarnedDescriptor), "Property is required for class EdFiCourseTranscriptPartialCourseTranscriptAwards.");

            if (edFiCourseTranscriptPartialCourseTranscriptAwards.LetterGradeEarnedOption.IsSet && edFiCourseTranscriptPartialCourseTranscriptAwards.LetterGradeEarned == null)
                throw new ArgumentNullException(nameof(edFiCourseTranscriptPartialCourseTranscriptAwards.LetterGradeEarned), "Property is required for class EdFiCourseTranscriptPartialCourseTranscriptAwards.");

            if (edFiCourseTranscriptPartialCourseTranscriptAwards.NumericGradeEarnedOption.IsSet && edFiCourseTranscriptPartialCourseTranscriptAwards.NumericGradeEarned == null)
                throw new ArgumentNullException(nameof(edFiCourseTranscriptPartialCourseTranscriptAwards.NumericGradeEarned), "Property is required for class EdFiCourseTranscriptPartialCourseTranscriptAwards.");
