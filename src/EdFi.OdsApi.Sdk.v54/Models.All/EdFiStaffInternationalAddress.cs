    ...
    public class EdFiStaffInternationalAddressJsonConverter : JsonConverter<EdFiStaffInternationalAddress>
    {
        ...
        public override EdFiStaffInternationalAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class EdFiStaffInternationalAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class EdFiStaffInternationalAddress.");

            if (addressLine4.IsSet && addressLine4.Value == null)
                throw new ArgumentNullException(nameof(addressLine4), "Property is not nullable for class EdFiStaffInternationalAddress.");

            if (beginDate.IsSet && beginDate.Value == null)
                throw new ArgumentNullException(nameof(beginDate), "Property is not nullable for class EdFiStaffInternationalAddress.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class EdFiStaffInternationalAddress.");

            if (latitude.IsSet && latitude.Value == null)
                throw new ArgumentNullException(nameof(latitude), "Property is not nullable for class EdFiStaffInternationalAddress.");

            if (longitude.IsSet && longitude.Value == null)
                throw new ArgumentNullException(nameof(longitude), "Property is not nullable for class EdFiStaffInternationalAddress.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStaffInternationalAddress edFiStaffInternationalAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStaffInternationalAddress.AddressLine2Option.IsSet && edFiStaffInternationalAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(edFiStaffInternationalAddress.AddressLine2), "Property is required for class EdFiStaffInternationalAddress.");

            if (edFiStaffInternationalAddress.AddressLine3Option.IsSet && edFiStaffInternationalAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(edFiStaffInternationalAddress.AddressLine3), "Property is required for class EdFiStaffInternationalAddress.");

            if (edFiStaffInternationalAddress.AddressLine4Option.IsSet && edFiStaffInternationalAddress.AddressLine4 == null)
                throw new ArgumentNullException(nameof(edFiStaffInternationalAddress.AddressLine4), "Property is required for class EdFiStaffInternationalAddress.");

            if (edFiStaffInternationalAddress.LatitudeOption.IsSet && edFiStaffInternationalAddress.Latitude == null)
                throw new ArgumentNullException(nameof(edFiStaffInternationalAddress.Latitude), "Property is required for class EdFiStaffInternationalAddress.");

            if (edFiStaffInternationalAddress.LongitudeOption.IsSet && edFiStaffInternationalAddress.Longitude == null)
                throw new ArgumentNullException(nameof(edFiStaffInternationalAddress.Longitude), "Property is required for class EdFiStaffInternationalAddress.");
