...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public class EdFiSurveyQuestionResponseSurveyQuestionMatrixElementResponseJsonConverter : JsonConverter<EdFiSurveyQuestionResponseSurveyQuestionMatrixElementResponse>
    {
        ...
        public override EdFiSurveyQuestionResponseSurveyQuestionMatrixElementResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (maxNumericResponse.IsSet && maxNumericResponse.Value == null)
                throw new ArgumentNullException(nameof(maxNumericResponse), "Property is not nullable for class EdFiSurveyQuestionResponseSurveyQuestionMatrixElementResponse.");

            if (minNumericResponse.IsSet && minNumericResponse.Value == null)
                throw new ArgumentNullException(nameof(minNumericResponse), "Property is not nullable for class EdFiSurveyQuestionResponseSurveyQuestionMatrixElementResponse.");

            if (noResponse.IsSet && noResponse.Value == null)
                throw new ArgumentNullException(nameof(noResponse), "Property is not nullable for class EdFiSurveyQuestionResponseSurveyQuestionMatrixElementResponse.");

            if (numericResponse.IsSet && numericResponse.Value == null)
                throw new ArgumentNullException(nameof(numericResponse), "Property is not nullable for class EdFiSurveyQuestionResponseSurveyQuestionMatrixElementResponse.");

            if (textResponse.IsSet && textResponse.Value == null)
                throw new ArgumentNullException(nameof(textResponse), "Property is not nullable for class EdFiSurveyQuestionResponseSurveyQuestionMatrixElementResponse.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiSurveyQuestionResponseSurveyQuestionMatrixElementResponse edFiSurveyQuestionResponseSurveyQuestionMatrixElementResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiSurveyQuestionResponseSurveyQuestionMatrixElementResponse.TextResponseOption.IsSet && edFiSurveyQuestionResponseSurveyQuestionMatrixElementResponse.TextResponse == null)
                throw new ArgumentNullException(nameof(edFiSurveyQuestionResponseSurveyQuestionMatrixElementResponse.TextResponse), "Property is required for class EdFiSurveyQuestionResponseSurveyQuestionMatrixElementResponse.");
