...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiStudentOtherName : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="otherNameTypeDescriptor">The types of alternate names for a person.</param>
    ...
    public class EdFiStudentOtherNameJsonConverter : JsonConverter<EdFiStudentOtherName>
    {
        ...
        public override EdFiStudentOtherName Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (generationCodeSuffix.IsSet && generationCodeSuffix.Value == null)
                throw new ArgumentNullException(nameof(generationCodeSuffix), "Property is not nullable for class EdFiStudentOtherName.");

            if (middleName.IsSet && middleName.Value == null)
                throw new ArgumentNullException(nameof(middleName), "Property is not nullable for class EdFiStudentOtherName.");

            if (personalTitlePrefix.IsSet && personalTitlePrefix.Value == null)
                throw new ArgumentNullException(nameof(personalTitlePrefix), "Property is not nullable for class EdFiStudentOtherName.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentOtherName edFiStudentOtherName, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentOtherName.GenerationCodeSuffixOption.IsSet && edFiStudentOtherName.GenerationCodeSuffix == null)
                throw new ArgumentNullException(nameof(edFiStudentOtherName.GenerationCodeSuffix), "Property is required for class EdFiStudentOtherName.");

            if (edFiStudentOtherName.MiddleNameOption.IsSet && edFiStudentOtherName.MiddleName == null)
                throw new ArgumentNullException(nameof(edFiStudentOtherName.MiddleName), "Property is required for class EdFiStudentOtherName.");

            if (edFiStudentOtherName.PersonalTitlePrefixOption.IsSet && edFiStudentOtherName.PersonalTitlePrefix == null)
                throw new ArgumentNullException(nameof(edFiStudentOtherName.PersonalTitlePrefix), "Property is required for class EdFiStudentOtherName.");
