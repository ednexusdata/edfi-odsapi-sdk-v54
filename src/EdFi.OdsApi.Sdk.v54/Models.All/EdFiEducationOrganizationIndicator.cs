...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public class EdFiEducationOrganizationIndicatorJsonConverter : JsonConverter<EdFiEducationOrganizationIndicator>
    {
        ...
        public override EdFiEducationOrganizationIndicator Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (indicatorGroupDescriptor.IsSet && indicatorGroupDescriptor.Value == null)
                throw new ArgumentNullException(nameof(indicatorGroupDescriptor), "Property is not nullable for class EdFiEducationOrganizationIndicator.");

            if (indicatorLevelDescriptor.IsSet && indicatorLevelDescriptor.Value == null)
                throw new ArgumentNullException(nameof(indicatorLevelDescriptor), "Property is not nullable for class EdFiEducationOrganizationIndicator.");

            if (designatedBy.IsSet && designatedBy.Value == null)
                throw new ArgumentNullException(nameof(designatedBy), "Property is not nullable for class EdFiEducationOrganizationIndicator.");

            if (indicatorValue.IsSet && indicatorValue.Value == null)
                throw new ArgumentNullException(nameof(indicatorValue), "Property is not nullable for class EdFiEducationOrganizationIndicator.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiEducationOrganizationIndicator edFiEducationOrganizationIndicator, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiEducationOrganizationIndicator.IndicatorGroupDescriptorOption.IsSet && edFiEducationOrganizationIndicator.IndicatorGroupDescriptor == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationIndicator.IndicatorGroupDescriptor), "Property is required for class EdFiEducationOrganizationIndicator.");

            if (edFiEducationOrganizationIndicator.IndicatorLevelDescriptorOption.IsSet && edFiEducationOrganizationIndicator.IndicatorLevelDescriptor == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationIndicator.IndicatorLevelDescriptor), "Property is required for class EdFiEducationOrganizationIndicator.");

            if (edFiEducationOrganizationIndicator.DesignatedByOption.IsSet && edFiEducationOrganizationIndicator.DesignatedBy == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationIndicator.DesignatedBy), "Property is required for class EdFiEducationOrganizationIndicator.");

            if (edFiEducationOrganizationIndicator.IndicatorValueOption.IsSet && edFiEducationOrganizationIndicator.IndicatorValue == null)
                throw new ArgumentNullException(nameof(edFiEducationOrganizationIndicator.IndicatorValue), "Property is required for class EdFiEducationOrganizationIndicator.");
