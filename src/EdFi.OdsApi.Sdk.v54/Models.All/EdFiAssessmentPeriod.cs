    ...
    public class EdFiAssessmentPeriodJsonConverter : JsonConverter<EdFiAssessmentPeriod>
    {
        ...
        public override EdFiAssessmentPeriod Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (beginDate.IsSet && beginDate.Value == null)
                throw new ArgumentNullException(nameof(beginDate), "Property is not nullable for class EdFiAssessmentPeriod.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class EdFiAssessmentPeriod.");
