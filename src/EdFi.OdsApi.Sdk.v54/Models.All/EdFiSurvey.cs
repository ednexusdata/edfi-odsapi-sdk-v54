...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public class EdFiSurveyJsonConverter : JsonConverter<EdFiSurvey>
    {
        ...
        public override EdFiSurvey Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (numberAdministered.IsSet && numberAdministered.Value == null)
                throw new ArgumentNullException(nameof(numberAdministered), "Property is not nullable for class EdFiSurvey.");

            if (surveyCategoryDescriptor.IsSet && surveyCategoryDescriptor.Value == null)
                throw new ArgumentNullException(nameof(surveyCategoryDescriptor), "Property is not nullable for class EdFiSurvey.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiSurvey edFiSurvey, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiSurvey.SurveyCategoryDescriptorOption.IsSet && edFiSurvey.SurveyCategoryDescriptor == null)
                throw new ArgumentNullException(nameof(edFiSurvey.SurveyCategoryDescriptor), "Property is required for class EdFiSurvey.");
