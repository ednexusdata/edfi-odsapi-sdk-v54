...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiOrganizationDepartment : IValidatableObject
    {
        ...
        /// <param name="organizationDepartmentId">The unique identification code for the OrganizationDepartment.</param>
    ...
    public class EdFiOrganizationDepartmentJsonConverter : JsonConverter<EdFiOrganizationDepartment>
    {
        ...
        public override EdFiOrganizationDepartment Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (academicSubjectDescriptor.IsSet && academicSubjectDescriptor.Value == null)
                throw new ArgumentNullException(nameof(academicSubjectDescriptor), "Property is not nullable for class EdFiOrganizationDepartment.");
            ...
            if (operationalStatusDescriptor.IsSet && operationalStatusDescriptor.Value == null)
                throw new ArgumentNullException(nameof(operationalStatusDescriptor), "Property is not nullable for class EdFiOrganizationDepartment.");

            if (shortNameOfInstitution.IsSet && shortNameOfInstitution.Value == null)
                throw new ArgumentNullException(nameof(shortNameOfInstitution), "Property is not nullable for class EdFiOrganizationDepartment.");

            if (webSite.IsSet && webSite.Value == null)
                throw new ArgumentNullException(nameof(webSite), "Property is not nullable for class EdFiOrganizationDepartment.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiOrganizationDepartment edFiOrganizationDepartment, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiOrganizationDepartment.AcademicSubjectDescriptorOption.IsSet && edFiOrganizationDepartment.AcademicSubjectDescriptor == null)
                throw new ArgumentNullException(nameof(edFiOrganizationDepartment.AcademicSubjectDescriptor), "Property is required for class EdFiOrganizationDepartment.");
            ...
            if (edFiOrganizationDepartment.OperationalStatusDescriptorOption.IsSet && edFiOrganizationDepartment.OperationalStatusDescriptor == null)
                throw new ArgumentNullException(nameof(edFiOrganizationDepartment.OperationalStatusDescriptor), "Property is required for class EdFiOrganizationDepartment.");

            if (edFiOrganizationDepartment.ShortNameOfInstitutionOption.IsSet && edFiOrganizationDepartment.ShortNameOfInstitution == null)
                throw new ArgumentNullException(nameof(edFiOrganizationDepartment.ShortNameOfInstitution), "Property is required for class EdFiOrganizationDepartment.");

            if (edFiOrganizationDepartment.WebSiteOption.IsSet && edFiOrganizationDepartment.WebSite == null)
                throw new ArgumentNullException(nameof(edFiOrganizationDepartment.WebSite), "Property is required for class EdFiOrganizationDepartment.");
