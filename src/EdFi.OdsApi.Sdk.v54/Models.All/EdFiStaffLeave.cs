...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiStaffLeave : IValidatableObject
    {
        ...
        /// <param name="staffLeaveEventCategoryDescriptor">The code describing the type of leave taken, for example: Sick, Personal, Vacation.</param>
    ...
    public class EdFiStaffLeaveJsonConverter : JsonConverter<EdFiStaffLeave>
    {
        ...
        public override EdFiStaffLeave Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class EdFiStaffLeave.");

            if (reason.IsSet && reason.Value == null)
                throw new ArgumentNullException(nameof(reason), "Property is not nullable for class EdFiStaffLeave.");

            if (substituteAssigned.IsSet && substituteAssigned.Value == null)
                throw new ArgumentNullException(nameof(substituteAssigned), "Property is not nullable for class EdFiStaffLeave.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStaffLeave edFiStaffLeave, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStaffLeave.ReasonOption.IsSet && edFiStaffLeave.Reason == null)
                throw new ArgumentNullException(nameof(edFiStaffLeave.Reason), "Property is required for class EdFiStaffLeave.");
