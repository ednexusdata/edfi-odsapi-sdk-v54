...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiAssessmentScoreRangeLearningStandard : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="learningStandards">An unordered collection of assessmentScoreRangeLearningStandardLearningStandards. LearningStandard associated with the score range.</param>
    ...
    public class EdFiAssessmentScoreRangeLearningStandardJsonConverter : JsonConverter<EdFiAssessmentScoreRangeLearningStandard>
    {
        ...
        public override EdFiAssessmentScoreRangeLearningStandard Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (assessmentReportingMethodDescriptor.IsSet && assessmentReportingMethodDescriptor.Value == null)
                throw new ArgumentNullException(nameof(assessmentReportingMethodDescriptor), "Property is not nullable for class EdFiAssessmentScoreRangeLearningStandard.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiAssessmentScoreRangeLearningStandard edFiAssessmentScoreRangeLearningStandard, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiAssessmentScoreRangeLearningStandard.AssessmentReportingMethodDescriptorOption.IsSet && edFiAssessmentScoreRangeLearningStandard.AssessmentReportingMethodDescriptor == null)
                throw new ArgumentNullException(nameof(edFiAssessmentScoreRangeLearningStandard.AssessmentReportingMethodDescriptor), "Property is required for class EdFiAssessmentScoreRangeLearningStandard.");
