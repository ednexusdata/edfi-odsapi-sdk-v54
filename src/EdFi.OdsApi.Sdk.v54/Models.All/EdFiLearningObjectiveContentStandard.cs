...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public class EdFiLearningObjectiveContentStandardJsonConverter : JsonConverter<EdFiLearningObjectiveContentStandard>
    {
        ...
        public override EdFiLearningObjectiveContentStandard Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (publicationStatusDescriptor.IsSet && publicationStatusDescriptor.Value == null)
                throw new ArgumentNullException(nameof(publicationStatusDescriptor), "Property is not nullable for class EdFiLearningObjectiveContentStandard.");

            if (beginDate.IsSet && beginDate.Value == null)
                throw new ArgumentNullException(nameof(beginDate), "Property is not nullable for class EdFiLearningObjectiveContentStandard.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class EdFiLearningObjectiveContentStandard.");

            if (publicationDate.IsSet && publicationDate.Value == null)
                throw new ArgumentNullException(nameof(publicationDate), "Property is not nullable for class EdFiLearningObjectiveContentStandard.");

            if (publicationYear.IsSet && publicationYear.Value == null)
                throw new ArgumentNullException(nameof(publicationYear), "Property is not nullable for class EdFiLearningObjectiveContentStandard.");

            if (uri.IsSet && uri.Value == null)
                throw new ArgumentNullException(nameof(uri), "Property is not nullable for class EdFiLearningObjectiveContentStandard.");

            if (varVersion.IsSet && varVersion.Value == null)
                throw new ArgumentNullException(nameof(varVersion), "Property is not nullable for class EdFiLearningObjectiveContentStandard.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiLearningObjectiveContentStandard edFiLearningObjectiveContentStandard, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiLearningObjectiveContentStandard.PublicationStatusDescriptorOption.IsSet && edFiLearningObjectiveContentStandard.PublicationStatusDescriptor == null)
                throw new ArgumentNullException(nameof(edFiLearningObjectiveContentStandard.PublicationStatusDescriptor), "Property is required for class EdFiLearningObjectiveContentStandard.");

            if (edFiLearningObjectiveContentStandard.UriOption.IsSet && edFiLearningObjectiveContentStandard.Uri == null)
                throw new ArgumentNullException(nameof(edFiLearningObjectiveContentStandard.Uri), "Property is required for class EdFiLearningObjectiveContentStandard.");

            if (edFiLearningObjectiveContentStandard.VarVersionOption.IsSet && edFiLearningObjectiveContentStandard.VarVersion == null)
                throw new ArgumentNullException(nameof(edFiLearningObjectiveContentStandard.VarVersion), "Property is required for class EdFiLearningObjectiveContentStandard.");
