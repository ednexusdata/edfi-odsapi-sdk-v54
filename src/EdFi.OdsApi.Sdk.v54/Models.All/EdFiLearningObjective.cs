...
namespace EdFi.OdsApi.Sdk.v54.Models.All
{
    ...
    public partial class EdFiLearningObjective : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="academicSubjects">An unordered collection of learningObjectiveAcademicSubjects. The description of the content or subject area (e.g., arts, mathematics, reading, stenography, or a foreign language) of an assessment.</param>
        ...
        /// <param name="objective">The designated title of the LearningObjective.</param>
    ...
    public class EdFiLearningObjectiveJsonConverter : JsonConverter<EdFiLearningObjective>
    {
        ...
        public override EdFiLearningObjective Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class EdFiLearningObjective.");
            ...
            if (nomenclature.IsSet && nomenclature.Value == null)
                throw new ArgumentNullException(nameof(nomenclature), "Property is not nullable for class EdFiLearningObjective.");

            if (successCriteria.IsSet && successCriteria.Value == null)
                throw new ArgumentNullException(nameof(successCriteria), "Property is not nullable for class EdFiLearningObjective.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiLearningObjective edFiLearningObjective, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiLearningObjective.DescriptionOption.IsSet && edFiLearningObjective.Description == null)
                throw new ArgumentNullException(nameof(edFiLearningObjective.Description), "Property is required for class EdFiLearningObjective.");
            ...
            if (edFiLearningObjective.NomenclatureOption.IsSet && edFiLearningObjective.Nomenclature == null)
                throw new ArgumentNullException(nameof(edFiLearningObjective.Nomenclature), "Property is required for class EdFiLearningObjective.");

            if (edFiLearningObjective.SuccessCriteriaOption.IsSet && edFiLearningObjective.SuccessCriteria == null)
                throw new ArgumentNullException(nameof(edFiLearningObjective.SuccessCriteria), "Property is required for class EdFiLearningObjective.");
