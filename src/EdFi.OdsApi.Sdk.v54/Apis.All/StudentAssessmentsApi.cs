...
namespace EdFi.OdsApi.Sdk.v54.Apis.All
{
    ...
    public interface IStudentAssessmentsApi : IApi
    {
        ...
        Task<IDeletesStudentAssessmentsApiResponse> DeletesStudentAssessmentsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// </summary>
    public interface IDeleteStudentAssessmentByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesStudentAssessmentsApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<List<DeletedResource>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetStudentAssessmentsApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<List<EdFiStudentAssessment>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetStudentAssessmentsByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v54.Models.All.EdFiStudentAssessment?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostStudentAssessmentApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutStudentAssessmentApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class StudentAssessmentsApi : IStudentAssessmentsApi
    {
        ...
        /// </summary>
        public partial class DeleteStudentAssessmentByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IDeleteStudentAssessmentByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        partial void FormatDeletesStudentAssessments(ref Option<int> offset, ref Option<int> limit, ref Option<long> minChangeVersion, ref Option<long> maxChangeVersion, ref Option<string> snapshotIdentifier);
        ...
        /// <param name="snapshotIdentifier"></param>
        private void AfterDeletesStudentAssessmentsDefaultImplementation(IDeletesStudentAssessmentsApiResponse apiResponseLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier)
        {
            bool suppressDefaultLog = false;
            AfterDeletesStudentAssessments(ref suppressDefaultLog, apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        partial void AfterDeletesStudentAssessments(ref bool suppressDefaultLog, IDeletesStudentAssessmentsApiResponse apiResponseLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier);
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        private void OnErrorDeletesStudentAssessmentsDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorDeletesStudentAssessments(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        partial void OnErrorDeletesStudentAssessments(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier);
        ...
        public async Task<IDeletesStudentAssessmentsApiResponse?> DeletesStudentAssessmentsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await DeletesStudentAssessmentsAsync(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IDeletesStudentAssessmentsApiResponse> DeletesStudentAssessmentsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                FormatDeletesStudentAssessments(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref snapshotIdentifier);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterDeletesStudentAssessmentsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            ...
            {
                OnErrorDeletesStudentAssessmentsDefaultImplementation(e, "/ed-fi/studentAssessments/deletes", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
        ...
        /// </summary>
        public partial class DeletesStudentAssessmentsApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IDeletesStudentAssessmentsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        public async Task<IGetStudentAssessmentsApiResponse?> GetStudentAssessmentsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> studentAssessmentIdentifier = default, Option<string> assessmentIdentifier = default, Option<string> varNamespace = default, Option<string> studentUniqueId = default, Option<int> schoolYear = default, Option<string> administrationEnvironmentDescriptor = default, Option<string> eventCircumstanceDescriptor = default, Option<string> whenAssessedGradeLevelDescriptor = default, Option<string> administrationLanguageDescriptor = default, Option<string> platformTypeDescriptor = default, Option<string> reasonNotTestedDescriptor = default, Option<string> retestIndicatorDescriptor = default, Option<DateTime> administrationDate = default, Option<DateTime> administrationEndDate = default, Option<string> eventDescription = default, Option<string> id = default, Option<string> serialNumber = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetStudentAssessmentsAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, studentAssessmentIdentifier, assessmentIdentifier, varNamespace, studentUniqueId, schoolYear, administrationEnvironmentDescriptor, eventCircumstanceDescriptor, whenAssessedGradeLevelDescriptor, administrationLanguageDescriptor, platformTypeDescriptor, reasonNotTestedDescriptor, retestIndicatorDescriptor, administrationDate, administrationEndDate, eventDescription, id, serialNumber, snapshotIdentifier, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IGetStudentAssessmentsApiResponse> GetStudentAssessmentsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> studentAssessmentIdentifier = default, Option<string> assessmentIdentifier = default, Option<string> varNamespace = default, Option<string> studentUniqueId = default, Option<int> schoolYear = default, Option<string> administrationEnvironmentDescriptor = default, Option<string> eventCircumstanceDescriptor = default, Option<string> whenAssessedGradeLevelDescriptor = default, Option<string> administrationLanguageDescriptor = default, Option<string> platformTypeDescriptor = default, Option<string> reasonNotTestedDescriptor = default, Option<string> retestIndicatorDescriptor = default, Option<DateTime> administrationDate = default, Option<DateTime> administrationEndDate = default, Option<string> eventDescription = default, Option<string> id = default, Option<string> serialNumber = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetStudentAssessments(studentAssessmentIdentifier, assessmentIdentifier, varNamespace, studentUniqueId, administrationEnvironmentDescriptor, eventCircumstanceDescriptor, whenAssessedGradeLevelDescriptor, administrationLanguageDescriptor, platformTypeDescriptor, reasonNotTestedDescriptor, retestIndicatorDescriptor, eventDescription, id, serialNumber, snapshotIdentifier);

                FormatGetStudentAssessments(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref studentAssessmentIdentifier, ref assessmentIdentifier, ref varNamespace, ref studentUniqueId, ref schoolYear, ref administrationEnvironmentDescriptor, ref eventCircumstanceDescriptor, ref whenAssessedGradeLevelDescriptor, ref administrationLanguageDescriptor, ref platformTypeDescriptor, ref reasonNotTestedDescriptor, ref retestIndicatorDescriptor, ref administrationDate, ref administrationEndDate, ref eventDescription, ref id, ref serialNumber, ref snapshotIdentifier);
        ...
        /// </summary>
        public partial class GetStudentAssessmentsApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IGetStudentAssessmentsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetStudentAssessmentsByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IGetStudentAssessmentsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v54.Models.All.EdFiStudentAssessment? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v54.Models.All.EdFiStudentAssessment>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v54.Models.All.EdFiStudentAssessment? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class PostStudentAssessmentApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IPostStudentAssessmentApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutStudentAssessmentApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IPutStudentAssessmentApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
