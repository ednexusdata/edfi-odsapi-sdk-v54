...
namespace EdFi.OdsApi.Sdk.v54.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteStudentGradebookEntryByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesStudentGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<List<DeletedResource>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetStudentGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<List<EdFiStudentGradebookEntry>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetStudentGradebookEntriesByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v54.Models.All.EdFiStudentGradebookEntry?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostStudentGradebookEntryApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutStudentGradebookEntryApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class StudentGradebookEntriesApi : IStudentGradebookEntriesApi
    {
        ...
        /// </summary>
        public partial class DeleteStudentGradebookEntryByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IDeleteStudentGradebookEntryByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        partial void FormatDeletesStudentGradebookEntries(ref Option<int> offset, ref Option<int> limit, ref Option<long> minChangeVersion, ref Option<long> maxChangeVersion, ref Option<string> snapshotIdentifier);
        ...
        /// <param name="snapshotIdentifier"></param>
        private void AfterDeletesStudentGradebookEntriesDefaultImplementation(IDeletesStudentGradebookEntriesApiResponse apiResponseLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier)
        {
            bool suppressDefaultLog = false;
            AfterDeletesStudentGradebookEntries(ref suppressDefaultLog, apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        partial void AfterDeletesStudentGradebookEntries(ref bool suppressDefaultLog, IDeletesStudentGradebookEntriesApiResponse apiResponseLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier);
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        private void OnErrorDeletesStudentGradebookEntriesDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorDeletesStudentGradebookEntries(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        partial void OnErrorDeletesStudentGradebookEntries(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier);
        ...
        public async Task<IDeletesStudentGradebookEntriesApiResponse?> DeletesStudentGradebookEntriesOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await DeletesStudentGradebookEntriesAsync(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IDeletesStudentGradebookEntriesApiResponse> DeletesStudentGradebookEntriesAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                FormatDeletesStudentGradebookEntries(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref snapshotIdentifier);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterDeletesStudentGradebookEntriesDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            ...
            {
                OnErrorDeletesStudentGradebookEntriesDefaultImplementation(e, "/ed-fi/studentGradebookEntries/deletes", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
        ...
        /// </summary>
        public partial class DeletesStudentGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IDeletesStudentGradebookEntriesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        partial void FormatGetStudentGradebookEntries(ref Option<int> offset, ref Option<int> limit, ref Option<long> minChangeVersion, ref Option<long> maxChangeVersion, ref Option<bool> totalCount, ref Option<DateOnly> dateAssigned, ref Option<string> gradebookEntryTitle, ref Option<string> localCourseCode, ref Option<int> schoolId, ref Option<int> schoolYear, ref Option<string> sectionIdentifier, ref Option<string> sessionName, ref Option<DateOnly> beginDate, ref Option<string> studentUniqueId, ref Option<string> competencyLevelDescriptor, ref Option<DateOnly> dateFulfilled, ref Option<string> diagnosticStatement, ref Option<string> id, ref Option<string> letterGradeEarned, ref Option<double> numericGradeEarned, ref Option<string> snapshotIdentifier);

        /// <summary>
        /// Validates the request parameters
        /// </summary>
        /// <param name="gradebookEntryTitle"></param>
        ...
        /// <param name="snapshotIdentifier"></param>
        /// <returns></returns>
        private void ValidateGetStudentGradebookEntries(Option<string> gradebookEntryTitle, Option<string> localCourseCode, Option<string> sectionIdentifier, Option<string> sessionName, Option<string> studentUniqueId, Option<string> competencyLevelDescriptor, Option<string> diagnosticStatement, Option<string> id, Option<string> letterGradeEarned, Option<string> snapshotIdentifier)
        {
            if (gradebookEntryTitle.IsSet && gradebookEntryTitle.Value == null)
                throw new ArgumentNullException(nameof(gradebookEntryTitle));
        ...
        /// <param name="snapshotIdentifier"></param>
        private void AfterGetStudentGradebookEntriesDefaultImplementation(IGetStudentGradebookEntriesApiResponse apiResponseLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<bool> totalCount, Option<DateOnly> dateAssigned, Option<string> gradebookEntryTitle, Option<string> localCourseCode, Option<int> schoolId, Option<int> schoolYear, Option<string> sectionIdentifier, Option<string> sessionName, Option<DateOnly> beginDate, Option<string> studentUniqueId, Option<string> competencyLevelDescriptor, Option<DateOnly> dateFulfilled, Option<string> diagnosticStatement, Option<string> id, Option<string> letterGradeEarned, Option<double> numericGradeEarned, Option<string> snapshotIdentifier)
        {
            bool suppressDefaultLog = false;
        ...
        public async Task<IGetStudentGradebookEntriesApiResponse> GetStudentGradebookEntriesAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<DateOnly> dateAssigned = default, Option<string> gradebookEntryTitle = default, Option<string> localCourseCode = default, Option<int> schoolId = default, Option<int> schoolYear = default, Option<string> sectionIdentifier = default, Option<string> sessionName = default, Option<DateOnly> beginDate = default, Option<string> studentUniqueId = default, Option<string> competencyLevelDescriptor = default, Option<DateOnly> dateFulfilled = default, Option<string> diagnosticStatement = default, Option<string> id = default, Option<string> letterGradeEarned = default, Option<double> numericGradeEarned = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetStudentGradebookEntries(gradebookEntryTitle, localCourseCode, sectionIdentifier, sessionName, studentUniqueId, competencyLevelDescriptor, diagnosticStatement, id, letterGradeEarned, snapshotIdentifier);

                FormatGetStudentGradebookEntries(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref dateAssigned, ref gradebookEntryTitle, ref localCourseCode, ref schoolId, ref schoolYear, ref sectionIdentifier, ref sessionName, ref beginDate, ref studentUniqueId, ref competencyLevelDescriptor, ref dateFulfilled, ref diagnosticStatement, ref id, ref letterGradeEarned, ref numericGradeEarned, ref snapshotIdentifier);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    if (gradebookEntryTitle.IsSet)
                        parseQueryStringLocalVar["gradebookEntryTitle"] = ClientUtils.ParameterToString(gradebookEntryTitle.Value);
        ...
        /// </summary>
        public partial class GetStudentGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IGetStudentGradebookEntriesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetStudentGradebookEntriesByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IGetStudentGradebookEntriesByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v54.Models.All.EdFiStudentGradebookEntry? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v54.Models.All.EdFiStudentGradebookEntry>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v54.Models.All.EdFiStudentGradebookEntry? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class PostStudentGradebookEntryApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IPostStudentGradebookEntryApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutStudentGradebookEntryApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IPutStudentGradebookEntryApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
