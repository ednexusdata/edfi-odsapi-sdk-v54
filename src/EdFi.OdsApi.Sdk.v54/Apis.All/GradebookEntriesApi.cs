...
namespace EdFi.OdsApi.Sdk.v54.Apis.All
{
    ...
    public interface IGradebookEntriesApi : IApi
    {
        ...
        Task<IDeletesGradebookEntriesApiResponse> DeletesGradebookEntriesAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// </summary>
    public interface IDeleteGradebookEntryByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<List<DeletedResource>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<List<EdFiGradebookEntry>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetGradebookEntriesByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v54.Models.All.EdFiGradebookEntry?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostGradebookEntryApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutGradebookEntryApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class GradebookEntriesApi : IGradebookEntriesApi
    {
        ...
        /// </summary>
        public partial class DeleteGradebookEntryByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IDeleteGradebookEntryByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        partial void FormatDeletesGradebookEntries(ref Option<int> offset, ref Option<int> limit, ref Option<long> minChangeVersion, ref Option<long> maxChangeVersion, ref Option<string> snapshotIdentifier);
        ...
        /// <param name="snapshotIdentifier"></param>
        private void AfterDeletesGradebookEntriesDefaultImplementation(IDeletesGradebookEntriesApiResponse apiResponseLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier)
        {
            bool suppressDefaultLog = false;
            AfterDeletesGradebookEntries(ref suppressDefaultLog, apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        partial void AfterDeletesGradebookEntries(ref bool suppressDefaultLog, IDeletesGradebookEntriesApiResponse apiResponseLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier);
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        private void OnErrorDeletesGradebookEntriesDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorDeletesGradebookEntries(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        partial void OnErrorDeletesGradebookEntries(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier);
        ...
        public async Task<IDeletesGradebookEntriesApiResponse?> DeletesGradebookEntriesOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await DeletesGradebookEntriesAsync(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IDeletesGradebookEntriesApiResponse> DeletesGradebookEntriesAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                FormatDeletesGradebookEntries(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref snapshotIdentifier);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterDeletesGradebookEntriesDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            ...
            {
                OnErrorDeletesGradebookEntriesDefaultImplementation(e, "/ed-fi/gradebookEntries/deletes", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
        ...
        /// </summary>
        public partial class DeletesGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IDeletesGradebookEntriesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <param name="snapshotIdentifier"></param>
        /// <returns></returns>
        private void ValidateGetGradebookEntries(Option<string> gradebookEntryTitle, Option<string> localCourseCode, Option<string> sectionIdentifier, Option<string> sessionName, Option<string> gradingPeriodDescriptor, Option<string> gradebookEntryTypeDescriptor, Option<string> description, Option<string> id, Option<string> snapshotIdentifier)
        {
        ...
        public async Task<IGetGradebookEntriesApiResponse> GetGradebookEntriesAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<DateOnly> dateAssigned = default, Option<string> gradebookEntryTitle = default, Option<string> localCourseCode = default, Option<int> schoolId = default, Option<int> schoolYear = default, Option<string> sectionIdentifier = default, Option<string> sessionName = default, Option<string> gradingPeriodDescriptor = default, Option<int> periodSequence = default, Option<string> gradebookEntryTypeDescriptor = default, Option<string> description = default, Option<DateOnly> dueDate = default, Option<string> id = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetGradebookEntries(gradebookEntryTitle, localCourseCode, sectionIdentifier, sessionName, gradingPeriodDescriptor, gradebookEntryTypeDescriptor, description, id, snapshotIdentifier);

                FormatGetGradebookEntries(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref dateAssigned, ref gradebookEntryTitle, ref localCourseCode, ref schoolId, ref schoolYear, ref sectionIdentifier, ref sessionName, ref gradingPeriodDescriptor, ref periodSequence, ref gradebookEntryTypeDescriptor, ref description, ref dueDate, ref id, ref snapshotIdentifier);
        ...
        /// </summary>
        public partial class GetGradebookEntriesApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IGetGradebookEntriesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetGradebookEntriesByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IGetGradebookEntriesByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v54.Models.All.EdFiGradebookEntry? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v54.Models.All.EdFiGradebookEntry>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v54.Models.All.EdFiGradebookEntry? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class PostGradebookEntryApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IPostGradebookEntryApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutGradebookEntryApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IPutGradebookEntryApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
