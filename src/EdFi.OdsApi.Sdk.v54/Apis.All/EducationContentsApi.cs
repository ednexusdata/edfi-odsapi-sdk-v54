...
namespace EdFi.OdsApi.Sdk.v54.Apis.All
{
    ...
    public interface IEducationContentsApi : IApi
    {
        ...
        Task<IDeletesEducationContentsApiResponse> DeletesEducationContentsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// </summary>
    public interface IDeleteEducationContentByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesEducationContentsApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<List<DeletedResource>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetEducationContentsApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<List<EdFiEducationContent>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetEducationContentsByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v54.Models.All.EdFiEducationContent?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostEducationContentApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutEducationContentApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class EducationContentsApi : IEducationContentsApi
    {
        ...
        /// </summary>
        public partial class DeleteEducationContentByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IDeleteEducationContentByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        partial void FormatDeletesEducationContents(ref Option<int> offset, ref Option<int> limit, ref Option<long> minChangeVersion, ref Option<long> maxChangeVersion, ref Option<string> snapshotIdentifier);
        ...
        /// <param name="snapshotIdentifier"></param>
        private void AfterDeletesEducationContentsDefaultImplementation(IDeletesEducationContentsApiResponse apiResponseLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier)
        {
            bool suppressDefaultLog = false;
            AfterDeletesEducationContents(ref suppressDefaultLog, apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        partial void AfterDeletesEducationContents(ref bool suppressDefaultLog, IDeletesEducationContentsApiResponse apiResponseLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier);
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        private void OnErrorDeletesEducationContentsDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorDeletesEducationContents(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        partial void OnErrorDeletesEducationContents(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier);
        ...
        public async Task<IDeletesEducationContentsApiResponse?> DeletesEducationContentsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await DeletesEducationContentsAsync(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IDeletesEducationContentsApiResponse> DeletesEducationContentsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                FormatDeletesEducationContents(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref snapshotIdentifier);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterDeletesEducationContentsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            ...
            {
                OnErrorDeletesEducationContentsDefaultImplementation(e, "/ed-fi/educationContents/deletes", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
        ...
        /// </summary>
        public partial class DeletesEducationContentsApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IDeletesEducationContentsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetEducationContentsApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IGetEducationContentsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetEducationContentsByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IGetEducationContentsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v54.Models.All.EdFiEducationContent? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v54.Models.All.EdFiEducationContent>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v54.Models.All.EdFiEducationContent? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class PostEducationContentApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IPostEducationContentApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutEducationContentApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IPutEducationContentApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
