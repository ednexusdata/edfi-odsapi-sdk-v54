...
namespace EdFi.OdsApi.Sdk.v54.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteMagnetSpecialProgramEmphasisSchoolDescriptorByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesMagnetSpecialProgramEmphasisSchoolDescriptorsApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<List<DeletedResource>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetMagnetSpecialProgramEmphasisSchoolDescriptorsApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<List<EdFiMagnetSpecialProgramEmphasisSchoolDescriptor>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetMagnetSpecialProgramEmphasisSchoolDescriptorsByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v54.Models.All.EdFiMagnetSpecialProgramEmphasisSchoolDescriptor?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostMagnetSpecialProgramEmphasisSchoolDescriptorApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutMagnetSpecialProgramEmphasisSchoolDescriptorApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class MagnetSpecialProgramEmphasisSchoolDescriptorsApi : IMagnetSpecialProgramEmphasisSchoolDescriptorsApi
    {
        ...
        /// </summary>
        public partial class DeleteMagnetSpecialProgramEmphasisSchoolDescriptorByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IDeleteMagnetSpecialProgramEmphasisSchoolDescriptorByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        partial void FormatDeletesMagnetSpecialProgramEmphasisSchoolDescriptors(ref Option<int> offset, ref Option<int> limit, ref Option<long> minChangeVersion, ref Option<long> maxChangeVersion, ref Option<string> snapshotIdentifier);
        ...
        {
            bool suppressDefaultLog = false;
            AfterDeletesMagnetSpecialProgramEmphasisSchoolDescriptors(ref suppressDefaultLog, apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        private void OnErrorDeletesMagnetSpecialProgramEmphasisSchoolDescriptorsDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorDeletesMagnetSpecialProgramEmphasisSchoolDescriptors(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IDeletesMagnetSpecialProgramEmphasisSchoolDescriptorsApiResponse?> DeletesMagnetSpecialProgramEmphasisSchoolDescriptorsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await DeletesMagnetSpecialProgramEmphasisSchoolDescriptorsAsync(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IDeletesMagnetSpecialProgramEmphasisSchoolDescriptorsApiResponse> DeletesMagnetSpecialProgramEmphasisSchoolDescriptorsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                FormatDeletesMagnetSpecialProgramEmphasisSchoolDescriptors(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref snapshotIdentifier);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterDeletesMagnetSpecialProgramEmphasisSchoolDescriptorsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            ...
            {
                OnErrorDeletesMagnetSpecialProgramEmphasisSchoolDescriptorsDefaultImplementation(e, "/ed-fi/magnetSpecialProgramEmphasisSchoolDescriptors/deletes", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
        ...
        /// </summary>
        public partial class DeletesMagnetSpecialProgramEmphasisSchoolDescriptorsApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IDeletesMagnetSpecialProgramEmphasisSchoolDescriptorsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetMagnetSpecialProgramEmphasisSchoolDescriptorsApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IGetMagnetSpecialProgramEmphasisSchoolDescriptorsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetMagnetSpecialProgramEmphasisSchoolDescriptorsByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IGetMagnetSpecialProgramEmphasisSchoolDescriptorsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v54.Models.All.EdFiMagnetSpecialProgramEmphasisSchoolDescriptor? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v54.Models.All.EdFiMagnetSpecialProgramEmphasisSchoolDescriptor>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v54.Models.All.EdFiMagnetSpecialProgramEmphasisSchoolDescriptor? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class PostMagnetSpecialProgramEmphasisSchoolDescriptorApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IPostMagnetSpecialProgramEmphasisSchoolDescriptorApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutMagnetSpecialProgramEmphasisSchoolDescriptorApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IPutMagnetSpecialProgramEmphasisSchoolDescriptorApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
