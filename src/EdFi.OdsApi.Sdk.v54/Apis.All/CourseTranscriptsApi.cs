...
namespace EdFi.OdsApi.Sdk.v54.Apis.All
{
    ...
    public interface ICourseTranscriptsApi : IApi
    {
        ...
        Task<IDeletesCourseTranscriptsApiResponse> DeletesCourseTranscriptsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// </summary>
    public interface IDeleteCourseTranscriptByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesCourseTranscriptsApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<List<DeletedResource>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetCourseTranscriptsApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<List<EdFiCourseTranscript>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetCourseTranscriptsByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v54.Models.All.EdFiCourseTranscript?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostCourseTranscriptApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutCourseTranscriptApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class CourseTranscriptsApi : ICourseTranscriptsApi
    {
        ...
        /// </summary>
        public partial class DeleteCourseTranscriptByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IDeleteCourseTranscriptByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        partial void FormatDeletesCourseTranscripts(ref Option<int> offset, ref Option<int> limit, ref Option<long> minChangeVersion, ref Option<long> maxChangeVersion, ref Option<string> snapshotIdentifier);
        ...
        /// <param name="snapshotIdentifier"></param>
        private void AfterDeletesCourseTranscriptsDefaultImplementation(IDeletesCourseTranscriptsApiResponse apiResponseLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier)
        {
            bool suppressDefaultLog = false;
            AfterDeletesCourseTranscripts(ref suppressDefaultLog, apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        partial void AfterDeletesCourseTranscripts(ref bool suppressDefaultLog, IDeletesCourseTranscriptsApiResponse apiResponseLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier);
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        private void OnErrorDeletesCourseTranscriptsDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorDeletesCourseTranscripts(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        partial void OnErrorDeletesCourseTranscripts(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier);
        ...
        public async Task<IDeletesCourseTranscriptsApiResponse?> DeletesCourseTranscriptsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await DeletesCourseTranscriptsAsync(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IDeletesCourseTranscriptsApiResponse> DeletesCourseTranscriptsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                FormatDeletesCourseTranscripts(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref snapshotIdentifier);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterDeletesCourseTranscriptsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            ...
            {
                OnErrorDeletesCourseTranscriptsDefaultImplementation(e, "/ed-fi/courseTranscripts/deletes", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
        ...
        /// </summary>
        public partial class DeletesCourseTranscriptsApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IDeletesCourseTranscriptsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetCourseTranscriptsApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IGetCourseTranscriptsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetCourseTranscriptsByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IGetCourseTranscriptsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v54.Models.All.EdFiCourseTranscript? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v54.Models.All.EdFiCourseTranscript>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v54.Models.All.EdFiCourseTranscript? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class PostCourseTranscriptApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IPostCourseTranscriptApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutCourseTranscriptApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IPutCourseTranscriptApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
