...
namespace EdFi.OdsApi.Sdk.v54.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteStaffEducationOrganizationAssignmentAssociationByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesStaffEducationOrganizationAssignmentAssociationsApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<List<DeletedResource>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetStaffEducationOrganizationAssignmentAssociationsApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<List<EdFiStaffEducationOrganizationAssignmentAssociation>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetStaffEducationOrganizationAssignmentAssociationsByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v54.Models.All.EdFiStaffEducationOrganizationAssignmentAssociation?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostStaffEducationOrganizationAssignmentAssociationApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutStaffEducationOrganizationAssignmentAssociationApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class StaffEducationOrganizationAssignmentAssociationsApi : IStaffEducationOrganizationAssignmentAssociationsApi
    {
        ...
        /// </summary>
        public partial class DeleteStaffEducationOrganizationAssignmentAssociationByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IDeleteStaffEducationOrganizationAssignmentAssociationByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        partial void FormatDeletesStaffEducationOrganizationAssignmentAssociations(ref Option<int> offset, ref Option<int> limit, ref Option<long> minChangeVersion, ref Option<long> maxChangeVersion, ref Option<string> snapshotIdentifier);
        ...
        {
            bool suppressDefaultLog = false;
            AfterDeletesStaffEducationOrganizationAssignmentAssociations(ref suppressDefaultLog, apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        private void OnErrorDeletesStaffEducationOrganizationAssignmentAssociationsDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorDeletesStaffEducationOrganizationAssignmentAssociations(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        public async Task<IDeletesStaffEducationOrganizationAssignmentAssociationsApiResponse?> DeletesStaffEducationOrganizationAssignmentAssociationsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await DeletesStaffEducationOrganizationAssignmentAssociationsAsync(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IDeletesStaffEducationOrganizationAssignmentAssociationsApiResponse> DeletesStaffEducationOrganizationAssignmentAssociationsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                FormatDeletesStaffEducationOrganizationAssignmentAssociations(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref snapshotIdentifier);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterDeletesStaffEducationOrganizationAssignmentAssociationsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            ...
            {
                OnErrorDeletesStaffEducationOrganizationAssignmentAssociationsDefaultImplementation(e, "/ed-fi/staffEducationOrganizationAssignmentAssociations/deletes", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
        ...
        /// </summary>
        public partial class DeletesStaffEducationOrganizationAssignmentAssociationsApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IDeletesStaffEducationOrganizationAssignmentAssociationsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetStaffEducationOrganizationAssignmentAssociationsApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IGetStaffEducationOrganizationAssignmentAssociationsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetStaffEducationOrganizationAssignmentAssociationsByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IGetStaffEducationOrganizationAssignmentAssociationsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v54.Models.All.EdFiStaffEducationOrganizationAssignmentAssociation? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v54.Models.All.EdFiStaffEducationOrganizationAssignmentAssociation>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v54.Models.All.EdFiStaffEducationOrganizationAssignmentAssociation? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class PostStaffEducationOrganizationAssignmentAssociationApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IPostStaffEducationOrganizationAssignmentAssociationApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutStaffEducationOrganizationAssignmentAssociationApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IPutStaffEducationOrganizationAssignmentAssociationApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
