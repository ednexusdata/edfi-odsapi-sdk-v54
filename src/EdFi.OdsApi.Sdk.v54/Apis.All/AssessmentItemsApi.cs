...
namespace EdFi.OdsApi.Sdk.v54.Apis.All
{
    ...
    public interface IAssessmentItemsApi : IApi
    {
        ...
        Task<IDeletesAssessmentItemsApiResponse> DeletesAssessmentItemsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// </summary>
    public interface IDeleteAssessmentItemByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesAssessmentItemsApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<List<DeletedResource>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetAssessmentItemsApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<List<EdFiAssessmentItem>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetAssessmentItemsByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v54.Models.All.EdFiAssessmentItem?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostAssessmentItemApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutAssessmentItemApiResponse : EdFi.OdsApi.Sdk.v54.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class AssessmentItemsApi : IAssessmentItemsApi
    {
        ...
        /// </summary>
        public partial class DeleteAssessmentItemByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IDeleteAssessmentItemByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        partial void FormatDeletesAssessmentItems(ref Option<int> offset, ref Option<int> limit, ref Option<long> minChangeVersion, ref Option<long> maxChangeVersion, ref Option<string> snapshotIdentifier);
        ...
        /// <param name="snapshotIdentifier"></param>
        private void AfterDeletesAssessmentItemsDefaultImplementation(IDeletesAssessmentItemsApiResponse apiResponseLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier)
        {
            bool suppressDefaultLog = false;
            AfterDeletesAssessmentItems(ref suppressDefaultLog, apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        partial void AfterDeletesAssessmentItems(ref bool suppressDefaultLog, IDeletesAssessmentItemsApiResponse apiResponseLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier);
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        private void OnErrorDeletesAssessmentItemsDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorDeletesAssessmentItems(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="maxChangeVersion"></param>
        /// <param name="snapshotIdentifier"></param>
        partial void OnErrorDeletesAssessmentItems(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<int> offset, Option<int> limit, Option<long> minChangeVersion, Option<long> maxChangeVersion, Option<string> snapshotIdentifier);
        ...
        public async Task<IDeletesAssessmentItemsApiResponse?> DeletesAssessmentItemsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await DeletesAssessmentItemsAsync(offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IDeletesAssessmentItemsApiResponse> DeletesAssessmentItemsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                FormatDeletesAssessmentItems(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref snapshotIdentifier);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterDeletesAssessmentItemsDefaultImplementation(apiResponseLocalVar, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
            ...
            {
                OnErrorDeletesAssessmentItemsDefaultImplementation(e, "/ed-fi/assessmentItems/deletes", uriBuilderLocalVar.Path, offset, limit, minChangeVersion, maxChangeVersion, snapshotIdentifier);
        ...
        /// </summary>
        public partial class DeletesAssessmentItemsApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IDeletesAssessmentItemsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        private void ValidateGetAssessmentItems(Option<string> identificationCode, Option<string> assessmentIdentifier, Option<string> varNamespace, Option<string> assessmentItemCategoryDescriptor, Option<string> assessmentItemURI, Option<string> correctResponse, Option<string> expectedTimeAssessed, Option<string> id, Option<string> itemText, Option<string> nomenclature, Option<string> snapshotIdentifier)
        {
            ...
            if (correctResponse.IsSet && correctResponse.Value == null)
                throw new ArgumentNullException(nameof(correctResponse));
        ...
        public async Task<IGetAssessmentItemsApiResponse> GetAssessmentItemsAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<string> identificationCode = default, Option<string> assessmentIdentifier = default, Option<string> varNamespace = default, Option<string> assessmentItemCategoryDescriptor = default, Option<string> assessmentItemURI = default, Option<string> correctResponse = default, Option<string> expectedTimeAssessed = default, Option<string> id = default, Option<string> itemText = default, Option<double> maxRawScore = default, Option<string> nomenclature = default, Option<string> snapshotIdentifier = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateGetAssessmentItems(identificationCode, assessmentIdentifier, varNamespace, assessmentItemCategoryDescriptor, assessmentItemURI, correctResponse, expectedTimeAssessed, id, itemText, nomenclature, snapshotIdentifier);

                FormatGetAssessmentItems(ref offset, ref limit, ref minChangeVersion, ref maxChangeVersion, ref totalCount, ref identificationCode, ref assessmentIdentifier, ref varNamespace, ref assessmentItemCategoryDescriptor, ref assessmentItemURI, ref correctResponse, ref expectedTimeAssessed, ref id, ref itemText, ref maxRawScore, ref nomenclature, ref snapshotIdentifier);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    if (correctResponse.IsSet)
                        parseQueryStringLocalVar["correctResponse"] = ClientUtils.ParameterToString(correctResponse.Value);
        ...
        /// </summary>
        public partial class GetAssessmentItemsApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IGetAssessmentItemsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetAssessmentItemsByIdApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IGetAssessmentItemsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v54.Models.All.EdFiAssessmentItem? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v54.Models.All.EdFiAssessmentItem>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v54.Models.All.EdFiAssessmentItem? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class PostAssessmentItemApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IPostAssessmentItemApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutAssessmentItemApiResponse : EdFi.OdsApi.Sdk.v54.Client.ApiResponse, IPutAssessmentItemApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
